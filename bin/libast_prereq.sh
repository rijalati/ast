...
set -e
set -x
bin_dir="$PACKAGEROOT/bin"
comp_dir="$PACKAGEROOT/src/lib/libast/comp"
PATH=$bin_dir:$PATH

cd "$PACKAGEROOT/src/lib/libast/features"
...
for name in sfinit signal; do
    ...
    cc -D_BLD_DLL -D_BLD_ast -I${PACKAGEROOT}/src/lib/libast -I. -I.. -Icomp -I../comp -Iinclude -I../include \
