...
int
b_exec(int argc, char *argv[], Shbltin_t *context)
{
...
static void
noexport(Namval_t *np, void *data)
{
    NOT_USED(data);
...
int
B_login(int argc, char *argv[], Shbltin_t *context)
{
    struct checkpt *pp;
    struct login *logp = 0;
    Shell_t *shp;
...
int
b_let(int argc, char *argv[], Shbltin_t *context)
{
    int r;
    char *arg;
...
int
b_eval(int argc, char *argv[], Shbltin_t *context)
{
    int r;
    Shell_t *shp = context->shp;
    NOT_USED(argc);
...
int
b_dot_cmd(int n, char *argv[], Shbltin_t *context)
{
    char *script;
    Namval_t *np;
    int jmpval;
    ...
    *prevscope = shp->st;
    ...
    if (np) {
        shp->st.filename
        = np->nvalue.rp->fname ? strdup(np->nvalue.rp->fname) : 0;
    }
 ...
 */
int
b_true(int argc, char *argv[], Shbltin_t *context)
{
    NOT_USED(argc);
    NOT_USED(argv[0]);
    NOT_USED(context);
 ...
 */
int
b_false(int argc, char *argv[], Shbltin_t *context)
{
    NOT_USED(argc);
    NOT_USED(argv[0]);
    NOT_USED(context);
...
int
b_shift(int n, char *argv[], Shbltin_t *context)
{
    char *arg;
    Shell_t *shp = context->shp;
...
int
b_wait(int n, char *argv[], Shbltin_t *context)
{
    Shell_t *shp = context->shp;
...
#    endif
int
b_bg(int n, char *argv[], Shbltin_t *context)
{
    int flag = **argv;
    Shell_t *shp = context->shp;
...
int
b_jobs(int n, char *argv[], Shbltin_t *context)
{
    int flag = 0;
    Shell_t *shp = context->shp;
 ...
 */
int
b_universe(int argc, char *argv[], Shbltin_t *context)
{
    char *arg;
    int n;
    NOT_USED(context);
...
#    endif
int
b_vpath(int argc, char *argv[], Shbltin_t *context)
{
    int flag, n;
    const char *optstr;
    char *vend;
