...
#    define CMDLIST(f)                                                       \
        SHOPT_CMDLIB_DIR "/" #f, NV_BLTIN | NV_BLTINOPT | NV_NOFREE, b_##f,
#else
#    define CMDLIST(f, d)                                                    \
        d "/" #f, NV_BLTIN | NV_BLTINOPT | NV_NOFREE | BLT_DISABLE, b_##f,   \
...
#else
    CMDLIST(basename) CMDLIST(chmod) CMDLIST(dirname) CMDLIST(getconf)
    CMDLIST(head) CMDLIST(mkdir) CMDLIST(logname) CMDLIST(cat) CMDLIST(cmp)
    CMDLIST(cut) CMDLIST(uname) CMDLIST(wc) CMDLIST(sync)
#endif
#if SHOPT_REGRESS
    "__regress__",
    NV_BLTIN | BLT_ENV,
...
#    define _JOB_                                                            \
        ...
        "[+\apool\a.\anum\a?refers to job \anum\a in background pool named " \
        "\apool\a.]"                                                         \
...
= "[-1c?\n@(#)$Id: cd (AT&T Research) 2013-08-18 $\n]" USAGE_LICENSE
  ...
  "[+?When \bcd\b is successful, the \bPWD\b environment variable will be "
  "set "
  ...
  "[f?The directory path is relative to the open file descriptor "
  "\adirfd\a.]#[dirfd]"
  ...
  "[@?Change into the hidden attribute directory of \adirectory\a which may "
  "also be "
...
= "[-1c?@(#)$Id: \b.\b (AT&T Research) 2000-04-02 $\n]" USAGE_LICENSE
  ...
  "[+?If \aname\a refers to a function defined with the \bfunction\b "
  "\aname\a "
...
= "[-1c?\n@(#)$Id: eval (AT&T Research) 1999-07-07 $\n]" USAGE_LICENSE
  ...
  "[+DESCRIPTION?\beval\b is a shell special built-in command that "
  "constructs "
...
= "[-1c?\n@(#)$Id: exit (AT&T Research) 1999-07-07 $\n]" USAGE_LICENSE
  ...
  "\n[n]\n"
  "\n"
  "[+EXIT STATUS?If \an\a is specified, the exit status is the least "
  "significant "
...
= "[-1c?@(#)$Id: bg (AT&T Research) 2000-04-02 $\n]" USAGE_LICENSE
  ...
  "background job is resumed or continued in the background.]" _JOB_
  "\n"
  "\n[job ...]\n"
  "\n"
  "[+EXIT STATUS?]{"
...
= "[-1c?@(#)$Id: fg (AT&T Research) 2000-04-02 $\n]" USAGE_LICENSE
  ...
  "[+?If \ajob\a is omitted, the most recently started or stopped "
  "background job is moved to the foreground.]" _JOB_
  "\n"
  "\n[job ...]\n"
  "\n"
...
= "[-1c?@(#)$Id: jobs (AT&T Research) 2000-04-02 $\n]" USAGE_LICENSE
  ...
  "[+?If \ajob\a is omitted, \bjobs\b displays the status of all stopped "
  "jobs, "
  ...
  "the current shell environment.]" _JOB_
...
= "[-1c?\n@(#)$Id: kill (AT&T Research) 2012-07-05 $\n]" USAGE_LICENSE
  ...
  "is being caught or ignored.]" _JOB_
  ...
  "[Q]#[n?The same as \b-q\b except that the message number \an\a is stored "
  "in "
  "the pointer portion of the value field and therefore can be a large "
  "unsigned integer.]"
  "[L?Same as \b-l\b except that of no argument is specified the signals "
  "will "
...
= "[-1c?\n@(#)$Id: print (AT&T Research) 2014-05-25 $\n]" USAGE_LICENSE
  ...
  "[e?Unless \b-f\b is specified, process \b\\\b sequences in each "
  "\astring\a "
  ...
  "use "
  "\b-u p\b instead.]"
  "[r?Do not process \b\\\b sequences in each \astring\a operand as "
  "described "
  "above.]"
  ...
  "[C?Treat each \astring\a as a variable name and write the value in "
  "\b%#B\b "
  "format.  Cannot be used with \b-f\b.]"
  "\n"
  "\n[string ...]\n"
...
= "[-1c?\n@(#)$Id: read (AT&T Research) 2014-07-20 $\n]" USAGE_LICENSE
  ...
  "\bREPLY\b is used.]"
  "[+?When \avar\a has the binary attribute and \b-n\b or \b-N\b is "
  "specified, "
  ...
  "[A?Unset \avar\a and then create an indexed array containing each field "
  "in "
  ...
  "are supported.]"
  "[p]:[prompt?Write \aprompt\a on each line before reading.  In earlier "
  "releases "
  ...
  "[u]:[fd:=0?Read from file descriptor number \afd\a instead of standard "
  "input. "
  ...
  "a terminal or pipe.]"
  "[n]#[count?Read at most \acount\a characters.  For binary fields "
  "\acount\a "
  "is the number of bytes.]"
  "[N]#[count?Read exactly \ancount\a characters.  For binary fields "
  "\acount\a "
  "is the number of bytes.]"
...
= "[-1c?\n@(#)$Id: return (AT&T Research) 1999-07-07 $\n]" USAGE_LICENSE
  ...
  "[+?If \breturn\b is invoked inside a function defined with the "
  "\bfunction\b "
...
= "+[-1?\n@(#)$Id: sh (AT&T Research) " SH_RELEASE " $\n]" USAGE_LICENSE
  ...
  "[+?Any option can use a \b+\b instead of a \b-\b to disable the "
  "corresponding "
  "option.]"
  "[c?Read the commands from the first \aarg\a.]"
  "[i?Specifies that the shell is interactive.]"
  "[l?Invoke the shell as a login shell; \b/etc/profile\b and "
  "\b$HOME/.profile\b, "
  ...
  "}"
  "[s?Read the commands from standard input.  The positional parameters will "
  "be "
  "initialized from \aarg\a.]"
  "[D\f:dump-strings\f?Do not execute the script, but output the set of "
  "double "
...
= "+[-1c?\n@(#)$Id: set (AT&T Research) 2013-04-25 $\n]" USAGE_LICENSE
  ...
  "[+?If no \aarg\as are specified, not even the end of options argument "
  "\b--\b, "
  ...
  "\fabc\f"
  "[K:keys]:[keylist?When used with \b-s\b and \b-A\b and without \aarg\a, "
  "it "
...
= "[-1c?\n@(#)$Id: sleep (AT&T Research) 2009-03-12 $\n]" USAGE_LICENSE
  ...
  "[+DESCRIPTION?\bsleep\b suspends execution for at least the time "
  "specified "
  ...
  "insensitive "
  "ISO 8601 duration except that \bM\b specifies months, \bm\b before \bs\b "
  "or \bS\b "
  "specifies minutes and after specifies milliseconds, \bu\b or \bU\b "
  "specifies "
  "microseconds, and \bn\b specifies nanoseconds.]"
  "[+date/time?Sleep until the \bdate\b(1) compatible date/time.]"
  "}"
  "[s?Sleep until a signal or a timeout is received. If \aduration\a is "
  "omitted "
...
= "+[-1c?\n@(#)$Id: typeset (AT&T Research) 2013-05-21 $\n]" USAGE_LICENSE
  ...
  "[E]#?[n:=\avar\a.DIG?Floating point number represented in scientific "
  "notation. "
  "\an\a specifies the number of significant figures when the "
  "value is expanded.]"
  "[F]#?[n:=\avar\a.DIG?Floating point.  \an\a is the number of places after "
  "the "
  ...
  "[L]#?[n?Left justify.  If \an\a is given it represents the field width.  "
  "If "
  ...
  "[R]#?[n?Right justify.  If \an\a is given it represents the field width.  "
  "If "
  "the \b-Z\b attribute is also specified, then zeros will "
  "be used as the fill character.  Otherwise, spaces are used.]"
  "[X]#?[n:=2*sizeof(long long)?Floating point number represented in "
  "hexadecimal "
...
= "[-1c?\n@(#)$Id: unset (AT&T Research) 1999-07-07 $\n]" USAGE_LICENSE
  ...
  "[+DESCRIPTION?For each \aname\a specified, \bunset\b  unsets the "
  "variable, "
  "or function if \b-f\b is specified, from the current shell "
  "execution environment.  Readonly variables cannot be unset.]"
  "[n?If \aname\a refers to variable that is a reference, the variable "
  "\aname\a "
...
= "[-1c?\n@(#)$Id: wait (AT&T Research) 1999-06-17 $\n]" USAGE_LICENSE
  ...
  "\n[job ...]\n"
  "\n"
  "[+EXIT STATUS?If \await\a is invoked with one or more \ajob\as, and all "
  "of "
...
= "[-1c?\n@(#)$Id: whence (AT&T Research) 2007-04-24 $\n]" USAGE_LICENSE
  ...
  "[q?Quiet mode. Returns 0 if all arguments are built-ins, functions, or "
  "are "
