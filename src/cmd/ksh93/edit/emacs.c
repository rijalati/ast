...
draw(Emacs_t *, Draw_t);
static int
escape(Emacs_t *, genchar *, int);
static void
putstring(Emacs_t *, char *);
static void
search(Emacs_t *, genchar *, int);
static void
setcursor(Emacs_t *, int, int);
static void
show_info(Emacs_t *, const char *);
static void
xcommands(Emacs_t *, int);
...
static void
show_info(Emacs_t *ep, const char *str)
{
...
static int
escape(Emacs_t *ep, genchar *out, int count)
{
    int i, value;
    int digit, ch;
    digit = 0;
...
static void
xcommands(Emacs_t *ep, int count)
{
...
static void
search(Emacs_t *ep, genchar *out, int direction)
{
#ifndef ESH_NFIRST
    Histloc_t location;
#endif
...
#    endif /*SHOPT_MULTIBYTE */
    ...
    ***********************/
    ...
    if (ep->ed->e_multiline && option == REFRESH && ep->ed->e_nocrnl == 0)
        ed_setcursor(
        ep->ed, ep->screen, ep->cursor - ep->screen, ep->ed->e_peol, -1);
...
static void
setcursor(Emacs_t *ep, int newp, int c)
{
