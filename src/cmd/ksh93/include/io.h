...
extern int
sh_iocheckfd(Shell_t *, int, int);
extern void
sh_ioinit(Shell_t *);
extern int
sh_iomovefd(Shell_t *, int);
extern int
sh_iorenumber(Shell_t *, int, int);
extern void
sh_pclose(int[]);
extern int
sh_rpipe(int[]);
extern void
sh_iorestore(Shell_t *, int, int);
extern void
sh_vexrestore(Shell_t *, int);
extern void
sh_vexsave(Shell_t *, int, int, Spawnvex_f, void *);
#    if defined(__EXPORT__) && defined(_BLD_DLL) && defined(_BLD_shell)
__EXPORT__
#    endif
extern Sfio_t *
sh_iostream(Shell_t *, int, int);
extern int
sh_redirect(Shell_t *, struct ionod *, int);
extern void
sh_iosave(Shell_t *, int, int, char *);
extern bool
sh_iovalidfd(Shell_t *, int);
extern bool
sh_inuse(Shell_t *, int);
extern void
sh_iounsave(Shell_t *);
extern void
sh_iounpipe(Shell_t *);
extern int
sh_chkopen(const char *);
extern int
sh_ioaccess(int, int);
extern int
sh_devtofd(const char *);
extern bool
sh_isdevfd(const char *);
extern bool
sh_source(Shell_t *, Sfio_t *, const char *);
