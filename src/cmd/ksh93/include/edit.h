...
ed_crlf(Edit_t *);
extern void
ed_putchar(Edit_t *, int);
extern void
ed_ringbell(void);
extern void
ed_setup(Edit_t *, int, int);
extern void
ed_flush(Edit_t *);
extern int
ed_getchar(Edit_t *, int);
extern int
ed_virt_to_phys(Edit_t *, genchar *, genchar *, int, int, int);
extern int
ed_window(void);
extern void
ed_ungetchar(Edit_t *, int);
extern int
ed_viread(void *, int, char *, int, int);
extern int
ed_read(void *, int, char *, int, int);
extern int
ed_emacsread(void *, int, char *, int, int);
extern Edpos_t
ed_curpos(Edit_t *, genchar *, int, int, Edpos_t);
extern int
ed_setcursor(Edit_t *, genchar *, int, int, int);
#    if SHOPT_COMPLETE
extern char **
ed_pcomplete(struct Complete *, const char *, const char *, int);
#    endif /*SHOPT_COMPLETE */
#    if KSHELL
extern int
ed_macro(Edit_t *, int);
extern int
ed_expand(Edit_t *, char[], int *, int *, int, int);
extern int
ed_fulledit(Edit_t *);
extern void *
ed_open(Shell_t *);
...
#    if SHOPT_MULTIBYTE
extern int
ed_internal(const char *, genchar *);
extern int
ed_external(const genchar *, char *);
extern void
ed_gencpy(genchar *, const genchar *);
extern void
ed_genncpy(genchar *, const genchar *, int);
extern int
ed_genlen(const genchar *);
extern int
ed_setwidth(const char *);
#    endif /* SHOPT_MULTIBYTE */
#    if SHOPT_EDPREDICT
extern int
ed_histgen(Edit_t *, const char *);
extern void
ed_histlist(Edit_t *, int);
#    endif /* SHOPT_EDPREDICT */
...
extern int
hist_expand(Shell_t *shp, const char *, char **);
