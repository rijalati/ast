...
#        define ARRAY_MAX                                                    \
            (1UL << 31) /* maximum number of elements in an array */
#    else
#        define ARRAY_MAX                                                    \
            (1UL << ARRAY_BITS) /* maximum number of elements in an array */
#    endif
#    define ARRAY_MASK                                                       \
        ((1UL << ARRAY_BITS) - 1) /* For backward compatibility */

#    define ARRAY_INCR                                                       \
        32 /* number of elements to grow when array                          \
...
#    define NV_ATTRIBUTES                                                    \
        (~(NV_NOSCOPE | NV_ARRAY | NV_NOARRAY | NV_IDENT | NV_ASSIGN         \
           | NV_REF | NV_VARNAME | NV_STATIC))
...
#    define nv_isref(n)                                                      \
        (nv_isattr((n), NV_REF | NV_TAGGED | NV_FUNCT) == NV_REF)
#    define is_abuiltin(n) (nv_isattr(n, NV_BLTIN | NV_INTEGER) == NV_BLTIN)
#    define is_afunction(n)                                                  \
        (nv_isattr(n, NV_FUNCTION | NV_REF) == NV_FUNCTION)
...
extern int
array_maxindex(Namval_t *);
extern char *
nv_endsubscript(Namval_t *, char *, int, void *);
extern Namfun_t *
nv_cover(Namval_t *);
extern Namarr_t *
nv_arrayptr(Namval_t *);
extern bool
nv_arrayisset(Namval_t *, Namarr_t *);
extern bool
nv_arraysettype(Namval_t *, Namval_t *, const char *, int);
extern int
nv_aimax(Namval_t *);
extern union Value *
nv_aivec(Namval_t *, unsigned char **);
extern int
nv_aipack(Namarr_t *);
extern bool
nv_atypeindex(Namval_t *, const char *);
extern bool
nv_setnotify(Namval_t *, char **);
extern bool
nv_unsetnotify(Namval_t *, char **);
extern struct argnod *
nv_onlist(struct argnod *, const char *);
extern void
nv_optimize(Namval_t *);
extern void
nv_unref(Namval_t *);
extern void
_nv_unset(Namval_t *, int);
extern bool
nv_hasget(Namval_t *);
extern void
nv_chkrequired(Namval_t *);
extern int
nv_clone(Namval_t *, Namval_t *, int);
void
clone_all_disc(Namval_t *, Namval_t *, int);
extern Namfun_t *
nv_clone_disc(Namfun_t *, int);
extern void *
nv_diropen(Namval_t *, const char *, void *);
extern char *
nv_dirnext(void *);
extern void
nv_dirclose(void *);
...
extern void
nv_attribute(Namval_t *, Sfio_t *, char *, int);
extern Namval_t *
nv_bfsearch(const char *, Dt_t *, Namval_t **, char **);
extern Namval_t *
nv_mkclone(Namval_t *);
extern Namval_t *
nv_mktype(Namval_t **, int);
extern Namval_t *
nv_addnode(Namval_t *, int);
extern Namval_t *
nv_parent(Namval_t *);
extern char *nv_getbuf(size_t);
extern Namval_t *
nv_mount(Namval_t *, const char *name, Dt_t *);
extern Namval_t *
nv_arraychild(Namval_t *, Namval_t *, int);
extern int
nv_compare(Dt_t *, Void_t *, Void_t *, Dtdisc_t *);
extern void
nv_outnode(Namval_t *, Sfio_t *, int, int);
extern bool
nv_subsaved(Namval_t *, int);
extern void
nv_typename(Namval_t *, Sfio_t *);
extern void
nv_newtype(Namval_t *);
extern Namval_t *
nv_typeparent(Namval_t *);
extern bool
nv_istable(Namval_t *);
extern size_t
nv_datasize(Namval_t *, size_t *);
extern Namfun_t *
nv_mapchar(Namval_t *, const char *);
extern void
nv_checkrequired(Namval_t *);
#    if SHOPT_FIXEDARRAY
extern int
nv_arrfixed(Namval_t *, Sfio_t *, int, char *);
#    endif /* SHOPT_FIXEDARRAY */
