...
extern pid_t
sh_copid(struct cosh *);
extern char *
sh_pid2str(Shell_t *, pid_t);
#    endif /* SHOPT_COSHELL */
...
job_bwait(char **);
extern int
job_walk(Shell_t *, Sfio_t *, int (*)(struct process *, int), int, char *[]);
extern int
job_kill(struct process *, int);
extern bool job_wait(pid_t);
extern int
job_post(Shell_t *, pid_t, pid_t);
extern void *
job_subsave(void);
extern void
job_subrestore(Shell_t *, void *);
extern void
job_chldtrap(Shell_t *, const char *, int);
#    ifdef JOBS
extern void
job_init(Shell_t *, int);
extern int
job_close(Shell_t *);
extern int
job_list(struct process *, int);
extern int
job_terminate(struct process *, int);
extern int
job_hup(struct process *, int);
extern int
job_switch(struct process *, int);
