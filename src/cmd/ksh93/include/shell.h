...
// Bit of a chicken and egg problem here. If we've already included fault.h
// then this typedef already exists and depending on the compiler defining it
// here may cause a warning or an error.
#    ifndef _FAULT_H
...
/// This is a macro that can be used to silence "unused parameter" warnings
/// from the compiler for functions which need to accept parameters they do
/// not use because they need to be compatible with an interface. It's similar
...
extern int
sh_access(const char *, int);
extern Namval_t *
sh_addbuiltin(const char *, int (*)(int, char *[], Shbltin_t *), void *);
extern Dt_t *
sh_bltin_tree(void);
extern int
sh_chdir(const char *);
...
sh_eval(Sfio_t *, int);
extern int
sh_exec(Shell_t *, const Shnode_t *, int);
extern void
sh_exit(int);
extern int
sh_fchdir(int);
...
sh_fmtq(const char *);
extern char *
sh_fmtqf(const char *, int, int);
extern int
sh_fun(Namval_t *, Namval_t *, char *[]);
extern int
sh_funscope(int, char *[], int (*)(void *), void *, int);
extern Shell_t *
sh_getinterp(void);
extern Shscope_t *
sh_getscope(int, int);
...
sh_iogetiop(int, int);
extern int
sh_main(int, char *[], Shinit_f);
extern void
sh_menu(Sfio_t *, int, char *[]);
extern void
sh_offoption(int);
extern bool
sh_isoption(int);
...
sh_onoption(int);
extern int
sh_open(const char *, int, ...);
extern int
sh_openmax(void);
extern void *
sh_parse(Shell_t *, Sfio_t *, int);
extern Sfio_t *
...
sh_run(int, char *[]);
extern off_t
sh_seek(int, off_t, int);
extern Shscope_t *
sh_setscope(Shscope_t *);
extern void
sh_sigcheck(Shell_t *);
extern int
sh_stat(const char *, struct stat *);
extern Sfdouble_t
sh_strnum(const char *, char **, int);
extern void
sh_subfork(void);
extern int
sh_trap(const char *, int);
...
extern Namval_t *
sh_addbuiltin_20120720(Shell_t *,
                       const char *,
                       int (*)(int, char *[], Shbltin_t *),
                       void *);
extern Dt_t *
sh_bltin_tree_20120720(Shell_t *);
extern int
sh_eval_20120720(Shell_t *, Sfio_t *, int);
extern void
sh_exit_20120720(Shell_t *, int);
extern Sfio_t *
sh_fd2sfio_20120720(Shell_t *, int);
extern int
sh_fun_20120720(Shell_t *, Namval_t *, Namval_t *, char *[]);
extern int
sh_funscope_20120720(Shell_t *, int, char *[], int (*)(void *), void *, int);
extern Shscope_t *
sh_getscope_20120720(Shell_t *, int, int);
extern void
sh_offoption_20120720(Shell_t *, int);
extern bool
sh_isoption_20120720(Shell_t *, int);
extern void
sh_onoption_20120720(Shell_t *, int);
extern void
sh_menu_20120720(Shell_t *, Sfio_t *, int, char *[]);
extern Sfio_t *
sh_pathopen_20120720(Shell_t *, const char *);
extern int
sh_reinit_20120720(Shell_t *, char *[]);
extern int
sh_run_20120720(Shell_t *, int, char *[]);
extern Shscope_t *
sh_setscope_20120720(Shell_t *, Shscope_t *);
extern Sfdouble_t
sh_strnum_20120720(Shell_t *, const char *, char **, int);
extern int
sh_trap_20120720(Shell_t *, const char *, int);
extern void *
sh_waitnotify_20120720(Shwait_f, void *);
