...
ivmeth(const char *);
extern Iv_t *
ivopen(Ivdisc_t *, Ivmeth_t *, int, const char *);
extern int
ivclose(Iv_t *);
extern int
ivstr(Iv_t *, const char *, char **, unsigned char *, unsigned char *);
extern char *
ivfmt(Iv_t *, const unsigned char *, int);
...
#            define IVLIB(m)                                                 \
                Ivmethod_t *Iv##m = &_##Iv##m;                               \
                extern __EXPORT__ Ivmethod_t *vcodex_lib(const char *path)   \
                {                                                            \
                    return Iv##m;                                            \
                }
#        else
#            define IVLIB(m)                                                 \
                Ivmethod_t *Iv##m = &_##Iv##m;                               \
                extern Ivmethod_t *iv_lib(const char *path)                  \
                {                                                            \
                    return Iv##m;                                            \
                }
#        endif
