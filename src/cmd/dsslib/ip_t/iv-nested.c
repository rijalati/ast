...
static int
nestset(Iv_t *iv, unsigned char *lo, unsigned char *hi, void *data)
{
    Nest_t *nst;
    Itvl_t itvl;
    Itvl_t *it;
...
static int
nestdel(Iv_t *iv, unsigned char *lo, unsigned char *hi)
{
    Nest_t *nst;
    Itvl_t itvl;
    Itvl_t *it;
...
static Ivmeth_t _Ivnested = {
    "nested",
    "The nested method manages nested intervals so that only points in the "
    "smallest containing intervals will be visible.",
    0,
    nestget,
    nestset,
    nestdel,
