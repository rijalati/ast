...
struct Ptdisc_s;
typedef struct Ptdisc_s Ptdisc_t;
struct Ptprefix_s;
typedef struct Ptprefix_s Ptprefix_t;
...
#    define ptinit(d)                                                        \
        (memset(d, 0, sizeof(Ptdisc_t)), (d)->version = PT_VERSION)
...
ptclose(Pt_t *);
extern Ptprefix_t *
ptinsert(Pt_t *, Ptaddr_t, Ptaddr_t);
extern int
ptdelete(Pt_t *, Ptaddr_t, Ptaddr_t);

extern Ptprefix_t *
ptmatch(Pt_t *, Ptaddr_t);
...
ptinvert(Pt_t *);
extern Pt_t *
ptintersect(Pt_t *, Pt_t *);
extern Pt_t *
ptunion(Pt_t *, Pt_t *);
extern Pt_t *
ptdifference(Pt_t *, Pt_t *);
extern Pt_t *
ptcover(Pt_t *, Pt_t *);
extern Pt_t *
ptrebit(Pt_t *, int);
