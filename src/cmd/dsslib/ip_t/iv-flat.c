...
static Ivmeth_t _Ivflat = {
    "flat",
    "The flat interval method allows a new interval to simply overwrite any "
    "portion of older intervals that it overlaps with. Adjacent intervals "
    "with the same data are merged.",
    0,
    flatget,
    flatset,
    flatdel,
