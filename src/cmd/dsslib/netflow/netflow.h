...
#    define NETFLOW_GROUP_4_BEGIN set
    ...
    Nflong_t mpls_label_1; /* Stack position 1 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
    Nflong_t mpls_label_2; /* Stack position 2 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
    Nflong_t mpls_label_3; /* Stack position 3 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
    Nflong_t mpls_label_4; /* Stack position 4 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
    Nflong_t mpls_label_5; /* Stack position 5 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
    Nflong_t mpls_label_6; /* Stack position 6 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
    Nflong_t mpls_label_7; /* Stack position 7 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
    Nflong_t mpls_label_8; /* Stack position 8 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
    Nflong_t mpls_label_9; /* Stack position 9 MPLS label: 20 bits MPLS label,
                              3 bits experimental, 1 bit end-of-stack */
