...
= { "flat",
    ...
    "record of these fields: src_addr, dst_addr, hop, input, output, "
    "packets, bytes, first, last, src_port, dst_port, flags, tcp_flags, "
    "prot, tos, src_as, dst_as, src_mask, dst_mask, flow_sequence",
    CXH,
    flatident,
    flatopen,
    flatread,
