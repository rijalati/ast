...
= { CXF("html::ref",
        ...
        html_ref_F,
        "string",
        "Return a space separated list of referenced resources from the HTML "
        "tags in the string argument.") 0 };

Dsslib_t dss_lib_html = { "html",
                          "html function support"
                          "[-?\n@(#)$Id: dss html function library (AT&T "
                          "Research) 2010-04-22 $\n]" USAGE_LICENSE,
                          CXH,
                          0,
                          0,
