...
struct Pax_s;
typedef struct Pax_s Pax_t;
#    ifndef Paxarchive_t
struct Paxarchive_s;
typedef struct Paxarchive_s Paxarchive_t;
#    endif
#    ifndef Paxfile_t
struct Paxfile_s;
typedef struct Paxfile_s Paxfile_t;
#    endif
#    ifndef Paxformat_t
struct Paxformat_s;
typedef struct Paxformat_s Paxformat_t;
#    endif
struct Paxio_s;
typedef struct Paxio_s Paxio_t;
struct Paxvalue_s;
typedef struct Paxvalue_s Paxvalue_t;
...
struct Paxformat_s /* format info			*/
{
    ...
    int (
    *lookup)(Pax_t *, Paxarchive_t *, Paxfile_t *, int, char **, Sflong_t *);
    int (*backup)(Pax_t *, Paxarchive_t *);
    unsigned long (*checksum)(Pax_t *,
                              Paxarchive_t *,
                              Paxfile_t *,
                              void *,
                              size_t,
...
#        ifdef __STDC__
#            define PAXLIB(f)                                                \
                extern Paxformat_t *pax_lib(Pax_t *pax)                      \
                {                                                            \
                    return &pax_##f##_format;                                \
                }                                                            \
                unsigned long plugin_version(void)                           \
                {                                                            \
                    return PAX_PLUGIN_VERSION;                               \
                }
#        else
#            define PAXLIB(f)                                                \
                extern Paxformat_t *pax_lib(pax) Pax_t *pax;                 \
                {                                                            \
                    return &pax_##f##_format;                                \
                }                                                            \
