...
extern int
addlink(Archive_t *, File_t *);
extern int
apply(Archive_t *, File_t *, Filter_t *);
extern long
asc_checksum(char *, int, unsigned long);
extern void
backup(Archive_t *);
extern long
bblock(int);
extern void
bflushin(Archive_t *, int);
extern void
bflushout(Archive_t *);
extern char *
bget(Archive_t *, off_t, off_t *);
extern void
binit(Archive_t *);
extern void
bput(Archive_t *, off_t);
extern off_t
bread(Archive_t *, void *, off_t, off_t, int);
extern off_t
bseek(Archive_t *, off_t, int, int);
extern int
bskip(Archive_t *);
extern void
bunread(Archive_t *, void *, int);
extern void
bwrite(Archive_t *, void *, off_t);
extern int
closein(Archive_t *, File_t *, int);
extern int
closeout(Archive_t *, File_t *, int);
extern int
cmpftw(Ftw_t *, Ftw_t *);
extern void
complete(Archive_t *, File_t *, size_t);
extern void
convert(Archive_t *, int, int, int);
extern void
copy(Archive_t *, int (*)(Ftw_t *));
extern void
copyin(Archive_t *);
extern int
copyinout(Ftw_t *);
...
deltabase(Archive_t *);
extern int
deltacheck(Archive_t *, File_t *);
extern void
deltadelete(Archive_t *);
extern void
deltaout(Archive_t *, Archive_t *, File_t *);
extern void
deltapass(Archive_t *, Archive_t *);
extern void
deltaset(Archive_t *, char *);
extern void
deltaverify(Archive_t *);
extern int
dirprefix(char *, char *, int);
extern void
filein(Archive_t *, File_t *);
extern void
fileout(Archive_t *, File_t *);
extern void
fileskip(Archive_t *, File_t *);
extern Filter_t *
filter(Archive_t *, File_t *);
extern void
finish(int);
extern Archive_t *
getarchive(int);
extern void
getdeltaheader(Archive_t *, File_t *);
extern void
getdeltatrailer(Archive_t *, File_t *);
extern int
getepilogue(Archive_t *);
extern int
getfile(Archive_t *, File_t *, Ftw_t *);
extern Format_t *
getformat(char *, int);
extern int
getheader(Archive_t *, File_t *);
extern void
getidnames(File_t *);
extern int
getprologue(Archive_t *);
extern void
gettrailer(Archive_t *, File_t *);
extern ssize_t
holewrite(int, void *, size_t);
extern Archive_t *
initarchive(const char *, int);
extern void
initdelta(Archive_t *, Format_t *);
extern void
initfile(Archive_t *, File_t *, struct stat *, char *, int);
extern void
initmatch(char **);
extern void
interactive(void);
...
listentry(File_t *);
extern int
listprintf(Sfio_t *, Archive_t *, File_t *, const char *);
extern char *
map(Archive_t *, char *);
extern int
match(char *);
extern void
newio(Archive_t *, int, int);
extern Format_t *
nextformat(Format_t *);
extern void
nospace(void);
extern unsigned long
omemsum(const void *, int, unsigned long);
extern int
openin(Archive_t *, File_t *);
extern int
openout(Archive_t *, File_t *);
extern int
paxdelta(Archive_t *, Archive_t *, File_t *, int, ...);
extern void
paxinit(Pax_t *, const char *);
extern int
portable(Archive_t *, const char *);
extern int
prune(Archive_t *, File_t *, struct stat *);
extern void
putdeltaheader(Archive_t *, File_t *);
extern void
putdeltatrailer(Archive_t *, File_t *);
extern void
putepilogue(Archive_t *);
extern int
putheader(Archive_t *, File_t *);
extern void
putinfo(Archive_t *, char *, unsigned long, unsigned long);
extern void
putkey(Archive_t *, Sfio_t *, Option_t *, const char *, Sfulong_t);
extern void
putprologue(Archive_t *, int);
extern void
puttrailer(Archive_t *, File_t *);
extern char *
release(void);
extern int
restore(const char *, char *, void *);
extern void
seekable(Archive_t *);
extern int
selectfile(Archive_t *, File_t *);
extern void
setdeltaheader(Archive_t *, File_t *);
extern void
setfile(Archive_t *, File_t *);
extern void
setidnames(File_t *);
extern void
setinfo(Archive_t *, File_t *);
extern void
setoptions(char *, size_t, char **, char *, Archive_t *, int);
extern void
settime(const char *, Tv_t *, Tv_t *, Tv_t *);
extern char *
stash(Value_t *, const char *, size_t);
extern char *
strlower(char *);
extern char *
strupper(char *);
extern void
undoable(Archive_t *, Format_t *);
extern void
undos(File_t *);
extern int
validout(Archive_t *, File_t *);
extern int
verify(Archive_t *, File_t *, char *);
