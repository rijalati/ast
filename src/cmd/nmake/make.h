...
#    define debug(x)                                                         \
        ...
        while (0)
#    define PANIC                                                            \
        (ERROR_PANIC | ERROR_SOURCE | ERROR_SYSTEM), __FILE__, __LINE__
#else
#    define debug(x)
...
#define EXPLAIN                                                              \
    (state.user && (state.explain || error_info.trace <= EXPTRACE))
...
#define canon(x)                                                             \
    ((state.context && iscontextp(x, &state.tmppchar))                       \
     ? state.tmppchar                                                        \
...
#define notfile(r)                                                           \
    (((r)->property                                                          \
      & (P_attribute | P_functional | P_make | P_operator | P_state | P_use  \
         | P_virtual))                                                       \
     || ((r)->dynamic & D_scope) || (r)->semaphore                           \
...
#define reason(x)                                                            \
    ...
    while (0)
#define ropen(f, m)                                                          \
    ((f) == internal.openfile ? (internal.openfile = 0, internal.openfd)     \
                              : open(f, m))
#define rsfopen(f)                                                           \
    ((f) == internal.openfile                                                \
     ? (internal.openfile = 0,                                               \
        sfnew(NiL, NiL, SF_UNBOUND, internal.openfd, SF_READ))               \
     : sfopen(NiL, f, "re"))
...
#define isstate(s)                                                           \
    (nametype(s, NiL) & (NAME_staterule | NAME_altstate | NAME_statevar))
...
#define D_CLEAROBJECT                                                        \
    (~(D_bindindex | D_built | D_compiled | D_context | D_dynamic | D_index  \
       | D_lower | D_lowres | D_scope))
...
#define V_CLEAROBJECT                                                        \
    (~(V_auxiliary | V_builtin | V_functional | V_import | V_retain | V_scan \
       | V_scope))
...
/*
 * statevar data, staterule sync time and unbound rule name -- shared in
 * rule.u1
 */
...
extern File_t *
addfile(Dir_t *, char *, Time_t);
extern void
addprereq(Rule_t *, Rule_t *, int);
extern List_t *
append(List_t *, List_t *);
extern int
apply(Rule_t *, char *, char *, char *, Flags_t);
extern void
argcount(void);
extern void
arscan(Rule_t *);
...
arupdate(char *);
extern Rule_t *
associate(Rule_t *, Rule_t *, char *, List_t **);
extern Var_t *
auxiliary(char *, int);
extern Rule_t *
bind(Rule_t *);
extern void
bindattribute(Rule_t *);
extern Rule_t *
bindfile(Rule_t *, char *, int);
extern Rule_t *
bindstate(Rule_t *, char *);
extern int
block(int);
extern void
candidates(void);
...
call(Rule_t *, char *);
extern Rule_t *
catrule(char *, char *, char *, int);
extern char *
colonlist(Sfio_t *, char *, int, int);
extern void
compile(char *, char *);
extern int
complete(Rule_t *, List_t *, Time_t *, Flags_t);
extern void
compref(Rule_t *, int);
extern List_t *
cons(Rule_t *, List_t *);
...
dump(Sfio_t *, int);
extern void
dumpaction(Sfio_t *, const char *, char *, const char *);
extern void
dumpjobs(int, int);
extern void
dumpregress(Sfio_t *, const char *, const char *, char *);
extern void
dumprule(Sfio_t *, Rule_t *);
extern void
dumpvar(Sfio_t *, Var_t *);
extern void
dynamic(Rule_t *);
extern void
edit(Sfio_t *, char *, char *, char *, char *);
extern void
expand(Sfio_t *, char *);
extern void
explain(int, ...);
...
expr(Sfio_t *, char *);
extern Sfio_t *
fapply(Rule_t *, char *, char *, char *, Flags_t);
extern void
finish(int);
extern int
forcescan(const char *, char *v, void *);
extern char *
getarg(char **, int *);
extern void
getop(Sfio_t *, char *, int);
extern char *
getval(char *, int);
extern char **
globv(glob_t *, char *);
...
handle(void);
extern int
hasattribute(Rule_t *, Rule_t *, Rule_t *);
extern int
hasafter(Rule_t *, Flags_t);
extern void
immediate(Rule_t *);
extern void
initcode(void);
...
listops(Sfio_t *, int);
extern int
load(Sfio_t *, const char *, int, int);
extern int
loadable(Sfio_t *, Rule_t *, int);
extern void
localvar(Sfio_t *, Var_t *, char *, int);
extern char *
localview(Rule_t *);
extern void
lockstate(int);
extern int
make(Rule_t *, Time_t *, char *, Flags_t);
extern int
makeafter(Rule_t *, Flags_t);
extern int
makebefore(Rule_t *);
extern Rule_t *
makerule(char *);
extern void
maketop(Rule_t *, int, char *);
extern char *
mamcanon(char *);
extern ssize_t
mamerror(int, const void *, size_t);
extern char *
mamname(Rule_t *);
extern void
mampop(Sfio_t *, Rule_t *, Flags_t);
extern int
mampush(Sfio_t *, Rule_t *, Flags_t);
extern Sfio_t *
mamout(Rule_t *);
extern char *
maprule(char *, Rule_t *);
extern void
merge(Rule_t *, Rule_t *, int);
extern void
mergestate(Rule_t *, Rule_t *);
extern void
metaclose(Rule_t *, Rule_t *, int);
extern void
metaexpand(Sfio_t *, char *, char *);
extern Rule_t *
metaget(Rule_t *, Frame_t *, char *, Rule_t **);
extern Rule_t *
metainfo(int, char *, char *, int);
extern int
metamatch(char *, char *, char *);
extern Rule_t *
metarule(char *, char *, int);
extern void
negate(Rule_t *, Rule_t *);
extern void *
newchunk(char **, size_t);
extern void
newfile(Rule_t *, char *, Time_t);
extern char *
objectfile(void);
extern void
parentage(Sfio_t *, Rule_t *, char *);
extern int
parse(Sfio_t *, char *, char *, Sfio_t *);
extern char *
parsefile(void);
extern char *
pathname(char *, Rule_t *);
extern void
poplocal(void *);
extern int
prereqchange(Rule_t *, List_t *, Rule_t *, List_t *);
extern void
punt(int);
extern void *
pushlocal(void);
...
remtmp(int);
extern int
resolve(char *, int, int);
extern int
rstat(char *, Stat_t *, int);
extern void
rules(char *);
extern Rule_t *
rulestate(Rule_t *, int);
extern void
savestate(void);
extern List_t *
scan(Rule_t *, Time_t *);
extern int
scanargs(int, char **, int *);
extern int
set(char *, int, Sfio_t *);
extern Var_t *
setvar(char *, char *, int);
extern void
shquote(Sfio_t *, char *);
extern Rule_t *
source(Rule_t *);
...
statefile(void);
extern Rule_t *
staterule(int, Rule_t *, char *, int);
extern Time_t
statetime(Rule_t *, int);
extern int
statetimeq(Rule_t *, Rule_t *);
extern int
strprintf(Sfio_t *, const char *, char *, int, int);
extern void
terminate(void);
extern char *
timefmt(const char *, Time_t);
extern Time_t
timenum(const char *, char **);
extern char *timestr(Time_t);
extern void
trigger(Rule_t *, Rule_t *, char *, Flags_t);
extern int
unbind(const char *, char *, void *);
extern Dir_t *
unique(Rule_t *);
extern void
unparse(int);
