...
#define OPT_option                                                           \
    (101 | Oa | Of | Os | Ox) /* define new option by name                   \
                               */
#define OPT_override                                                         \
    (102 | Ob | Of | Ox)                /* override selected algorithms      \
                                         */
...
#define OPT_targetcontext                                                    \
    (105 | Ob | Of) /* expand in target dir context                          \
                     */
#define OPT_targetprefix                                                     \
    (106 | Os | Of)                    /* source dir target prefix sep       \
                                        */
...
#define OPT_writeobject                                                      \
    (107 | Of | Os | Ov | Ox) /* write recompiled object	*/
#define OPT_writestate                                                       \
    (108 | Of | Os | Ov | Ox) /* write state file on exit	*/
