...
static const Edit_xxx_t editxxx[] = { "A>", "N>", 2, 0 };

static const Edit_opt_t editbind[]
= { "force", { ED_QUAL, ED_FORCE }, "nowait", { ED_QUAL, ED_NOWAIT }, 0 };

static const Edit_opt_t editbound[]
= { "", { ED_OP, 0, 'B' }, "directory", { ED_OP, 0, 'D' }, 0 };

static const Edit_opt_t editgenerate[] = { "target", { ED_QUAL, LT }, 0 };

static const Edit_opt_t editintersect[] = { "literal", { ED_QUAL, LT }, 0 };

static const Edit_opt_t editlist[]
= { "",     { ED_QUAL, EQ }, "first",   { ED_QUAL, EQ },
    "sort", { ED_QUAL, LT }, "reverse", { ED_QUAL, GT },
    0 };

static const Edit_opt_t editmatch[]
= { "prereqs", { ED_QUAL, GT }, "re", { ED_OP, 'M' }, 0 };

static const Edit_opt_t editread[] = { "raw", { ED_OP, 0, 'X' }, 0 };

static const Edit_opt_t editsort[]
= { "numeric", { ED_QUAL, EQ },  "reverse", { ED_QUAL, GT },
    "unique",  { ED_QUAL, NOT }, 0 };

static const Edit_opt_t editstate[]
= { "",       { ED_OP, 0, 'S' },      "assign",   { ED_OP, 0, 'E' },
    "define", { ED_OP, 0, 'D' },      "prereqs",  { ED_OP, 0, 'S', 'P' },
    "rule",   { ED_OP, 0, 'S', 'R' }, "variable", { ED_OP, 0, 'S', 'V' },
    0 };

static const Edit_opt_t edittime[]
= { "event", { ED_OP, 0, 'E' }, "prereqs", { ED_OP, 0, 'C' },
    "rule",  { ED_OP, 0, 'R' }, "state",   { ED_OP, 0, 'S' },
    "wall",  { ED_OP, 0, 'W' }, 0 };
...
= { "append", { ED_OP, 0, 'A' }, "numeric", { ED_OP, 0, 'N' },
    "raw",    { ED_OP, 0, 'X' }, 0 };
