...
= "[-?\n@(#)$Id: sed (AT&T Research) 2012-03-28 $\n]" USAGE_LICENSE
  ...
  "[+DESCRIPTION?\bsed\b is a stream editor that reads one or more text "
  "files,"
  ...
  "[n:quiet|silent?Suppress the default output in which each line, after it "
  "is"
  "	examined for editing, is written to standard output. Only lines"
  "	explicitly selected for output will be written.]"
  "[A|X:augmented?Enable augmented regular expressions; this includes "
  "negation"
  "	and conjunction.]"
  ...
  "[S:strict|posix?Enable strict regular expression interpretation. This is "
  "the"
