...
= "[-?\n@(#)$Id: nl (AT&T Research) 2003-03-24 $\n]" USAGE_LICENSE
  ...
  "[+?The \bnl\b utility treats its input in terms of logical pages and "
  "resets "
  ...
  "[d1d2?Footer.]"
  "}"
  "[+?\bnl\b assumes that the first section is a logical body until it "
  "encounters "
  ...
  "[f:footer-numbering]:[type:=n?\atype\a is the same as for the \bb\b "
  "option.]"
  "[h:header-numbering]:[type:=n?\atype\a is the same as for the \bb\b "
  "option.]"
  "[i:page-increment]#[incr:=1?\aincr\a is the increment used to number "
  "logical "
  "page lines.]"
  ...
  "[s:number-separator]:[sep:=\\t?\asep\a is the string that is used to "
  "separate the line number "
  "and the corresponding text line.]"
  "[v:starting-line-number]#[startnum:=1?\astartnum\a is the initial value "
  "to number "
  "logical pages.]"
  "[w:number-width]#[width:=6?\awidth\a is the number of characters to be "
  "used "
  "for line numbering.]"
...
static int
donl(Nl_t *pp, Sfio_t *in, Sfio_t *out)
{
    char *cp;
        ...
        case 'h':
            ...
            case 'p':
                ...
                if (regcomp(&re[m], opt_info.arg + 1, REG_NOSUB))
                    error(2,
                          "-%c: invalid basic regular expression %s",
                          n,
                          opt_info.arg + 1);
                break;
            }
