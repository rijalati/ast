...
int rs_marker(rp, from, to, st, expire, force) rfile_t *rp;
char *from;
char *to;
struct stat *st;
time_t expire;
...
tag_t *getmarker(dir, s) rdirent_t *dir;
char *s;
{
    rdirent_t *ep;
...
tag_t *getmarkerbyfrom(dir, s) rdirent_t *dir;
char *s;
{
    rdirent_t *ep;
    char *t;
...
tag_t *getmarkerbyto(dir, s) rdirent_t *dir;
char *s;
{
    rdirent_t *ep;
    rdirent_t *r;
...
int markermatch(marker, s) char *marker;
char *s;
{
    char *t;
    int i;
