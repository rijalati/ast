 ...
 */
int HttpConvert(srcfile, htmlfile, linkfile) char *srcfile;
char *htmlfile;
char *linkfile;
{
 ...
 */
int HttpXfer(srv, rpath, linkfile, tmpfile) struct server_info *srv;
char *rpath;
char *linkfile;
char *tmpfile;
{
 ...
 */
int HttpXferDir(srv, tmpfile) struct server_info *srv;
char *tmpfile;
{
    char rpath[STRLEN];
 ...
 */
int HttpXferFile(srv, tmpfile) struct server_info *srv;
char *tmpfile;
{
    char linkfile[STRLEN];
    char *lpath = srv->lpath;
 ...
 *	validate a URL file
 */
int HttpGetFile(srv) struct server_info *srv;
{
    char tmpfile[STRLEN];
    char *rpath, *ptr;
    int ans;
 ...
 *	(ex: Cookie ...)
 */
int HttpUserDef(srv, argc, argv) struct server_info *srv;
int argc;
char *argv[];
{
    char buf[STRLEN];
