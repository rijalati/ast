 ...
 * rtn:	NULL if error
 */
void *MallocZero(nSize) int nSize;
{
    void *pBuf;
 ...
 */
int SecurityDataAccess(pos, data, len) int pos;
void *data;
int len;
{
 ...
 */
int DataEntryInsert(fpath, key, data, len) char *fpath;
char *key;
void *data;
int len;
{
 ...
 */
int DataEntryDelete(fpath, key) char *fpath;
char *key;
{
    struct DataEntry *ent = DataSpool;
 ...
 *name: DataEntryQuery
 */
int DataEntryQuery(fpath, key, buffer, bsize) char *fpath;
char *key;
void *buffer;
int bsize;
{
 ...
 */
int CopyFile(pSrc, pDst) char *pSrc, *pDst;
{
    char buf[1024];
    int fs, fd, len;
 ...
 */
void MakePath(fpath) char *fpath;
{
    char *ptr;
 ...
 */
void MakeTmpFile(fpath, buf, bsize) char *fpath;
char *buf;
int bsize;
{
    char *ptr;
 ...
 *name: GetUserFile
 */
char *GetUserFile(fname, buf, size) char *fname;
char *buf;
int size;
{
 ...
 * rtn: fields number
 */
int SplitFields(arg, asize, str, tok) char *arg[];
int asize;
char *str;
char tok;
{
 ...
 */
int MakeImageFile(fname, size) char *fname;
int size;
{
