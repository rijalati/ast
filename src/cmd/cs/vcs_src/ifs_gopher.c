...
int GopherXfer(srv, rpath, tmpfile) struct server_info *srv;
char *rpath;
char *tmpfile;
{
...
int GopherXferFile(srv, tmpfile) struct server_info *srv;
char *tmpfile;
{
    char buf[STRLEN];
...
int GopherXferDir(srv, tmpfile) struct server_info *srv;
char *tmpfile;
{
    char buf[STRLEN];
...
int GopherGetFile(srv) struct server_info *srv;
{
    char tmpfile[STRLEN];
