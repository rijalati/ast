...
struct Ssdisc_s;
typedef struct Ssdisc_s Ssdisc_t;
struct Ssexpr_s;
typedef struct Ssexpr_s Ssexpr_t;
struct Ssfield_s;
typedef struct Ssfield_s Ssfield_t;
struct Ssfile_s;
typedef struct Ssfile_s Ssfile_t;
struct Ssgroup_s;
typedef struct Ssgroup_s Ssgroup_t;
struct Ss_s;
typedef struct Ss_s Ss_t;

union Ssop_u;
typedef union Ssop_u Ssop_t;
...
#    define ssinit(d, e)                                                     \
        (memset(d, 0, sizeof(Ssdisc_t)),                                     \
         (d)->version = SS_VERSION,                                          \
         (d)->errorf = (Error_f)(e))

extern Ss_t *
ssopen(const char *, Ssdisc_t *);
extern int
ssdd(const char *, const char *, Ssdisc_t *);
extern int
sseval(Ss_t *, Ssexpr_t *, const char *, size_t);
extern char *
sskey(Ss_t *, Ssfield_t *);
extern int
sslist(Ss_t *, Sfio_t *);
extern int
sssum(Ss_t *, Ssfield_t *, const char *, size_t, char *);
extern ssize_t
sscopy(Ss_t *, Ssfile_t *, const char *, size_t, char *, size_t);
extern ssize_t
sswrite(Ss_t *, Ssfile_t *, const char *, size_t);
extern int
ssio(Ss_t *, int);
extern int
ssannounce(Ss_t *, Rs_t *);
extern int
ssclose(Ss_t *);
