...
: hide alarm _alarm __alarm clock_gettime _clock_gettime __clock_gettime
  gettimeofday _gettimeofday __gettimeofday getitimer _getitimer __getitimer
  poll _poll __poll select _select __select setitimer _setitimer __setitimer
  time times utime _utime __utime utimensat _utimensat __utimensat utimes
  _utimes __utimes utimets _utimets __utimets fstat64 lstat64
  __STDPP__directive pragma pp
: hide execlp _execlp __execlp execve _execve __execve execvp _execvp __execvp
  execvpe _execvpe __execvpe
#else
...
#if defined(__STDPP__directive) && defined(__STDPP__hide)
__STDPP__directive pragma pp
: nohide alarm _alarm __alarm clock_gettime _clock_gettime __clock_gettime
  gettimeofday _gettimeofday __gettimeofday getitimer _getitimer __getitimer
  poll _poll __poll select _select __select setitimer _setitimer __setitimer
  time times utime _utime __utime utimensat _utimensat __utimensat utimes
  _utimes __utimes utimets _utimets __utimets fstat64 lstat64
  __STDPP__directive pragma pp
: nohide execlp _execlp __execlp execve _execve __execve execvp _execvp
  __execvp execvpe _execvpe __execvpe
#else
#    undef alarm
#    undef _alarm
#    undef __alarm
...
#define UNWARP_REL(t)                                                        \
    ((t) = (t) ? (state.factor ? ((t) / state.factor) : (t)) : 0)
...
static int
warp_setitimer(Call_t *p,
               int i,
               const struct itimerval *v,
               struct itimerval *o)
{
    int r;
    struct itimerval x;
