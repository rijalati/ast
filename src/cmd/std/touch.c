...
main(int argc, char **argv)
{
    ...
    for (;;) {
        ...
        case 'd':
        case 't':
            if (streq(opt_info.arg, "access") || streq(opt_info.arg, "atime")
                || streq(opt_info.arg, "use"))
                use = ATIME;
            else if (streq(opt_info.arg, "change")
                     || streq(opt_info.arg, "ctime"))
                use = CTIME;
            else if (streq(opt_info.arg, "modify")
