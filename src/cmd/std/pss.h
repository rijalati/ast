...
#    define PSS_all                                                          \
        (PSS_addr | PSS_args | PSS_command | PSS_cpu | PSS_flags | PSS_gid   \
         | PSS_job | PSS_nice | PSS_npid | PSS_pgrp | PSS_pid | PSS_ppid     \
         | PSS_pri | PSS_proc | PSS_refcount | PSS_rss | PSS_sched | PSS_sid \
         | PSS_size | PSS_start | PSS_state | PSS_tgrp | PSS_time | PSS_tty  \
         | PSS_uid | PSS_wchan)
...
pssopen(Pssdisc_t *);
extern Pssent_t *
pssread(Pss_t *, Pss_id_t);
extern Pssent_t *
psssave(Pss_t *, Pssent_t *);
extern int
pssclose(Pss_t *);

extern int
pssttyadd(Pss_t *, const char *, Pss_dev_t);
extern Pss_dev_t
pssttydev(Pss_t *, const char *);
extern char *
pssttyname(Pss_t *, Pssent_t *);
