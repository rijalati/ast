...
#    undef PR_CTIME
#    define PR_CTIME(p)                                                      \
        (((p)->rusage_children.ru_utime.tv_sec                               \
          + (p)->rusage_children.ru_stime.tv_sec)                            \
         * PR_HZ                                                             \
         + ((((p)->rusage_children.ru_utime.tv_usec                          \
              + (p)->rusage_children.ru_stime.tv_usec)                       \
             * PR_HZ)                                                        \
            / 1000000))
#    undef PR_START
...
#    undef PR_TIME
#    define PR_TIME(p)                                                       \
        (((p)->rusage_self.ru_utime.tv_sec                                   \
          + (p)->rusage_self.ru_stime.tv_sec)                                \
         * PR_HZ                                                             \
         + ((((p)->rusage_self.ru_utime.tv_usec                              \
              + (p)->rusage_self.ru_stime.tv_usec)                           \
             * PR_HZ)                                                        \
            / 1000000))
