...
tmain()
{
    ...
    if ((rc = asocaschar(&vc, 1, 2)) != 1)
        terror(
        "asocaschar return value failed -- expected %d, got %d", 1, rc);
    else if (vc != 2)
        terror("asocaschar value failed -- expected %d, got %d", 1, vc);
    else if ((rc = asocaschar(&vc, 1, 3)) != 2)
        terror(
        "asocaschar return value failed -- expected %d, got %d", 2, rc);
    else if (vc != 2)
    ...
    if ((rs = asocasshort(&vs, 1, 2)) != 1)
        terror(
        "asocasshort return value failed -- expected %d, got %d", 1, rs);
    else if (vs != 2)
        terror("asocasshort value failed -- expected %d, got %d", 2, vs);
    else if ((rs = asocasshort(&vs, 1, 3)) != 2)
        terror(
        "asocasshort return value failed -- expected %d, got %d", 2, rs);
    else if (vs != 2)
        terror("asocasshort value failed -- expected %d, got %d", 2, vs);
    ...
    if ((rl = asocaslong(&vl, 1, 2)) != 1)
        terror(
        "asocaslong return value failed -- expected %d, got %ld", 1, rl);
    else if (vl != 2)
        terror("asocaslong value failed -- expected %d, got %ld", 2, vl);
    else if ((rl = asocaslong(&vl, 1, 3)) != 2)
        terror(
        "asocaslong return value failed -- expected %d, got %ld", 2, rl);
    else if (vl != 2)
        terror("asocaslong value failed -- expected %d, got %ld", 2, vl);
