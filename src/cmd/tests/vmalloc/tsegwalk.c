...
memory(Vmalloc_t *vm,
       ...
       Vmdisc_t *disc)
#else
static Void_t *memory(vm, caddr, oldsize, newsize, disc) Vmalloc_t *vm;
Void_t *caddr;
size_t oldsize;
size_t newsize;
Vmdisc_t *disc;
...
static int
except(Vmalloc_t *vm, int type, Void_t *data, Vmdisc_t *disc)
{
...
#if __STD_C
static int
walk(Vmalloc_t *vm, Void_t *addr, size_t size, Vmdisc_t *disc, Void_t *handle)
#else
static int walk(vm, addr, size, disc) Vmalloc_t *vm;
Void_t *addr;
size_t size;
Vmdisc_t *disc;
#endif
