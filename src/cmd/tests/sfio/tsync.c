...
#if __STD_C
static int
except(Sfio_t *f, int type, Void_t *arg, Sfdisc_t *disc)
#else
static int except(f, type, arg, disc) Sfio_t *f;
int type;
Void_t *arg;
Sfdisc_t *disc;
#endif
...
#if __STD_C
int
event(Sfio_t *f, int type, Void_t *arg, Sfdisc_t *disc)
#else
int event(f, type, arg, disc) Sfio_t *f;
int type;
Void_t *arg;
Sfdisc_t *disc;
#endif
...
#if __STD_C
ssize_t
newline(Sfio_t *f, const Void_t *buf, size_t n, Sfdisc_t *disc)
#else
ssize_t newline(f, buf, n, disc) Sfio_t *f;
Void_t *buf;
size_t n;
Sfdisc_t *disc;
#endif
