...
#else
static int compare(dt, o1, o2, disc) Dt_t *dt;
Void_t *o1;
Void_t *o2;
Dtdisc_t *disc;
#endif
...
#if __STD_C
static int
rcompare(Dt_t *dt, Void_t *o1, Void_t *o2, Dtdisc_t *disc)
#else
static int rcompare(dt, o1, o2, disc) Dt_t *dt;
Void_t *o1;
Void_t *o2;
Dtdisc_t *disc;
#endif
...
#if __STD_C
static Void_t *
newint(Dt_t *dt, Void_t *o, Dtdisc_t *disc)
#else
...
#if __STD_C
static unsigned int
hashint(Dt_t *dt, Void_t *o, Dtdisc_t *disc)
#else
