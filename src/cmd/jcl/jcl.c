...
= "[-1s1I?\n@(#)$Id: jcl (AT&T Research) 2013-03-04 $\n]" USAGE_LICENSE
  ...
  "specified. If \b--map\b is not specified then \b--map=" JCL_MAPFILE
  "\b "
  ...
  "initialized by exporting \b" JCL_AUTO
  "\b\aname\a=\avalue\a or by "
  ...
  "option is specified then the default " JCL_MAPFILE
  ", if it exists, is "
