...
void test_compress
OF((Byte * compr, uLong comprLen, Byte *uncompr, uLong uncomprLen));
...
void
test_sync OF((Byte * compr, uLong comprLen, Byte *uncompr, uLong uncomprLen));
 ...
 */
void test_compress(compr, comprLen, uncompr, uncomprLen) Byte *compr,
*uncompr;
