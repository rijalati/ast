...
#        define ZLIB_WIN32
#    endif
#    if (defined(ZLIB_MSDOS) || defined(ZLIB_OS2) || defined(ZLIB_WINDOWS))  \
    && !defined(ZLIB_WIN32)
...
#        define ZLIB_STDC
#    endif
#    if !defined(ZLIB_STDC)                                                  \
    && (defined(ZLIB_MSDOS) || defined(ZLIB_WINDOWS) || defined(ZLIB_WIN32))
#        define ZLIB_STDC
#    endif
...
#    if defined(__OS400__)                                                   \
    && !defined(ZLIB_STDC) /* iSeries (formerly AS/400). */
#        define ZLIB_STDC
#    endif

#    ifndef ZLIB_STDC
#        ifndef const /* cannot use !defined(ZLIB_STDC) && !defined(const)   \
                         on Mac */
