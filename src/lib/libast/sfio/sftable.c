...
#if __STD_C
static Fmtpos_t *
sffmtpos(Sfio_t *f, const char *form, va_list args, Sffmt_t *ft, int type)
#else
...
sfcvinit()
{
    ...
    _Sftype['e'] = _Sftype['E'] = _Sftype['a'] = _Sftype['A'] = _Sftype['g']
    = _Sftype['G'] = _Sftype['f'] = SFFMT_FLOAT;
