...
#    if __STD_C
static int
treecompare(Dt_t *dt, char *one, char *two, Dtdisc_t *disc)
#    else
static int treecompare(dt, one, two, disc) Dt_t *dt;
char *one;
char *two;
Dtdisc_t *disc;
#    endif
...
#    if __STD_C
Void_t *
tsearch(const Void_t *key,
        Void_t **rootp,
        int (*comparf)(const Void_t *, const Void_t *))
#    else
Void_t *tsearch(key, rootp, comparf) Void_t *key;
Void_t **rootp;
int (*comparf)();
#    endif
{
...
#    if __STD_C
Void_t *
tfind(const Void_t *key,
      Void_t *const *rootp,
      int (*comparf)(const Void_t *, const Void_t *))
#    else
Void_t *tfind(key, rootp, comparf) Void_t *key;
Void_t **rootp;
int (*comparf)();
#    endif
{
...
#    if __STD_C
Void_t *
tdelete(const Void_t *key,
        Void_t **rootp,
        int (*comparf)(const Void_t *, const Void_t *))
#    else
Void_t *tdelete(key, rootp, comparf) Void_t *key;
Void_t **rootp;
int (*comparf)();
#    endif
{
...
#    if __STD_C
static void
_twalk(Tree_t *obj, void (*action)(const Void_t *, VISIT, int), int level)
#    else
static void _twalk(obj, action, level) Tree_t *obj;
void (*action)();
int level;
#    endif
{
...
#    if __STD_C
void
twalk(const Void_t *root, void (*action)(const Void_t *, VISIT, int))
#    else
void twalk(root, action) Void_t *root;
void (*action)();
#    endif
{
    reg Tree_t *o;
