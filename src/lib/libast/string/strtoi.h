...
#        else
S2I_function(a, size, e, basep, m) const char *a;
size_t size;
char **e;
char *basep;
int m;
...
#        else
S2I_function(a, size, e, base) const char *a;
size_t size;
char **e;
int base;
#        endif
...
#        else
S2I_function(a, e, basep, m) const char *a;
char **e;
char *basep;
int m;
#        endif
...
#        else
S2I_function(a, e, base) const char *a;
char **e;
int base;
#        endif
#    endif
#endif
{
    ...
    if (base > 36 && base <= SF_RADIX) {
        ...
        if (conformance < 0)
            conformance
            = !strcmp(astconf("CONFORMANCE", NiL, NiL), "standard");
        if (conformance)
            base = 1;
    }
#endif
