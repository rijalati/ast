...
#if __STD_C
static struct map *
getmapping(Dosdisc_t *dp, Sfoff_t offset, int whence)
#else
...
#if __STD_C
static ssize_t
dos_read(Sfio_t *iop, void *buff, size_t size, Sfdisc_t *disc)
#else
...
#if __STD_C
static Sfoff_t
cur_offset(Dosdisc_t *dp, Sfoff_t offset, Sfio_t *iop, int whence)
#else
...
#if __STD_C
static Sfoff_t
dos_seek(Sfio_t *iop, Sfoff_t offset, int whence, Sfdisc_t *disc)
#else
...
#if __STD_C
static int
dos_except(Sfio_t *iop, int type, void *arg, Sfdisc_t *disc)
#else
