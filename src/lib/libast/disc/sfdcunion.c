...
#if __STD_C
static Sfoff_t
unseek(Sfio_t *f, Sfoff_t addr, int type, Sfdisc_t *disc)
#else
static Sfoff_t unseek(f, addr, type, disc) Sfio_t *f;
Sfoff_t addr;
int type;
Sfdisc_t *disc;
#endif
...
#if __STD_C
static int
unexcept(Sfio_t *f, int type, Void_t *data, Sfdisc_t *disc)
#else
static int unexcept(f, type, data, disc) Sfio_t *f;
int type;
Void_t *data;
Sfdisc_t *disc;
#endif
...
#else
int sfdcunion(f, array, n) Sfio_t *f;
Sfio_t **array;
int n;
#endif
{
