...
#if __STD_C
static ssize_t
filterread(Sfio_t *f, Void_t *buf, size_t n, Sfdisc_t *disc)
#else
...
#if __STD_C
static Sfoff_t
filterseek(Sfio_t *f, Sfoff_t addr, int offset, Sfdisc_t *disc)
#else
...
#if __STD_C
static int
filterexcept(Sfio_t *f, int type, Void_t *data, Sfdisc_t *disc)
#else
