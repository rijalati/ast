...
#if __STD_C
static ssize_t
pfxwrite(Sfio_t *f, const Void_t *buf, size_t n, Sfdisc_t *dp)
#else
static ssize_t pfxwrite(f, buf, n, dp) Sfio_t *f;
Void_t *buf;
size_t n;
Sfdisc_t *dp;
#endif
...
#if __STD_C
static int
pfxexcept(Sfio_t *f, int type, Void_t *data, Sfdisc_t *dp)
#else
static int pfxexcept(f, type, data, dp) Sfio_t *f;
int type;
Void_t *data;
Sfdisc_t *dp;
#endif
...
#if __STD_C
int
sfdcprefix(Sfio_t *f, const char *prefix)
#else
int sfdcprefix(f, prefix) Sfio_t *f;
char *prefix;
#endif
{
    Prefix_t *pfx;
