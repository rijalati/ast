...
#    define FTS_NOSEEDOTDIR                                                  \
        0x00000800                   /* never retain leading . dir           \
                                      */
...
fts_local(FTSENT *);
extern int
fts_notify(int (*)(FTS *, FTSENT *, void *), void *);
extern FTS *
fts_open(char *const *, int, int (*)(FTSENT *const *, FTSENT *const *));
extern FTS *
fts_openat(int, char *const *, int, int (*)(FTSENT *const *, FTSENT *const *));
extern FTSENT *
fts_read(FTS *);
extern int
