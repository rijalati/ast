...
error(int, ...);
extern int
errormsg(const char *, int, ...);
extern void
errorv(const char *, int, va_list);
extern char *
errorx(const char *, const char *, const char *, const char *);
extern Error_info_t *
errorctx(Error_info_t *, int, int);
