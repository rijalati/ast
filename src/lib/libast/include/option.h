...
typedef int (*Optinfo_f)(struct Opt_s *,
                         Sfio_t *,
                         const char *,
                         struct Optdisc_s *);
...
extern int
optget(char **, const char *);
extern int
optjoin(char **, ...);
extern char *
opthelp(const char *, const char *);
extern char *
optusage(const char *);
extern int
optstr(const char *, const char *);
extern int
optesc(Sfio_t *, const char *, int);
extern Opt_t *
optctx(Opt_t *, Opt_t *);
