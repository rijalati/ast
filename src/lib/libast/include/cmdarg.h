...
#    ifndef cmdopen
extern Cmdarg_t *
cmdopen(char **, int, int, const char *, int);
#    endif
extern Cmdarg_t *
cmdopen_20110505(char **, int, int, const char *, int, Error_f);
extern Cmdarg_t *
cmdopen_20120411(char **, int, int, const char *, Cmddisc_t *);
extern int
cmdflush(Cmdarg_t *);
extern int
cmdarg(Cmdarg_t *, const char *, int);
extern int
cmdclose(Cmdarg_t *);
