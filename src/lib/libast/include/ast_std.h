...
typedef struct
{
    ...
    char pad[936 - sizeof(void *) - 2 * sizeof(int) - 8 * sizeof(void *)
             - sizeof(Mbstate_t)];
...
extern int
ftruncate64(int, off64_t);
#    endif
#    if !defined(lseek) && _lib_lseek64
#        define lseek lseek64
extern off64_t
lseek64(int, off64_t, int);
#    endif
#    if !defined(truncate) && _lib_truncate64
#        define truncate truncate64
extern int
truncate64(const char *, off64_t);
#    endif
...
extern void
qsort(void *, size_t, size_t, Qsortcmp_f);
#    endif
#    if !defined(qsort_r) && !_lib_qsort_r
#        define qsort_r _ast_qsort_r
extern void
qsort_r(void *, size_t, size_t, Qsortcmp_r_f, void *);
#    endif
