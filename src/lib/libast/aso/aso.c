...
static LONGLONG
_aso_InterlockedCompareExchange64_init(LONGLONG volatile *,
                                       LONGLONG,
                                       LONGLONG);

_aso_InterlockedCompareExchange64_f _aso_InterlockedCompareExchange64
= _aso_InterlockedCompareExchange64_init;

static LONGLONG
_aso_InterlockedCompareExchange64_32(LONGLONG volatile *p,
                                     LONGLONG o,
                                     LONGLONG n)
{
    LL_t *lp = ( LL_t * ) p;
...
static LONGLONG
_aso_InterlockedCompareExchange64_init(LONGLONG volatile *p,
                                       LONGLONG o,
                                       LONGLONG n)
{
...
static LONGLONG
_aso_InterlockedExchangeAdd64_init(LONGLONG volatile *, LONGLONG);

_aso_InterlockedExchangeAdd64_f _aso_InterlockedExchangeAdd64
= _aso_InterlockedExchangeAdd64_init;

static LONGLONG
_aso_InterlockedExchangeAdd64_32(LONGLONG volatile *p, LONGLONG n)
{
    LONGLONG o;
...
static LONGLONG
_aso_InterlockedExchangeAdd64_init(LONGLONG volatile *p, LONGLONG n)
{
    if (!(_aso_InterlockedExchangeAdd64 = ( _aso_InterlockedExchangeAdd64_f )
          getsymbol(MODULE_kernel, "InterlockedExchangeAdd64")))
...
/*
 * { 8 16 32 [64] } compare with old, swap with new if same, and return old
 * value
 */
