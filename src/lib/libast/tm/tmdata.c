...
static Tm_zone_t zone[] = { 0,      "GMT",  0,      (0 * 60),
                            0, /* UTC			*/
                            0,      "UCT",  0,      (0 * 60),
                            0, /* UTC			*/
                            0,      "UTC",  0,      (0 * 60),
                            ...
                            0, /* Newfoundland		*/
                            "GBR",  "",     "BST",  (0 * 60),
                            TM_DST, /* British Summer	*/
                            "EUR",  "WET",  "WEST", (0 * 60),
                            TM_DST, /* Western Eurpoean	*/
                            0,      "CET",  "CEST", -(1 * 60),
                            TM_DST, /* Central European	*/
                            0,      "MET",  "MEST", -(1 * 60),
                            TM_DST, /* Middle European	*/
                            0,      "EET",  "EEST", -(2 * 60),
                            TM_DST, /* Eastern Eurpoean	*/
                            "ISR",  "IST",  "IDT",  -(3 * 60),
                            TM_DST, /* Israel		*/
                            "IND",  "IST",  0,      -(5 * 60 + 30),
                            0, /* India		*/
                            ...
                            0, /* Australia Western	*/
                            0,      "ACST", 0,      -(9 * 60 + 30),
                            TM_DST, /* Australia Central	*/
                            0,      "CST",  0,      -(9 * 60 + 30),
                            TM_DST, /* Australia Central	*/
                            0,      "AEST", 0,      -(10 * 60),
                            TM_DST, /* Australia Eastern	*/
                            0,      "EST",  0,      -(10 * 60),
                            TM_DST, /* Australia Eastern	*/
                            "NZL",  "NZST", "NZDT", -(12 * 60),
                            TM_DST, /* New Zealand		*/
