...
/* : : generated by proto : : */
/* : : generated from features/map.c by iffe version 2013-11-14 : : */
#ifndef _def_map_ast
...
#    undef error_break
#    define error_break _ast_error_break
#    undef errorctx
#    define errorctx _ast_errorctx
#    undef errorf
#    define errorf _ast_errorf
#    undef errormsg
#    define errormsg _ast_errormsg
#    undef errorv
#    define errorv _ast_errorv
#    undef errorx
#    define errorx _ast_errorx
#    undef fnmatch
...
#    undef strngrpmatch
#    define strngrpmatch _ast_strngrpmatch
#    undef strntod
...
#    undef strsort_r
#    define strsort_r _ast_strsort_r
#    undef strsubmatch
...
extern __MANGLE__ int posix_memalign __PROTO__((__V_ **, size_t, size_t));
#    undef pvalloc
#    define pvalloc _ast_pvalloc
#    undef realloc
...
#    define memfatal_20130509 _ast_memfatal_20130509
