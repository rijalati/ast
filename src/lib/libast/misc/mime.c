...
arg(Parse_t *pp, int first)
{
    ...
    if (first >= 0 && pp->name.size > 0
        && pp->name.data[pp->name.size - 1] == ':')
        return 0;
                    ...
                    if (arg(&a1, -1)) {
                        ...
                        if (a1.name.size == 6
                            ...
                            if (a2.name.size != a3.name.size)
                                ...
                                c ^= (a1.name.size == 6 ? strncmp
                                                        : strncasecmp)(
                                     a2.name.data, a3.name.data, a2.name.size)
                                     == 0;
                            if (c)
                                break;
                            goto skip;
                            ...
                            if (a1.name.size != a3.name.size)
                                ...
                                c ^= (a4.name.size ? strncasecmp : strncmp)(
                                     a1.name.data, a3.name.data, a1.name.size)
                                     == 0;
                            if (c)
                                break;
                            goto skip;
