 ...
 * this restricts the various "standard" mount prototype conflicts to this
 * spot this means that code that includes <fs3d.h> cannot access the real
 * mount (at least without some additional macro hackery
 */

#undef mount

extern int
mount(const char *, char *, int, void *);
