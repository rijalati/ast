...
#    define _LIB_pthread 1 /* -lpthread is a library */
#    define _key___thread                                                    \
        1 /* __thread keyword exists and works with -lpthread                \
           */
...
#        define va_listval(p)                                                \
            (*(p)) /* retrieve va_list from va_arg(ap,va_listarg)            \
                    */
