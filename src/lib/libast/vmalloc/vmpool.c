...
#    if __STD_C
static Void_t *
poolalloc(Vmalloc_t *vm, size_t size, int local)
#    else
...
#    if __STD_C
static int
poolfree(Vmalloc_t *vm, Void_t *data, int local)
#    else
...
#    if __STD_C
static Void_t *
poolresize(Vmalloc_t *vm, Void_t *data, size_t size, int type, int local)
#    else
...
#    if __STD_C
static Void_t *
poolalign(Vmalloc_t *vm, size_t size, size_t align, int local)
#    else
...
/* get statistics */
static int
poolstat(Vmalloc_t *vm, Vmstat_t *st, int local)
{
    size_t size;
    Pool_t *pl;
    Vmpool_t *pool = ( Vmpool_t * )vm->data;
...
static int
poolevent(Vmalloc_t *vm, int event, Void_t *arg)
{
    Vmpool_t *pool;
