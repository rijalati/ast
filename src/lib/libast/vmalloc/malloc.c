...
**	    getmemory=f	enable f[:g..] getmemory() functions if supported, all by
*default *			    anon: mmap(MAP_ANON) *			    break|sbrk: sbrk()
...
#                define VMBLOCK                                              \
                    {                                                        \
                        int _vmblock = _sigblock();
#                define VMUNBLOCK                                            \
                    _sigunblock(_vmblock);                                   \
                    }
...
_vmstart(int freeing)
{
    ...
    if (_Vmassert & VM_debug)
        debug_printf(2,
                     ...
                     _Vmstart == 0
                     ? "UNINITIALIZED"
                     : _Vmstart == VM_STARTING
                       ? "STARTING"
                       : _Vmstart == VM_STARTED ? "STARTED" : "ERROR");
    ...
    if (_Vmassert & VM_verbose)
        debug_printf(2,
                     "vmalloc: method=%s\n",
                     Vmregion->meth.meth == VM_MTBEST
                     ? "best"
                     : Vmregion->meth.meth == VM_MTDEBUG
                       ? "debug"
                       : Vmregion->meth.meth == VM_MTLAST
                         ? "last"
                         : Vmregion->meth.meth == VM_MTPOOL ? "pool"
                                                            : "unknown");
...
extern Void_t *
calloc(size_t n_obj, size_t s_obj)
{
    Void_t *addr;

    VMPROLOGUE(0);
    addr = (*Vmregion->meth.resizef)(
    Vmregion, NIL(Void_t *), n_obj * s_obj, VM_RSZERO, 0);
    VMEPILOGUE(0);
...
extern Void_t *
realloc(Void_t *data, size_t size)
{
    Void_t *addr;
    Vmalloc_t *vm;
...
extern int
posix_memalign(Void_t **memptr, size_t align, size_t size)
{
    Void_t *mem;

    if (align == 0 || (align % sizeof(Void_t *)) != 0
        || ((align - 1) & align) != 0)
        return EINVAL;
...
static void
vm_free_hook(void *ptr, const void *caller)
{
    free(ptr);
}

static void *
vm_malloc_hook(size_t size, const void *caller)
{
    void *r;
...
static void *
vm_memalign_hook(size_t align, size_t size, const void *caller)
{
    void *r;
...
static void *
vm_realloc_hook(void *ptr, size_t size, const void *caller)
{
    void *r;
...
#                if __lib__malloc
extern Void_t *F2(_calloc, size_t, n, size_t, m)
{
    return calloc(n, m);
}
extern Void_t
...
extern Void_t *F1(_malloc, size_t, n)
{
    return malloc(n);
}
#                    if _lib_memalign
extern Void_t *F2(_memalign, size_t, a, size_t, n)
{
    return memalign(a, n);
}
#                    endif
#                    if _lib_pvalloc
extern Void_t *F1(_pvalloc, size_t, n)
{
    return pvalloc(n);
}
#                    endif
extern Void_t *
F2(_realloc, Void_t *, p, size_t, n)
{
    return realloc(p, n);
}
#                    if _lib_valloc
extern Void_t *F1(_valloc, size_t, n)
{
    return valloc(n);
}
#                    endif
...
#                if _lib___malloc
extern Void_t *F2(__calloc, size_t, n, size_t, m)
{
    return calloc(n, m);
}
extern Void_t
...
extern Void_t *F1(__malloc, size_t, n)
{
    return malloc(n);
}
#                    if _lib_memalign
extern Void_t *F2(__memalign, size_t, a, size_t, n)
{
    return memalign(a, n);
}
#                    endif
#                    if _lib_pvalloc
extern Void_t *F1(__pvalloc, size_t, n)
{
    return pvalloc(n);
}
#                    endif
extern Void_t *
F2(__realloc, Void_t *, p, size_t, n)
{
    return realloc(p, n);
}
#                    if _lib_valloc
extern Void_t *F1(__valloc, size_t, n)
{
    return valloc(n);
}
#                    endif
...
extern Void_t *F2(__libc_calloc, size_t, n, size_t, m)
{
    return calloc(n, m);
}
extern Void_t
F1(__libc_cfree, Void_t *, p)
{
    free(p);
}
extern Void_t
F1(__libc_free, Void_t *, p)
{
    free(p);
}
extern Void_t *F1(__libc_malloc, size_t, n)
{
    return malloc(n);
}
#                    if _lib_memalign
extern Void_t *F2(__libc_memalign, size_t, a, size_t, n)
{
    return memalign(a, n);
}
#                    endif
#                    if _lib_pvalloc
extern Void_t *F1(__libc_pvalloc, size_t, n)
{
    return pvalloc(n);
}
#                    endif
extern Void_t *
F2(__libc_realloc, Void_t *, p, size_t, n)
{
    return realloc(p, n);
}
#                    if _lib_valloc
extern Void_t *F1(__libc_valloc, size_t, n)
{
    return valloc(n);
}
#                    endif
...
extern Void_t *F2(_ast_calloc, size_t, n, size_t, m)
{
    return calloc(n, m);
}
extern Void_t
F1(_ast_cfree, Void_t *, p)
{
    free(p);
}
extern Void_t
F1(_ast_free, Void_t *, p)
{
    free(p);
}
extern Void_t *F1(_ast_malloc, size_t, n)
{
    return malloc(n);
}
#        if _lib_memalign
extern Void_t *F2(_ast_memalign, size_t, a, size_t, n)
{
    return memalign(a, n);
}
#        endif
#        if _lib_pvalloc
extern Void_t *F1(_ast_pvalloc, size_t, n)
{
    return pvalloc(n);
}
#        endif
extern Void_t *
F2(_ast_realloc, Void_t *, p, size_t, n)
{
    return realloc(p, n);
}
#        if _lib_valloc
extern Void_t *F1(_ast_valloc, size_t, n)
{
    return valloc(n);
}
#        endif
...
#            if _lib_mallopt
extern int
F2(_ast_mallopt, int, cmd, int, value)
{
