    ...
    do {
        ...
        case REX_ALT:
            ...
            if (e->re.group.expr.binary.right
                && decomp(e->re.group.expr.binary.right,
                          e,
                          sp,
                          type,
                          delimiter,
        ...
        case REX_CONJ:
            ...
            sfputc(sp, '&');
            if (decomp(
                e->re.group.expr.binary.right, e, sp, type, delimiter, flags))
                return 1;
            break;
        case REX_GROUP:
        ...
        case REX_GROUP_COND:
            ...
            if (e->re.group.expr.binary.left
                && decomp(e->re.group.expr.binary.left,
                          e,
                          sp,
                          type,
                          delimiter,
            ...
            if (q = e->re.group.expr.binary.right) {
                ...
                if (q->re.group.expr.binary.right
                    && decomp(q->re.group.expr.binary.right,
                              q,
                              sp,
                              type,
                              delimiter,
