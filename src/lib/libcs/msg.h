...
#    define MSG_PURE(c)                                                      \
        ((c) & ~(((1 << MSG_ARG_CALL) - 1) & ~((1 << MSG_ARG_INDEX) - 1)))
...
#    define msggetsize(p)                                                    \
        ((((p)[0] & ((1 << MSG_SIZE_BITS) - 1)) << MSG_SIZE_BITS)            \
         | ((p)[1] & ((1 << MSG_SIZE_BITS) - 1)))
...
extern int
msggetmask(char *, int, unsigned long);
extern int
msgindex(const char *);
extern int
msglist(Sfio_t *, Msg_call_t *, int, unsigned long);
extern const char *
msgname(unsigned long);
extern unsigned long
msgsetmask(const char *);

extern unsigned long
msggetu(char **, char *);
extern int
msgputu(char **, char *, unsigned long);
extern size_t
msggetz(char **, char *, void *, size_t);
extern int
msgputz(char **, char *, void *, size_t);

extern ssize_t
msgcall(int, unsigned long, unsigned long, Msg_return_t *, ...);
extern ssize_t
msgvcall(int, unsigned long, unsigned long, Msg_return_t *, void **, va_list);
extern long
msgreturn(int, unsigned long, ...);
extern long
msgvreturn(int, unsigned long, void **, va_list);

extern ssize_t
msgblast(Msg_call_t *);
extern ssize_t
msgread(int, char *, size_t);
extern ssize_t
msgrecv(int, Msg_call_t *);
extern ssize_t
msgsend(int, Msg_call_t *, unsigned long, long, int, void *);
