...
struct Uu_s;
typedef struct Uu_s Uu_t;
struct Uudisc_s;
typedef struct Uudisc_s Uudisc_t;
struct Uumeth_s;
typedef struct Uumeth_s Uumeth_t;
...
extern Uu_t *
uuopen(Uudisc_t *, Uumeth_t *);
extern int
uuclose(Uu_t *);

extern ssize_t
uuencode(Uu_t *, Sfio_t *, Sfio_t *, size_t, const char *);
extern ssize_t
uudecode(Uu_t *, Sfio_t *, Sfio_t *, size_t, const char *);
