...
#if __STD_C
static int
_vdfilbuf(reg Vdio_t *io)
#else
static int _vdfilbuf(io) reg Vdio_t *io;
#endif
{
    reg int n;
...
#if __STD_C
static int
_vdflsbuf(reg Vdio_t *io)
#else
static int _vdflsbuf(io) reg Vdio_t *io;
#endif
{
    reg int n;
...
#if __STD_C
static ulong
_vdgetu(reg Vdio_t *io, reg ulong v)
#else
static ulong _vdgetu(io, v) reg Vdio_t *io;
reg ulong v;
#endif
{
    reg int c;
...
#if __STD_C
static int
_vdputu(reg Vdio_t *io, ulong v)
#else
static int _vdputu(io, v) reg Vdio_t *io;
reg ulong v;
#endif
{
    reg uchar *s, *next;
...
#if __STD_C
static int
_vdread(Vdio_t *io, reg uchar *s, reg int n)
#else
static int _vdread(io, s, n) Vdio_t *io;
reg uchar *s;
reg int n;
#endif
{
...
#if __STD_C
static int
_vdwrite(Vdio_t *io, reg uchar *s, reg int n)
#else
static int _vdwrite(io, s, n) Vdio_t *io;
reg uchar *s;
reg int n;
#endif
{
...
Vdbufio_t _Vdbufio
= { _vdfilbuf, _vdflsbuf, _vdgetu, _vdputu, _vdread, _vdwrite };
