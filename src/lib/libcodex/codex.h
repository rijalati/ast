...
struct Codex_s;
typedef struct Codex_s Codex_t;
struct Codexdata_s;
typedef struct Codexdata_s Codexdata_t;
struct Codexdisc_s;
typedef struct Codexdisc_s Codexdisc_t;
struct Codexmeth_s;
typedef struct Codexmeth_s Codexmeth_t;
...
#        ifdef __STDC__
#            define CODEXLIB(m)                                              \
                extern Codexmeth_t *codex_lib(const char *name)              \
                {                                                            \
                    return &codex_##m;                                       \
                }                                                            \
                unsigned long plugin_version(void)                           \
                {                                                            \
                    return CODEX_PLUGIN_VERSION;                             \
                }
#        else
#            define CODEXLIB(m)                                              \
                extern Codexmeth_t *codex_lib(name) char *name;              \
                {                                                            \
                    return &codex_##m;                                       \
                }                                                            \
...
extern Codexmeth_t *
codex_lib(const char *);

#        undef extern

#    endif

#    define codexinit(d, e)                                                  \
        (memset(d, 0, sizeof(*(d))),                                         \
         (d)->version = CODEX_VERSION,                                       \
         (d)->errorf = (Error_f)(e))
...
extern int
codex(Sfio_t *, const char *, Codexnum_t, Codexdisc_t *, Codexmeth_t *);
extern int
codexpop(Sfio_t *, int);
extern int
codexcmp(const char *, const char *);
extern int
codexdata(Sfio_t *, Codexdata_t *);
extern ssize_t
codexgetpass(const char *, void *, size_t);
extern Codexmeth_t *
codexid(const void *, size_t, char *, size_t);
extern Codexmeth_t *
codexlist(Codexmeth_t *);
extern Codexmeth_t *
codexmeth(const char *);
extern int
codexadd(const char *, Codexmeth_t *);
extern Sfio_t *
codexnull(void);
extern ssize_t
codexpass(void *, size_t, Codexdisc_t *, Codexmeth_t *);
extern int
codexsize(Sfio_t *, Sfoff_t);
extern int
codexoptinfo(Opt_t *, Sfio_t *, const char *, Optdisc_t *);
