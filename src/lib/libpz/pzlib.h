...
#    define PZ_INTERNAL                                                      \
        (PZ_HANDLE | PZ_UNKNOWN | PZ_MAINONLY | PZ_ROWONLY | PZ_AGAIN        \
         | PZ_POP | PZ_ERROR)
...
#    define PZ_HDR_ARR(x)                                                    \
        ((x) >= 0x41 && (x) <= 0x5a) /* header array op                      \
                                      */
#    define PZ_HDR_BUF(x)                                                    \
        ((x) >= 0x61 && (x) <= 0x7a) /* header buffer op                     \
                                      */
...
pznospace(Pz_t *);
extern int
pzsdeflate(Pz_t *, Sfio_t *);
extern int
pzsinflate(Pz_t *, Sfio_t *);
extern int
pzssplit(Pz_t *);
