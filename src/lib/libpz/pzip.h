...
struct Pz_s;
typedef struct Pz_s Pz_t;
struct Pzconvert_s;
typedef struct Pzconvert_s Pzconvert_t;
struct Pzcount_s;
typedef struct Pzcount_s Pzcount_t;
struct Pzdisc_s;
typedef struct Pzdisc_s Pzdisc_t;
struct Pzformat_s;
typedef struct Pzformat_s Pzformat_t;
struct Pzindex_s;
typedef struct Pzindex_s Pzindex_t;
struct Pzpart_s;
typedef struct Pzpart_s Pzpart_t;
struct Pzsplit_s;
typedef struct Pzsplit_s Pzsplit_t;

typedef ssize_t (*Pzconvert_f)(Pz_t *,
                               Pzconvert_t *,
                               const unsigned char *,
                               unsigned char *,
                               Pzdisc_t *);
...
extern Pz_t *
pzopen(Pzdisc_t *, const char *, unsigned long);
extern int
pzclose(Pz_t *);

extern ssize_t
pzread(Pz_t *, void *, size_t);
extern ssize_t
pzwrite(Pz_t *, Sfio_t *, const void *, size_t);
extern int
pzsync(Pz_t *);
extern int
pzfile(Pz_t *);
...
extern int
pzdeflate(Pz_t *, Sfio_t *);
extern int
pzinflate(Pz_t *, Sfio_t *);

extern Sfio_t *
pzfind(Pz_t *, const char *, const char *, const char *);
extern int
pzlib(Pz_t *, const char *, int);
extern const char *
pzinit(Pz_t *, const char *, Pzinit_f);

extern int
pzoptions(Pz_t *, Pzpart_t *, char *, int);
extern int
pzpartinit(Pz_t *, Pzpart_t *, const char *);
extern int
pzpartmap(Pz_t *, Pzpart_t *);
extern int
pzpartition(Pz_t *, const char *);
extern int
pzpartprint(Pz_t *, Pzpart_t *, Sfio_t *);
extern int
pzpartread(Pz_t *);
extern int
pzpartwrite(Pz_t *, Sfio_t *);
extern Pzpart_t *
pzpartget(Pz_t *, const char *);
extern Pzpart_t *
pzpartnext(Pz_t *, Pzpart_t *);
extern Pzpart_t *
pzpartset(Pz_t *, Pzpart_t *);

extern int
pzheadread(Pz_t *);
extern int
pzheadwrite(Pz_t *, Sfio_t *);
extern int
pzheadprint(Pz_t *, Sfio_t *, int);

extern int
pzdcconvert(Pz_t *, const Pzconvert_t *);

extern ssize_t
pzfixed(Pz_t *, Sfio_t *, void *, size_t);

extern int
sfdcpzip(Sfio_t *, const char *, unsigned long, Pzdisc_t *);
extern int
sfdczip(Sfio_t *, const char *, const char *, Error_f);
