...
#    define ppisseparate(x)                                                  \
        (((x) >= N_PP) && ((x) <= T_WSTRING) || ((x) >= N_NUMBER)            \
         || ((x) == '+') || ((x) == '-'))
...
#        define T_HEXADECIMAL_UL                                             \
            (N_NUMBER | N_HEXADECIMAL | N_UNSIGNED | N_LONG)
...
ppcpp(void);
extern void
ppcomment(char *, char *, char *, int);
extern void *
ppcontext(void *, int);
extern void
pperror(int, ...);
extern void
ppincref(char *, char *, int, int);
extern void
ppinput(char *, char *, int);
extern int
pplex(void);
extern void
ppline(int, char *);
extern void
ppmacref(struct ppsymbol *, char *, int, int, unsigned long);
extern void
ppop(int, ...);
extern void
pppragma(char *, char *, char *, char *, int);
extern int
ppprintf(char *, ...);
extern int
ppsync(void);
