...
#    ifndef MACKEYARGS
#        define MACKEYARGS                                                   \
            _BLD_DEBUG /* name=value macro formals and actuals */
#    endif
#    ifndef POOL
...
typedef void (
*PPMACREF)(struct ppsymbol *, const char *, int, int, unsigned long);
typedef int (*PPOPTARG)(int, int, const char *);
typedef void (
*PPPRAGMA)(const char *, const char *, const char *, const char *, int);
...
#    define PUSH_FILE(f, d) pppush(IN_FILE, f, NiL, d)
...
_PP_DELAY_ include<unistd.h> _PP_DELAY_ include<time.h>
...
extern void
ppassert(int, char *, char *);
extern void
ppbuiltin(void);
extern int
ppcall(struct ppsymbol *, int);
extern int
ppcontrol(void);
extern void
ppdump(void);
...
ppload(char *);
extern void
ppmapinclude(char *, char *);
extern char *
ppmodestr(long);
extern int
ppmultiple(struct ppfile *, struct ppsymbol *);
extern void
ppnest(void);
extern int
ppoption(char *);
...
pppdrop(char *);
extern char *
pppopen(char *, int, char *, char *, char *, char *, int);
extern int
pppread(char *);
extern int
pppredargs(void);
extern void
pppush(int, char *, char *, int);
extern struct ppsymbol *
pprefmac(char *, int);
extern int
ppsearch(char *, int, int);
extern int
ppset(long *, long, int);
extern char *
ppstatestr(long);
