...
static Suftree *
child_find(Suftree *node, Element c)
{
    Suftree *np, *last;
...
*/
Suftree *
bldsuftree(Element *src, long len)
{
...
*/
long
mtchsuftree(Suftree *tree, Element *str, long len, Element **mtchp)
{
    Suftree *match;
