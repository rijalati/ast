...
int TclUpdateReturnInfo(iPtr) Interp *iPtr; /* Interpreter for which
                                             * TCL_RETURN exception is being
                                             * processed. */
{
    int code;
...
int Tcl_TclEval(interp,
                cmd) Tcl_Interp *interp; /* Token for command interpreter
