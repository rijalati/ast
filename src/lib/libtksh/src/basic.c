...
static void DeleteInterpProc(interp) Tcl_Interp *interp; /* Interpreter to
                                                            delete. */
{
    Interp *iPtr = ( Interp * )interp;
    Tcl_HashEntry *hPtr;
...
int Tcl_InterpDeleted(interp) Tcl_Interp *interp;
{
...
void Tcl_DeleteTrace(interp, trace) Tcl_Interp *interp; /* Interpreter that
                                                           contains trace. */
...
int Tcl_SetRecursionLimit(interp,
                          depth) Tcl_Interp *interp; /* Interpreter whose
                                                      * nesting limit
                                                      * is to be set. */
...
void Tcl_AllowExceptions(interp) Tcl_Interp *interp; /* Interpreter in which
                                                        to set flag. */
{
    Interp *iPtr = ( Interp * )interp;
