...
typedef int(Tcl_CmdProc) _ANSI_ARGS_(
...
typedef int(Tcl_DriverInputProc) _ANSI_ARGS_(
(ClientData instanceData, char *buf, int toRead, int *errorCodePtr));
typedef int(Tcl_DriverOutputProc) _ANSI_ARGS_(
(ClientData instanceData, char *buf, int toWrite, int *errorCodePtr));
typedef int(Tcl_DriverSeekProc) _ANSI_ARGS_(
...
_ANSI_ARGS_((ClientData instanceData, char *optionName, Tcl_DString *dsPtr));
typedef void(Tcl_DriverWatchChannelProc)
...
EXTERN int Tcl_ConvertElement _ANSI_ARGS_((char *src, char *dst, int flags));
...
EXTERN Tcl_Trace Tcl_CreateTrace _ANSI_ARGS_((Tcl_Interp * interp,
                                              ...
                                              ClientData clientData));
EXTERN char *
Tcl_DbCkalloc _ANSI_ARGS_((unsigned int size, char *file, int line));
EXTERN int Tcl_DbCkfree _ANSI_ARGS_((char *ptr, char *file, int line));
EXTERN char *Tcl_DbCkrealloc
_ANSI_ARGS_((char *ptr, unsigned int size, char *file, int line));
...
EXTERN void Tcl_DeleteExitHandler _ANSI_ARGS_((Tcl_ExitProc * proc,
                                               ClientData clientData));
EXTERN void Tcl_DeleteFileHandler _ANSI_ARGS_((Tcl_File file));
...
EXTERN void Tcl_DeleteModalTimeout _ANSI_ARGS_((Tcl_TimerProc * proc,
                                                ClientData clientData));
...
EXTERN int
Tcl_ExprBoolean _ANSI_ARGS_((Tcl_Interp * interp, char *string, int *ptr));
EXTERN int
Tcl_ExprDouble _ANSI_ARGS_((Tcl_Interp * interp, char *string, double *ptr));
EXTERN int
Tcl_ExprLong _ANSI_ARGS_((Tcl_Interp * interp, char *string, long *ptr));
EXTERN int Tcl_ExprString _ANSI_ARGS_((Tcl_Interp * interp, char *string));
EXTERN int Tcl_FileReady _ANSI_ARGS_((Tcl_File file, int mask));
...
EXTERN void Tcl_FreeFile _ANSI_ARGS_((Tcl_File file));
...
EXTERN int
Tcl_GetBoolean _ANSI_ARGS_((Tcl_Interp * interp, char *string, int *boolPtr));
...
EXTERN ClientData Tcl_GetNotifierData
_ANSI_ARGS_((Tcl_File file, Tcl_FileFreeProc **freeProcPtr));
...
EXTERN char *
Tcl_GetVar _ANSI_ARGS_((Tcl_Interp * interp, char *varName, int flags));
EXTERN char *Tcl_GetVar2
_ANSI_ARGS_((Tcl_Interp * interp, char *part1, char *part2, int flags));
...
EXTERN char *
Tcl_JoinPath _ANSI_ARGS_((int argc, char **argv, Tcl_DString *resultPtr));
EXTERN int Tcl_LinkVar
_ANSI_ARGS_((Tcl_Interp * interp, char *varName, char *addr, int type));
EXTERN void
Tcl_Main _ANSI_ARGS_((int argc, char **argv, Tcl_AppInitProc *appInitProc));
...
EXTERN Tcl_Channel Tcl_OpenTcpClient _ANSI_ARGS_((Tcl_Interp * interp,
                                                  ...
                                                  int async));
EXTERN
Tcl_Channel Tcl_OpenTcpServer _ANSI_ARGS_((Tcl_Interp * interp,
                                           int port,
                                           char *host,
                                           Tcl_TcpAcceptProc *acceptProc,
                                           ClientData callbackData));
EXTERN char *
Tcl_ParseVar _ANSI_ARGS_((Tcl_Interp * interp, char *string, char **termPtr));
EXTERN int
Tcl_PkgProvide _ANSI_ARGS_((Tcl_Interp * interp, char *name, char *version));
EXTERN char *Tcl_PkgRequire
_ANSI_ARGS_((Tcl_Interp * interp, char *name, char *version, int exact));
EXTERN char *Tcl_PosixError _ANSI_ARGS_((Tcl_Interp * interp));
EXTERN void Tcl_Preserve _ANSI_ARGS_((ClientData data));
EXTERN void
Tcl_PrintDouble _ANSI_ARGS_((Tcl_Interp * interp, double value, char *dst));
...
(Tcl_Interp * interp, Tcl_RegExp regexp, char *string, char *start));
...
EXTERN int Tcl_ScanElement _ANSI_ARGS_((char *string, int *flagPtr));
...
_ANSI_ARGS_((void(*proc) _ANSI_ARGS_(TCL_VARARGS(char *, format))));
...
_ANSI_ARGS_((Tcl_Interp * interp, char *varName, char *newValue, int flags));
EXTERN char *Tcl_SetVar2 _ANSI_ARGS_(
...
EXTERN void
Tcl_SplitPath _ANSI_ARGS_((char *path, int *argcPtr, char ***argvPtr));
...
EXTERN int Tcl_UnregisterChannel _ANSI_ARGS_((Tcl_Interp * interp,
                                              Tcl_Channel chan));
EXTERN int
Tcl_UnsetVar _ANSI_ARGS_((Tcl_Interp * interp, char *varName, int flags));
...
EXTERN int Tcl_WaitPid _ANSI_ARGS_((int pid, int *statPtr, int options));
EXTERN void Tcl_WatchFile _ANSI_ARGS_((Tcl_File file, int mask));
