...
#if __STD_C
static int
copyinsert(Rs_t *rs, reg Rsobj_t *obj)
#else
static int copyinsert(rs, obj) Rs_t *rs;
reg Rsobj_t *obj;
#endif
{
...
static Rsmethod_t _Rscopy = { copyinsert, copylist, sizeof(Copy_t),
                              RS_MTCOPY,  "copy",   "Copy (no sort)." };
