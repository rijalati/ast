...
#if __STD_C
static int
radixinsert(Rs_t *rs, reg Rsobj_t *obj)
#else
static int radixinsert(rs, obj) Rs_t *rs;
reg Rsobj_t *obj;
#endif
{
    reg Rsobj_t *r;
...
radixlist(Rs_t *rs)
#else
static Rsobj_t *radixlist(rs) Rs_t *rs;
#endif
{
    reg Rsobj_t *work, *r;
    reg ssize_t ph;
...
/* public method */
static Rsmethod_t _Rsradix = { radixinsert, radixlist, sizeof(Rsradix_t),
                               RS_MTRADIX,  "radix",   "Radix sort." };
