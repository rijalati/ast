...
#if __STD_C
Sfio_t *
rstempwrite(Rs_t *rs, Sfio_t *sp)
#else
Sfio_t *rstempwrite(rs, sp) Rs_t *rs;
Sfio_t *sp;
#endif
{
    Sfio_t *op = sp;
...
#if __STD_C
int
rstempread(Rs_t *rs, Sfio_t *sp)
#else
int rstempread(rs, sp) Rs_t *rs;
Sfio_t *sp;
#endif
{
    int n;
...
#if __STD_C
int
rstempclose(Rs_t *rs, Sfio_t *sp)
#else
int rstempclose(rs, sp) Rs_t *rs;
Sfio_t *sp;
#endif
{
    int n;
