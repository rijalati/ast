...
#if __STD_C
int
rsfilewrite(Rs_t *rs, Sfio_t *sp, const char *path)
#else
int rsfilewrite(rs, sp, path) Rs_t *rs;
Sfio_t *sp;
char *path;
#endif
{
...
#if __STD_C
int
rsfileread(Rs_t *rs, Sfio_t *sp, const char *path)
#else
int rsfileread(rs, sp, path) Rs_t *rs;
Sfio_t *sp;
char *path;
#endif
{
...
#if __STD_C
int
rsfileclose(Rs_t *rs, Sfio_t *sp)
#else
int rsfileclose(rs, sp) Rs_t *rs;
Sfio_t *sp;
#endif
{
    int n;
