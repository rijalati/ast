...
static int FileMatchPPM _ANSI_ARGS_(
...
_ANSI_ARGS_((FILE * f, int *widthPtr, int *heightPtr, int *maxIntensityPtr));
...
static int
FileWritePPM(interp, fileName, formatString, blockPtr) Tcl_Interp *interp;
char *fileName;
char *formatString;
Tk_PhotoImageBlock *blockPtr;
{
