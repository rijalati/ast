...
= { { TK_CONFIG_BORDER,
    ...
    { TK_CONFIG_STRING,
      ...
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, justifyString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-lmargin1",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, lMargin1String),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-lmargin2",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, lMargin2String),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-offset",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, offsetString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-overstrike",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, overstrikeString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-relief",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, reliefString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-rmargin",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, rMarginString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-spacing1",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, spacing1String),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-spacing2",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, spacing2String),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-spacing3",
      ( char * ) NULL,
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, spacing3String),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-tabs",
      ( char * ) NULL,
    ...
    { TK_CONFIG_STRING,
      ...
      ( char * ) NULL,
      ( char * ) NULL,
      Tk_Offset(TkTextTag, underlineString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_UID,
      "-wrap",
      ( char * ) NULL,
...
static void ChangeTagPriority _ANSI_ARGS_((TkText * textPtr,
                                           ...
                                           int prio));
static TkTextTag *
FindTag _ANSI_ARGS_((Tcl_Interp * interp, TkText *textPtr, char *tagName));
static void SortTags _ANSI_ARGS_((int numTags, TkTextTag **tagArrayPtr));
static int TagSortProc _ANSI_ARGS_((CONST VOID * first, CONST VOID *second));
    ...
    addAndRemove:
        ...
        if ((argc < 4) || (argc > 6)) {
            Tcl_AppendResult(interp,
                             "wrong # args: should be \"",
                             argv[0],
                             " tag bind tagName ?sequence? ?command?\"",
                             ( char * ) NULL);
            return TCL_ERROR;
        }
        tagPtr = TkTextCreateTag(textPtr, argv[3]);
        ...
        if (argc == 4) {
            ...
            if ((tagPtr->border != NULL) || (tagPtr->bdString != NULL)
                || (tagPtr->reliefString != NULL)
                || (tagPtr->bgStipple != None) || (tagPtr->fgColor != NULL)
                || (tagPtr->fontPtr != None) || (tagPtr->fgStipple != None)
        ...
        if (argc == 3) {
            ...
            arrayPtr = ( TkTextTag ** ) ckalloc(
            ( unsigned ) (textPtr->numTags * sizeof(TkTextTag *)));
            for (i = 0,
...
TkTextTag *TkTextCreateTag(textPtr,
                           tagName) TkText *textPtr; /* Widget in which tag is
                                                        being used. */
...
static TkTextTag *FindTag(interp, textPtr, tagName)
...
static int TagSortProc(first, second) CONST VOID *first,
...
static void
ChangeTagPriority(textPtr, tagPtr, prio) TkText *textPtr; /* Information about
                                                             text widget. */
...
void TkTextBindProc(clientData,
                    eventPtr) ClientData clientData; /* Pointer to canvas
                                                        structure. */
...
#define AnyButtonMask                                                        \
    ...
    if (repick) {
        ...
        eventPtr->xbutton.state &= ~(Button1Mask | Button2Mask | Button3Mask
...
void TkTextPickCurrent(textPtr,
                       eventPtr) TkText *textPtr; /* Text widget in which to
                                                   * select
                                                   * current character. */
                   ...
                   * MotionNotify. */
{
    ...
    if (numNewTags > 0) {
        ...
        memcpy(
        ( VOID * ) copyArrayPtr, ( VOID * ) newArrayPtr, ( size_t ) size);
