...
static void ScaleImage _ANSI_ARGS_((Tk_Canvas canvas,
                                    ...
                                    double scaleX,
                                    double scaleY));
static void TranslateImage _ANSI_ARGS_(
...
static void
DeleteImage(canvas, itemPtr, display) Tk_Canvas canvas; /* Info about overall
                                                           canvas widget. */
...
/* ARGSUSED */
static void ComputeImageBbox(canvas,
                             imgPtr) Tk_Canvas canvas; /* Canvas that contains
                                                          item. */
...
static double
ImageToPoint(canvas, itemPtr, coordPtr) Tk_Canvas canvas; /* Canvas containing
                                                             item. */
