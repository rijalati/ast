...
static double BitmapToPoint _ANSI_ARGS_((Tk_Canvas canvas,
                                         Tk_Item *itemPtr,
                                         double *coordPtr));
static int BitmapToPostscript _ANSI_ARGS_(
...
static void ScaleBitmap _ANSI_ARGS_((Tk_Canvas canvas,
                                     ...
                                     double scaleX,
                                     double scaleY));
static void TranslateBitmap _ANSI_ARGS_(
...
static void
DeleteBitmap(canvas, itemPtr, display) Tk_Canvas canvas; /* Info about overall
                                                            canvas widget. */
...
/* ARGSUSED */
static void ComputeBitmapBbox(canvas,
                              bmapPtr) Tk_Canvas canvas; /* Canvas that
                                                            contains item. */
                          ...
                          * must be redisplayed (not used). */
{
    ...
    if (bmapPtr->bitmap != None) {
        ...
        XSetClipOrigin(
        display, bmapPtr->gc, drawableX - bmapX, drawableY - bmapY);
        XCopyPlane(display,
                   bmapPtr->bitmap,
                   drawable,
                   bmapPtr->gc,
...
/* ARGSUSED */
static double BitmapToPoint(canvas,
                            itemPtr,
                            coordPtr) Tk_Canvas canvas; /* Canvas containing
                                                           item. */
