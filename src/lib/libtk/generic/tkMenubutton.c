...
= { { TK_CONFIG_BORDER,
      ...
      "activeBackground",
      "Foreground",
      DEF_MENUBUTTON_ACTIVE_BG_COLOR,
      Tk_Offset(MenuButton, activeBorder),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_BORDER,
      "-activebackground",
      "activeBackground",
      "Foreground",
      DEF_MENUBUTTON_ACTIVE_BG_MONO,
      Tk_Offset(MenuButton, activeBorder),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_COLOR,
      "-activeforeground",
      "activeForeground",
      "Background",
      DEF_MENUBUTTON_ACTIVE_FG_COLOR,
      Tk_Offset(MenuButton, activeFg),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_COLOR,
      "-activeforeground",
      "activeForeground",
      "Background",
      DEF_MENUBUTTON_ACTIVE_FG_MONO,
      Tk_Offset(MenuButton, activeFg),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_ANCHOR,
      "-anchor",
      "anchor",
      "Anchor",
      DEF_MENUBUTTON_ANCHOR,
      Tk_Offset(MenuButton, anchor),
      0 },
    { TK_CONFIG_BORDER,
      "-background",
      "background",
      ...
      Tk_Offset(MenuButton, normalBorder),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_BORDER,
      "-background",
      "background",
      "Background",
      DEF_MENUBUTTON_BG_MONO,
      Tk_Offset(MenuButton, normalBorder),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_SYNONYM,
      "-bd",
    ...
    { TK_CONFIG_BITMAP,
      ...
      "bitmap",
      "Bitmap",
      DEF_MENUBUTTON_BITMAP,
      Tk_Offset(MenuButton, bitmap),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_PIXELS,
      "-borderwidth",
      "borderWidth",
      "BorderWidth",
      DEF_MENUBUTTON_BORDER_WIDTH,
      Tk_Offset(MenuButton, borderWidth),
      0 },
    { TK_CONFIG_ACTIVE_CURSOR,
      "-cursor",
      "cursor",
      "Cursor",
      DEF_MENUBUTTON_CURSOR,
      Tk_Offset(MenuButton, cursor),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_COLOR,
      "-disabledforeground",
      "disabledForeground",
      "DisabledForeground",
      DEF_MENUBUTTON_DISABLED_FG_COLOR,
    ...
    { TK_CONFIG_COLOR,
      ...
      "disabledForeground",
      "DisabledForeground",
      DEF_MENUBUTTON_DISABLED_FG_MONO,
      Tk_Offset(MenuButton, disabledFg),
    ...
    { TK_CONFIG_COLOR,
      ...
      "Foreground",
      DEF_MENUBUTTON_FG,
      Tk_Offset(MenuButton, normalFg),
      0 },
    { TK_CONFIG_STRING,
      "-height",
      "height",
      "Height",
      DEF_MENUBUTTON_HEIGHT,
      Tk_Offset(MenuButton, heightString),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightbackground",
      "highlightBackground",
      "HighlightBackground",
      DEF_MENUBUTTON_HIGHLIGHT_BG,
      Tk_Offset(MenuButton, highlightBgColorPtr),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightcolor",
      "highlightColor",
      "HighlightColor",
      DEF_MENUBUTTON_HIGHLIGHT,
      Tk_Offset(MenuButton, highlightColorPtr),
      0 },
    { TK_CONFIG_PIXELS,
      "-highlightthickness",
      "highlightThickness",
      "HighlightThickness",
      DEF_MENUBUTTON_HIGHLIGHT_WIDTH,
      Tk_Offset(MenuButton, highlightWidth),
      0 },
    { TK_CONFIG_STRING,
      "-image",
      "image",
      "Image",
      DEF_MENUBUTTON_IMAGE,
      Tk_Offset(MenuButton, imageString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_BOOLEAN,
      "-indicatoron",
      "indicatorOn",
      "IndicatorOn",
      DEF_MENUBUTTON_INDICATOR,
      Tk_Offset(MenuButton, indicatorOn),
      0 },
    { TK_CONFIG_JUSTIFY,
      "-justify",
      "justify",
      "Justify",
      DEF_MENUBUTTON_JUSTIFY,
      Tk_Offset(MenuButton, justify),
      0 },
    { TK_CONFIG_STRING,
      "-menu",
      "menu",
    ...
    { TK_CONFIG_PIXELS,
      ...
      "Pad",
      DEF_MENUBUTTON_PADY,
      Tk_Offset(MenuButton, padY),
      0 },
    { TK_CONFIG_RELIEF,
      "-relief",
      "relief",
      "Relief",
      DEF_MENUBUTTON_RELIEF,
      Tk_Offset(MenuButton, relief),
      0 },
    { TK_CONFIG_UID,
      "-state",
      "state",
      "State",
      DEF_MENUBUTTON_STATE,
      Tk_Offset(MenuButton, state),
      0 },
    { TK_CONFIG_STRING,
      "-takefocus",
      "takeFocus",
      "TakeFocus",
      DEF_MENUBUTTON_TAKE_FOCUS,
      Tk_Offset(MenuButton, takeFocus),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-text",
      "text",
    ...
    { TK_CONFIG_STRING,
      ...
      Tk_Offset(MenuButton, textVarName),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_INT,
      "-underline",
      "underline",
      "Underline",
      DEF_MENUBUTTON_UNDERLINE,
      Tk_Offset(MenuButton, underline),
      0 },
    { TK_CONFIG_STRING,
      "-width",
      "width",
      "Width",
      DEF_MENUBUTTON_WIDTH,
      Tk_Offset(MenuButton, widthString),
      0 },
    { TK_CONFIG_PIXELS,
      "-wraplength",
      "wrapLength",
      "WrapLength",
      DEF_MENUBUTTON_WRAP_LENGTH,
      Tk_Offset(MenuButton, wrapLength),
      0 },
    { TK_CONFIG_END,
      ( char * ) NULL,
      ( char * ) NULL,
...
static void ComputeMenuButtonGeometry _ANSI_ARGS_((MenuButton * mbPtr));
static void MenuButtonCmdDeletedProc _ANSI_ARGS_((ClientData clientData));
...
static void MenuButtonImageProc _ANSI_ARGS_((ClientData clientData,
                                             ...
                                             int imgWidth,
                                             int imgHeight));
static char *MenuButtonTextVarProc _ANSI_ARGS_((ClientData clientData,
                                                Tcl_Interp *interp,
                                                char *name1,
                                                char *name2,
                                                int flags));
static int MenuButtonWidgetCmd _ANSI_ARGS_(
(ClientData clientData, Tcl_Interp *interp, int argc, char **argv));
static int ConfigureMenuButton _ANSI_ARGS_(
(Tcl_Interp * interp, MenuButton *mbPtr, int argc, char **argv, int flags));
...
int Tk_MenubuttonCmd(clientData, interp, argc, argv)
...
char **argv;           /* Argument strings. */
{
    ...
    mbPtr->interp = interp;
    mbPtr->widgetCmd = Tcl_CreateCommand(interp,
...
static int MenuButtonWidgetCmd(clientData, interp, argc, argv)
...
static void DestroyMenuButton(memPtr) char *memPtr; /* Info about button
                                                       widget. */
{
...
static int ConfigureMenuButton(interp, mbPtr, argc, argv, flags)
...
static void DisplayMenuButton(clientData)
ClientData clientData; /* Information about widget. */
{
    ...
    pixmap = Tk_GetPixmap(mbPtr->display,
                          Tk_WindowId(tkwin),
                          Tk_Width(tkwin),
                          Tk_Height(tkwin),
                          Tk_Depth(tkwin));
    ...
    imageOrBitmap:
        ...
        case TK_ANCHOR_S:
            x += (( int ) (Tk_Width(tkwin) - width - mbPtr->indicatorWidth))
                 / 2;
            break;
        default:
            x
        ...
        case TK_ANCHOR_S:
            x
            = (( int ) (Tk_Width(tkwin) - width - mbPtr->indicatorWidth)) / 2;
            break;
        default:
    ...
    if (mbPtr->indicatorOn) {
        ...
        Tk_Fill3DRectangle(tkwin,
                           ...
                           - mbPtr->indicatorWidth + mbPtr->indicatorHeight,
                           y
                           + (( int ) (height - mbPtr->indicatorHeight)) / 2,
...
static void MenuButtonEventProc(clientData, eventPtr)
...
static void ComputeMenuButtonGeometry(mbPtr)
...
/* ARGSUSED */
static char *MenuButtonTextVarProc(clientData, interp, name1, name2, flags)
