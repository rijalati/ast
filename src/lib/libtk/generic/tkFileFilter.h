...
EXTERN void TkInitFileFilters _ANSI_ARGS_((FileFilterList * flistPtr));
EXTERN int TkGetFileFilters _ANSI_ARGS_(
(Tcl_Interp * interp, FileFilterList *flistPtr, char *string, int isWindows));
#endif
