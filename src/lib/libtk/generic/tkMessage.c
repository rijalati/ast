...
= { { TK_CONFIG_ANCHOR,
    ...
    { TK_CONFIG_INT,
      ...
      "Aspect",
      DEF_MESSAGE_ASPECT,
      Tk_Offset(Message, aspect),
      0 },
    { TK_CONFIG_BORDER,
      "-background",
      "background",
      "Background",
      DEF_MESSAGE_BG_COLOR,
      Tk_Offset(Message, border),
    ...
    { TK_CONFIG_PIXELS,
      ...
      "borderWidth",
      "BorderWidth",
      DEF_MESSAGE_BORDER_WIDTH,
      Tk_Offset(Message, borderWidth),
      0 },
    ...
    { TK_CONFIG_COLOR,
      ...
      "Foreground",
      DEF_MESSAGE_FG,
      Tk_Offset(Message, fgColorPtr),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightbackground",
      "highlightBackground",
      "HighlightBackground",
      DEF_MESSAGE_HIGHLIGHT_BG,
      Tk_Offset(Message, highlightBgColorPtr),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightcolor",
      "highlightColor",
      "HighlightColor",
      DEF_MESSAGE_HIGHLIGHT,
      Tk_Offset(Message, highlightColorPtr),
      0 },
    { TK_CONFIG_PIXELS,
      "-highlightthickness",
      "highlightThickness",
      ...
      Tk_Offset(Message, highlightWidth),
      0 },
    { TK_CONFIG_JUSTIFY,
      "-justify",
      "justify",
    ...
    { TK_CONFIG_RELIEF,
      ...
      "Relief",
      DEF_MESSAGE_RELIEF,
      Tk_Offset(Message, relief),
      0 },
    { TK_CONFIG_STRING,
      "-takefocus",
      "takeFocus",
      "TakeFocus",
      DEF_MESSAGE_TAKE_FOCUS,
      Tk_Offset(Message, takeFocus),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-text",
      "text",
      "Text",
      DEF_MESSAGE_TEXT,
      Tk_Offset(Message, string),
      0 },
    { TK_CONFIG_STRING,
      "-textvariable",
      "textVariable",
      "Variable",
      DEF_MESSAGE_TEXT_VARIABLE,
      Tk_Offset(Message, textVarName),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_PIXELS,
      "-width",
      "width",
...
static void MessageCmdDeletedProc _ANSI_ARGS_((ClientData clientData));
...
static char *MessageTextVarProc _ANSI_ARGS_((ClientData clientData,
                                             ...
                                             char *name2,
                                             int flags));
static int MessageWidgetCmd _ANSI_ARGS_(
(ClientData clientData, Tcl_Interp *interp, int argc, char **argv));
static void ComputeMessageGeometry _ANSI_ARGS_((Message * msgPtr));
static int ConfigureMessage _ANSI_ARGS_(
(Tcl_Interp * interp, Message *msgPtr, int argc, char **argv, int flags));
...
static void ComputeMessageGeometry(
msgPtr) Message *msgPtr; /* Information about window. */
{
    char *p;
    ...
    for (;; inc /= 2)
    {
        ...
        for (numLines = 1, p = msgPtr->string;; numLines++)
        {
            ...
            p += TkMeasureChars(msgPtr->fontPtr,
                                p,
    ...
    = numLines * (msgPtr->fontPtr->ascent + msgPtr->fontPtr->descent);
    Tk_GeometryRequest(
    msgPtr->tkwin, maxWidth + 2 * msgPtr->inset + 2 * msgPtr->padX, height);
...
ClientData clientData; /* Information about window. */
{
    ...
    default:
        y
        = Tk_Height(tkwin) - msgPtr->inset - msgPtr->padY - msgPtr->msgHeight;
        break;
    }
         ...
         y += msgPtr->fontPtr->ascent + msgPtr->fontPtr->descent)
    {
        ...
        numChars = TkMeasureChars(msgPtr->fontPtr,
                                  p,
                                  charsLeft,
                                  0,
                                  msgPtr->lineLength,
    ...
    if (msgPtr->highlightWidth != 0)
    {
        ...
        tkwin, gc, msgPtr->highlightWidth, Tk_WindowId(tkwin));
    }
}
