...
= { { TK_CONFIG_BORDER,
      ...
      "activeBackground",
      "Foreground",
      DEF_SCALE_ACTIVE_BG_COLOR,
      Tk_Offset(Scale, activeBorder),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_BORDER,
      "-activebackground",
      "activeBackground",
      "Foreground",
      DEF_SCALE_ACTIVE_BG_MONO,
      Tk_Offset(Scale, activeBorder),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_BORDER,
      "-background",
    ...
    { TK_CONFIG_DOUBLE,
      ...
      "bigIncrement",
      "BigIncrement",
      DEF_SCALE_BIG_INCREMENT,
      Tk_Offset(Scale, bigIncrement),
      0 },
    { TK_CONFIG_SYNONYM,
      "-bd",
      "borderWidth",
    ...
    { TK_CONFIG_PIXELS,
      ...
      "borderWidth",
      "BorderWidth",
      DEF_SCALE_BORDER_WIDTH,
      Tk_Offset(Scale, borderWidth),
      0 },
    { TK_CONFIG_STRING,
      "-command",
      "command",
    ...
    { TK_CONFIG_DOUBLE,
      ...
      "From",
      DEF_SCALE_FROM,
      Tk_Offset(Scale, fromValue),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightbackground",
      "highlightBackground",
      "HighlightBackground",
      DEF_SCALE_HIGHLIGHT_BG,
      Tk_Offset(Scale, highlightBgColorPtr),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightcolor",
      "highlightColor",
      "HighlightColor",
      DEF_SCALE_HIGHLIGHT,
      Tk_Offset(Scale, highlightColorPtr),
      0 },
    { TK_CONFIG_PIXELS,
      "-highlightthickness",
      "highlightThickness",
      "HighlightThickness",
      DEF_SCALE_HIGHLIGHT_WIDTH,
      Tk_Offset(Scale, highlightWidth),
      0 },
    { TK_CONFIG_STRING,
      "-label",
      "label",
    ...
    { TK_CONFIG_RELIEF,
      ...
      "Relief",
      DEF_SCALE_RELIEF,
      Tk_Offset(Scale, relief),
      0 },
    { TK_CONFIG_INT,
      "-repeatdelay",
      "repeatDelay",
      "RepeatDelay",
      DEF_SCALE_REPEAT_DELAY,
      Tk_Offset(Scale, repeatDelay),
      0 },
    { TK_CONFIG_INT,
      "-repeatinterval",
      "repeatInterval",
      "RepeatInterval",
      DEF_SCALE_REPEAT_INTERVAL,
      Tk_Offset(Scale, repeatInterval),
      0 },
    { TK_CONFIG_DOUBLE,
      "-resolution",
      "resolution",
      "Resolution",
      DEF_SCALE_RESOLUTION,
      Tk_Offset(Scale, resolution),
      0 },
    { TK_CONFIG_BOOLEAN,
      "-showvalue",
      "showValue",
      "ShowValue",
      DEF_SCALE_SHOW_VALUE,
      Tk_Offset(Scale, showValue),
      0 },
    { TK_CONFIG_PIXELS,
      "-sliderlength",
      "sliderLength",
      "SliderLength",
      DEF_SCALE_SLIDER_LENGTH,
      Tk_Offset(Scale, sliderLength),
      0 },
    { TK_CONFIG_RELIEF,
      "-sliderrelief",
      "sliderRelief",
      "SliderRelief",
      DEF_SCALE_SLIDER_RELIEF,
      Tk_Offset(Scale, sliderRelief),
    ...
    { TK_CONFIG_UID,
      ...
      "State",
      DEF_SCALE_STATE,
      Tk_Offset(Scale, state),
      0 },
    { TK_CONFIG_STRING,
      "-takefocus",
      "takeFocus",
      "TakeFocus",
      DEF_SCALE_TAKE_FOCUS,
      Tk_Offset(Scale, takeFocus),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_DOUBLE,
      "-tickinterval",
      "tickInterval",
      "TickInterval",
      DEF_SCALE_TICK_INTERVAL,
      Tk_Offset(Scale, tickInterval),
      0 },
    { TK_CONFIG_DOUBLE,
      "-to",
      "to",
      "To",
      DEF_SCALE_TO,
      Tk_Offset(Scale, toValue),
      0 },
    { TK_CONFIG_COLOR,
      "-troughcolor",
      "troughColor",
      "Background",
      DEF_SCALE_TROUGH_COLOR,
      Tk_Offset(Scale, troughColorPtr),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_COLOR,
      "-troughcolor",
      "troughColor",
      "Background",
      DEF_SCALE_TROUGH_MONO,
      Tk_Offset(Scale, troughColorPtr),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_STRING,
      "-variable",
...
static int ConfigureScale _ANSI_ARGS_(
(Tcl_Interp * interp, Scale *scalePtr, int argc, char **argv, int flags));
...
static void DisplayHorizontalScale _ANSI_ARGS_((Scale * scalePtr,
                                                Drawable drawable,
                                                XRectangle *drawnAreaPtr));
static void DisplayHorizontalValue
_ANSI_ARGS_((Scale * scalePtr, Drawable drawable, double value, int top));
static void DisplayVerticalScale _ANSI_ARGS_((Scale * scalePtr,
                                              Drawable drawable,
                                              XRectangle *drawnAreaPtr));
static void DisplayVerticalValue _ANSI_ARGS_(
(Scale * scalePtr, Drawable drawable, double value, int rightEdge));
static void EventuallyRedrawScale _ANSI_ARGS_((Scale * scalePtr, int what));
static double PixelToValue _ANSI_ARGS_((Scale * scalePtr, int x, int y));
static double RoundToResolution _ANSI_ARGS_((Scale * scalePtr, double value));
static void ScaleCmdDeletedProc _ANSI_ARGS_((ClientData clientData));
static int ScaleElement _ANSI_ARGS_((Scale * scalePtr, int x, int y));
...
static char *ScaleVarProc _ANSI_ARGS_((ClientData clientData,
                                       ...
                                       char *name2,
                                       int flags));
static int ScaleWidgetCmd _ANSI_ARGS_(
(ClientData clientData, Tcl_Interp *interp, int argc, char **argv));
static void SetScaleValue
_ANSI_ARGS_((Scale * scalePtr, double value, int setVar, int invokeCommand));
...
static void ComputeFormat(scalePtr) Scale *scalePtr; /* Information about
                                                        scale widget. */
{
    double maxValue, x;
...
static void ComputeScaleGeometry(
scalePtr) Scale *scalePtr; /* Information about widget. */
{
    XCharStruct bbox;
    ...
    if (scalePtr->labelLength == 0) {
        ...
        XTextExtents(scalePtr->fontPtr,
                     ...
                     &bbox);
        scalePtr->vertLabelX
        = x + scalePtr->fontPtr->ascent / 2 - bbox.lbearing;
                           ...
                           * redrawn. */
{
    ...
    if (scalePtr->flags & REDRAW_OTHER) {
        ...
        if (scalePtr->tickInterval != 0) {
            for (tickValue = scalePtr->fromValue;;
                ...
                scalePtr, drawable, tickValue, scalePtr->vertTickRightX);
            }
        }
    }
    ...
    Tk_Draw3DRectangle(tkwin,
                       drawable,
                       scalePtr->bgBorder,
                       scalePtr->vertTroughX,
                       scalePtr->inset,
                       scalePtr->width + 2 * scalePtr->borderWidth,
                       Tk_Height(tkwin) - 2 * scalePtr->inset,
                       scalePtr->borderWidth,
                       TK_RELIEF_SUNKEN);
    XFillRectangle(scalePtr->display,
                   drawable,
                   scalePtr->troughGC,
                    ...
                    * specified in pixels. */
{
    ...
    XTextExtents(
    scalePtr->fontPtr, valueString, length, &dummy, &dummy, &dummy, &bbox);
                           ...
                           * redrawn. */
{
    ...
    if (scalePtr->flags & REDRAW_OTHER) {
        ...
        if (scalePtr->tickInterval != 0) {
            for (tickValue = scalePtr->fromValue;;
                ...
                scalePtr, drawable, tickValue, scalePtr->horizTickY);
            }
        }
    }
    ...
    if ((scalePtr->flags & REDRAW_OTHER) && (scalePtr->labelLength != 0)) {
        XDrawString(scalePtr->display,
                    drawable,
                    scalePtr->textGC,
                    scalePtr->inset + scalePtr->fontPtr->ascent / 2,
                    ...
                    * specified in pixels. */
{
    ...
    XDrawString(
    scalePtr->display, drawable, scalePtr->textGC, x, y, valueString, length);
}
                                                               ...
                                                               for scale. */
{
    ...
    pixmap = Tk_GetPixmap(scalePtr->display,
                          Tk_WindowId(tkwin),
                          Tk_Width(tkwin),
                          Tk_Height(tkwin),
                          Tk_Depth(tkwin));
    ...
    if (scalePtr->flags & REDRAW_OTHER) {
        if (scalePtr->relief != TK_RELIEF_FLAT) {
            Tk_Draw3DRectangle(tkwin,
                               pixmap,
                               scalePtr->bgBorder,
                               scalePtr->highlightWidth,
                               scalePtr->highlightWidth,
                               Tk_Width(tkwin) - 2 * scalePtr->highlightWidth,
                               Tk_Height(tkwin)
                               - 2 * scalePtr->highlightWidth,
                               scalePtr->borderWidth,
                               scalePtr->relief);
        }
        if (scalePtr->highlightWidth != 0) {
            ...
            tkwin, gc, scalePtr->highlightWidth, pixmap);
        }
    }
...
static int ScaleElement(scalePtr, x, y) Scale *scalePtr; /* Widget record for
                                                            scale. */
                                               ...
                                               * window. */
{
    ...
    value
    = scalePtr->fromValue + value * (scalePtr->toValue - scalePtr->fromValue);
...
static int ValueToPixel(scalePtr, value) Scale *scalePtr; /* Information about
                                                             widget. */
                    ...
                    * to notify of new value, 0 means don't. */
{
    ...
    if (setVar && (scalePtr->varName != NULL)) {
        ...
        Tcl_SetVar(
        scalePtr->interp, scalePtr->varName, string, TCL_GLOBAL_ONLY);
        scalePtr->flags &= ~SETTING_VAR;
    }
}
...
static void EventuallyRedrawScale(scalePtr,
                                  what) Scale *scalePtr; /* Information about
                                                            widget. */
