...
static double PolygonToPoint _ANSI_ARGS_((Tk_Canvas canvas,
                                          Tk_Item *itemPtr,
                                          double *pointPtr));
static int PolygonToPostscript _ANSI_ARGS_(
...
static void ScalePolygon _ANSI_ARGS_((Tk_Canvas canvas,
                                      ...
                                      double scaleX,
                                      double scaleY));
static void TranslatePolygon _ANSI_ARGS_(
...
static void DeletePolygon(canvas,
                          itemPtr,
...
static void ComputePolygonBbox(canvas,
                               polyPtr) Tk_Canvas canvas; /* Canvas that
                                                             contains item. */
...
/* ARGSUSED */
static double PolygonToPoint(canvas,
                             itemPtr,
