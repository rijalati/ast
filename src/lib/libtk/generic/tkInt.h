...
extern void(*tkHandleEventProc) _ANSI_ARGS_((XEvent * eventPtr));
...
EXTERN char *
TkAlignImageData _ANSI_ARGS_((XImage * image, int alignment, int bitOrder));
...
EXTERN void TkBezierPoints _ANSI_ARGS_((double control[],
                                        int numSteps,
                                        double *coordPtr));
EXTERN void TkBezierScreenPoints _ANSI_ARGS_(
...
EXTERN void TkChangeEventWindow _ANSI_ARGS_((XEvent * eventPtr,
                                             TkWindow *winPtr));
#ifndef TkClipBox
EXTERN void TkClipBox _ANSI_ARGS_((TkRegion rgn, XRectangle *rect_return));
#endif
EXTERN int TkClipInit _ANSI_ARGS_((Tcl_Interp * interp, TkDisplay *dispPtr));
EXTERN int TkCmapStressed _ANSI_ARGS_((Tk_Window tkwin, Colormap colormap));
EXTERN void TkComputeTextGeometry _ANSI_ARGS_((XFontStruct * fontStructPtr,
                                               char *string,
                                               int numChars,
                                               int wrapLength,
                                               int *widthPtr,
...
EXTERN void TkDisplayText _ANSI_ARGS_((Display * display,
                                       ...
                                       int underline,
                                       GC gc));
EXTERN void TkEventCleanupProc _ANSI_ARGS_((ClientData clientData,
                                            Tcl_Interp *interp));
...
EXTERN int TkFindStateNum _ANSI_ARGS_((Tcl_Interp * interp,
                                       ...
                                       CONST char *strKey));
EXTERN char *TkFindStateString _ANSI_ARGS_((CONST TkStateMap * mapPtr,
                                            int numKey));
...
EXTERN void TkFreeWindowId _ANSI_ARGS_((TkDisplay * dispPtr, Window w));
...
#endif
EXTERN void
TkGetPointerCoords _ANSI_ARGS_((Tk_Window tkwin, int *xPtr, int *yPtr));
...
EXTERN Window TkMakeWindow _ANSI_ARGS_((TkWindow * winPtr, Window parent));
...
EXTERN int TkRectInRegion _ANSI_ARGS_(
(TkRegion rgn, int x, int y, unsigned int width, unsigned int height));
#endif
EXTERN void TkQueueEventForAllChildren _ANSI_ARGS_((Tk_Window tkwin,
                                                    XEvent *eventPtr));
EXTERN int TkScrollWindow _ANSI_ARGS_((Tk_Window tkwin,
                                       GC gc,
                                       int x,
                                       int y,
                                       int width,
...
#endif
#ifndef TkSetRegion
EXTERN void TkSetRegion _ANSI_ARGS_((Display * display, GC gc, TkRegion rgn));
#endif
...
EXTERN void TkUnionRectWithRegion _ANSI_ARGS_((XRectangle * rect,
                                               ...
                                               TkRegion dr_return));
#endif
EXTERN void TkWmAddToColormapWindows _ANSI_ARGS_((TkWindow * winPtr));
...
EXTERN void TkWmProtocolEventProc _ANSI_ARGS_((TkWindow * winPtr,
                                               XEvent *evenvPtr));
EXTERN void TkWmRemoveFromColormapWindows _ANSI_ARGS_((TkWindow * winPtr));
...
EXTERN int
TkXFileProc _ANSI_ARGS_((ClientData clientData, int mask, int flags));

/*
 * Unsupported commands.
 */
EXTERN int TkUnsupported1Cmd _ANSI_ARGS_(
(ClientData clientData, Tcl_Interp *interp, int argc, char **argv));
