...
= { { TK_CONFIG_BORDER,
    ...
    { TK_CONFIG_PIXELS,
      ...
      "borderWidth",
      "BorderWidth",
      DEF_TEXT_BORDER_WIDTH,
      Tk_Offset(TkText, borderWidth),
      0 },
    { TK_CONFIG_ACTIVE_CURSOR,
      ...
      "Cursor",
      DEF_TEXT_CURSOR,
      Tk_Offset(TkText, cursor),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_BOOLEAN,
      "-exportselection",
      "exportSelection",
      "ExportSelection",
      DEF_TEXT_EXPORT_SELECTION,
      Tk_Offset(TkText, exportSelection),
      0 },
    { TK_CONFIG_SYNONYM,
      "-fg",
      "foreground",
    ...
    { TK_CONFIG_PIXELS,
      ...
      "Height",
      DEF_TEXT_HEIGHT,
      Tk_Offset(TkText, height),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightbackground",
      "highlightBackground",
      "HighlightBackground",
      DEF_TEXT_HIGHLIGHT_BG,
      Tk_Offset(TkText, highlightBgColorPtr),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightcolor",
      "highlightColor",
      "HighlightColor",
      DEF_TEXT_HIGHLIGHT,
      Tk_Offset(TkText, highlightColorPtr),
      0 },
    { TK_CONFIG_PIXELS,
      "-highlightthickness",
      "highlightThickness",
      "HighlightThickness",
      DEF_TEXT_HIGHLIGHT_WIDTH,
      Tk_Offset(TkText, highlightWidth),
      0 },
    { TK_CONFIG_BORDER,
      "-insertbackground",
      "insertBackground",
      "Foreground",
      DEF_TEXT_INSERT_BG,
      Tk_Offset(TkText, insertBorder),
      0 },
    { TK_CONFIG_PIXELS,
      "-insertborderwidth",
      "insertBorderWidth",
      "BorderWidth",
      DEF_TEXT_INSERT_BD_COLOR,
      Tk_Offset(TkText, insertBorderWidth),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_PIXELS,
      "-insertborderwidth",
      "insertBorderWidth",
    ...
    { TK_CONFIG_INT,
      ...
      "insertOffTime",
      "OffTime",
      DEF_TEXT_INSERT_OFF_TIME,
      Tk_Offset(TkText, insertOffTime),
      0 },
    { TK_CONFIG_INT,
      "-insertontime",
      "insertOnTime",
      "OnTime",
      DEF_TEXT_INSERT_ON_TIME,
      Tk_Offset(TkText, insertOnTime),
      0 },
    { TK_CONFIG_PIXELS,
      "-insertwidth",
      "insertWidth",
      "InsertWidth",
      DEF_TEXT_INSERT_WIDTH,
      Tk_Offset(TkText, insertWidth),
      0 },
    { TK_CONFIG_PIXELS,
      "-padx",
      "padX",
    ...
    { TK_CONFIG_BORDER,
      ...
      Tk_Offset(TkText, selBorder),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_BORDER,
      "-selectbackground",
      "selectBackground",
      "Foreground",
      DEF_TEXT_SELECT_MONO,
      Tk_Offset(TkText, selBorder),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_STRING,
      "-selectborderwidth",
      "selectBorderWidth",
      "BorderWidth",
      DEF_TEXT_SELECT_BD_COLOR,
      Tk_Offset(TkText, selBdString),
      TK_CONFIG_COLOR_ONLY | TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-selectborderwidth",
      "selectBorderWidth",
      "BorderWidth",
      DEF_TEXT_SELECT_BD_MONO,
      Tk_Offset(TkText, selBdString),
    ...
    { TK_CONFIG_COLOR,
      ...
      Tk_Offset(TkText, selFgColorPtr),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_COLOR,
      "-selectforeground",
      "selectForeground",
    ...
    { TK_CONFIG_STRING,
      ...
      "Tabs",
      DEF_TEXT_TABS,
      Tk_Offset(TkText, tabOptionString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-takefocus",
      "takeFocus",
    ...
    { TK_CONFIG_UID,
      ...
      "Wrap",
      DEF_TEXT_WRAP,
      Tk_Offset(TkText, wrapMode),
      0 },
    { TK_CONFIG_STRING,
      "-xscrollcommand",
      "xScrollCommand",
      "ScrollCommand",
      DEF_TEXT_XSCROLL_COMMAND,
      Tk_Offset(TkText, xScrollCmd),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-yscrollcommand",
      "yScrollCommand",
      "ScrollCommand",
      DEF_TEXT_YSCROLL_COMMAND,
      Tk_Offset(TkText, yScrollCmd),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_END,
      ( char * ) NULL,
      ( char * ) NULL,
...
(Tcl_Interp * interp, TkText *textPtr, int argc, char **argv, int flags));
...
static void TextCmdDeletedProc _ANSI_ARGS_((ClientData clientData));
static void TextEventProc _ANSI_ARGS_((ClientData clientData,
                                       XEvent *eventPtr));
static int TextFetchSelection
_ANSI_ARGS_((ClientData clientData, int offset, char *buffer, int maxBytes));
static int TextSearchCmd
_ANSI_ARGS_((TkText * textPtr, Tcl_Interp *interp, int argc, char **argv));
static int TextWidgetCmd _ANSI_ARGS_(
(ClientData clientData, Tcl_Interp *interp, int argc, char **argv));
static int TextDumpCmd
_ANSI_ARGS_((TkText * textPtr, Tcl_Interp *interp, int argc, char **argv));
...
char **argv;           /* Argument strings. */
{
    ...
    Tk_CreateEventHandler(textPtr->tkwin,
                          ...
                          TkTextBindProc,
                          ( ClientData ) textPtr);
    Tk_CreateSelHandler(textPtr->tkwin,
                        XA_PRIMARY,
                        XA_STRING,
                        TextFetchSelection,
                        ( ClientData ) textPtr,
    ...
    if ((c == 'b') && (strncmp(argv[1], "bbox", length) == 0)) {
        ...
        while (1) {
            ...
            if (segPtr->typePtr == &tkTextCharType) {
                ...
                Tcl_AppendResult(
                interp, segPtr->body.chars + offset, ( char * ) NULL);
...
static void DestroyText(memPtr) char *memPtr; /* Info about text widget. */
{
...
int flags;          /* Flags to pass to Tk_ConfigureWidget. */
{
    ...
    Tk_GeometryRequest(textPtr->tkwin,
                       ...
                       + 2 * textPtr->borderWidth + 2 * textPtr->padX
                       + 2 * textPtr->highlightWidth,
...
static void TextCmdDeletedProc(clientData)
...
static void InsertChars(textPtr,
                        indexPtr,
                        string) TkText *textPtr; /* Overall information about
                                                    text widget. */
...
static int DeleteChars(textPtr,
                       index1String,
                       index2String) TkText *textPtr; /* Overall information
                                                         about text widget. */
                        ...
                        * NULL character. */
{
    ...
    while (1) {
        ...
        while (1) {
            ...
            TkTextIndexForwChars(
            &textPtr->selIndex, chunkSize, &textPtr->selIndex);
        }
...
static void TextBlinkProc(clientData)
    ...
    for (i = 0, tabPtr = &tabArrayPtr->tabs[0]; i < argc; i++, tabPtr++) {
        ...
        if ((c == 'l') && (strncmp(argv[i], "left", strlen(argv[i])) == 0)) {
            ...
            Tcl_AppendResult(interp,
                             "bad tab alignment \"",
                             argv[i],
                             "\": must be left, right, center, or numeric",
                             ( char * ) NULL);
            goto error;
        }
    }
...
#define TK_DUMP_ALL (TK_DUMP_TEXT | TK_DUMP_MARK | TK_DUMP_TAG | TK_DUMP_WIN)
        ...
        if (strncmp("-all", argv[arg], len) == 0) {
            ...
            if (arg >= argc) {
                Tcl_AppendResult(interp,
                                 "Usage: ",
                                 argv[0],
                                 " dump ?-all -text -mark -tag -window? "
                                 "?-command script? index ?index2?",
                                 NULL);
                return TCL_ERROR;
            }
            command = argv[arg];
    ...
    if (arg >= argc) {
        Tcl_AppendResult(interp,
                         "Usage: ",
                         argv[0],
                         " dump ?-all -text -mark -tag -window? ?-command "
                         "script? index ?index2?",
                         NULL);
        return TCL_ERROR;
    }
    ...
    if (index1.linePtr == index2.linePtr) {
        ...
        while ((linePtr = TkBTreeNextLine(linePtr))
            ...
            DumpLine(
            interp, textPtr, what, linePtr, 0, 32000000, lineno, command);
        }
        DumpLine(interp,
                 textPtr,
                 what,
    ...
    for (offset = 0, segPtr = linePtr->segPtr;
        ...
        if ((what & TK_DUMP_TEXT) && (segPtr->typePtr == &tkTextCharType)
            ...
            if ((what & TK_DUMP_MARK) && (segPtr->typePtr->name[0] == 'm')) {
                ...
                DumpSegment(
                interp, "window", pathname, command, lineno, offset, what);
            }
        }
    }
}
