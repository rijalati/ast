...
#define ALL_MASK                                                             \
    (COMMAND_MASK | SEPARATOR_MASK | CHECK_BUTTON_MASK | RADIO_BUTTON_MASK   \
     | CASCADE_MASK | TEAROFF_MASK)
...
= { { TK_CONFIG_BORDER,
      ...
      ( char * )NULL,
      ( char * )NULL,
      DEF_MENU_ENTRY_ACTIVE_BG,
      Tk_Offset(MenuEntry, activeBorder),
    ...
    { TK_CONFIG_STRING,
      ...
      Tk_Offset(MenuEntry, imageString),
      COMMAND_MASK | CHECK_BUTTON_MASK | RADIO_BUTTON_MASK | CASCADE_MASK
      | TK_CONFIG_NULL_OK },
    { TK_CONFIG_BOOLEAN,
      "-indicatoron",
      ...
      Tk_Offset(MenuEntry, indicatorOn),
    ...
    { TK_CONFIG_COLOR,
      ...
      Tk_Offset(MenuEntry, indicatorFg),
    ...
    { TK_CONFIG_STRING,
      ...
      Tk_Offset(MenuEntry, selectImageString),
      CHECK_BUTTON_MASK | RADIO_BUTTON_MASK | TK_CONFIG_NULL_OK },
    { TK_CONFIG_UID,
      "-state",
      ( char * )NULL,
    ...
    { TK_CONFIG_INT,
      ...
      ( char * )NULL,
      ( char * )NULL,
      DEF_MENU_ENTRY_UNDERLINE,
      Tk_Offset(MenuEntry, underline),
      COMMAND_MASK | CHECK_BUTTON_MASK | RADIO_BUTTON_MASK | CASCADE_MASK
...
= { { TK_CONFIG_BORDER,
      ...
      "activeBackground",
      "Foreground",
      DEF_MENU_ACTIVE_BG_COLOR,
      Tk_Offset(Menu, activeBorder),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_BORDER,
      "-activebackground",
      "activeBackground",
      "Foreground",
      DEF_MENU_ACTIVE_BG_MONO,
      Tk_Offset(Menu, activeBorder),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_PIXELS,
      "-activeborderwidth",
      "activeBorderWidth",
      "BorderWidth",
      DEF_MENU_ACTIVE_BORDER_WIDTH,
      Tk_Offset(Menu, activeBorderWidth),
      0 },
    { TK_CONFIG_COLOR,
      "-activeforeground",
      "activeForeground",
      "Background",
      DEF_MENU_ACTIVE_FG_COLOR,
      Tk_Offset(Menu, activeFg),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_COLOR,
      "-activeforeground",
      "activeForeground",
      "Background",
      DEF_MENU_ACTIVE_FG_MONO,
      Tk_Offset(Menu, activeFg),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_BORDER,
      "-background",
    ...
    { TK_CONFIG_ACTIVE_CURSOR,
      ...
      "Cursor",
      DEF_MENU_CURSOR,
      Tk_Offset(Menu, cursor),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_COLOR,
      "-disabledforeground",
      "disabledForeground",
      "DisabledForeground",
      DEF_MENU_DISABLED_FG_COLOR,
      Tk_Offset(Menu, disabledFg),
      TK_CONFIG_COLOR_ONLY | TK_CONFIG_NULL_OK },
    { TK_CONFIG_COLOR,
      "-disabledforeground",
      "disabledForeground",
      "DisabledForeground",
      DEF_MENU_DISABLED_FG_MONO,
      Tk_Offset(Menu, disabledFg),
    ...
    { TK_CONFIG_RELIEF,
      ...
      "Relief",
      DEF_MENU_RELIEF,
      Tk_Offset(Menu, relief),
      0 },
    { TK_CONFIG_COLOR,
      "-selectcolor",
      "selectColor",
      "Background",
      DEF_MENU_SELECT_COLOR,
      Tk_Offset(Menu, indicatorFg),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_COLOR,
      "-selectcolor",
      "selectColor",
      "Background",
      DEF_MENU_SELECT_MONO,
      Tk_Offset(Menu, indicatorFg),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_STRING,
      "-takefocus",
    ...
    { TK_CONFIG_BOOLEAN,
      ...
      "TearOff",
      DEF_MENU_TEAROFF,
      Tk_Offset(Menu, tearOff),
      0 },
    { TK_CONFIG_STRING,
      "-tearoffcommand",
      "tearOffCommand",
      "TearOffCommand",
      DEF_MENU_TEAROFF_CMD,
      Tk_Offset(Menu, tearOffCommand),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_BOOLEAN,
      "-transient",
      "transient",
...
static int ActivateMenuEntry _ANSI_ARGS_((Menu * menuPtr, int index));
static void ComputeMenuGeometry _ANSI_ARGS_((ClientData clientData));
static int ConfigureMenu _ANSI_ARGS_(
(Tcl_Interp * interp, Menu *menuPtr, int argc, char **argv, int flags));
...
static void EventuallyRedrawMenu _ANSI_ARGS_((Menu * menuPtr,
                                              MenuEntry *mePtr));
static int GetMenuIndex _ANSI_ARGS_(
(Tcl_Interp * interp, Menu *menuPtr, char *string, int lastOK, int *indexPtr));
static int MenuAddOrInsert _ANSI_ARGS_((Tcl_Interp * interp,
                                        Menu *menuPtr,
                                        char *indexString,
                                        int argc,
                                        char **argv));
static void MenuCmdDeletedProc _ANSI_ARGS_((ClientData clientData));
...
static void MenuImageProc _ANSI_ARGS_((ClientData clientData,
                                       ...
                                       int imgHeight));
static MenuEntry *
MenuNewEntry _ANSI_ARGS_((Menu * menuPtr, int index, int type));
...
static char *MenuVarProc _ANSI_ARGS_((ClientData clientData,
                                      ...
                                      char *name2,
                                      int flags));
static int MenuWidgetCmd _ANSI_ARGS_(
...
char **argv; /* Argument strings. */
{
             ...
             && (length == 4))
    {
        ...
        Tk_GetVRootGeometry(Tk_Parent(menuPtr->tkwin),
                            &vRootX,
                            &vRootY,
                            &vRootWidth,
                            &vRootHeight);
...
static void DestroyMenu(memPtr) char *memPtr; /* Info about menu widget. */
{
    Menu *menuPtr = ( Menu * )memPtr;
    int i;
...
static void DestroyMenuEntry(memPtr) char *memPtr; /* Pointer to entry to be
                                                      freed. */
{
    MenuEntry *mePtr = ( MenuEntry * )memPtr;
    ...
    Tk_FreeOptions(entryConfigSpecs,
                   ( char * )mePtr,
                   menuPtr->display,
                   (COMMAND_MASK << mePtr->type));
    ckfree(( char * )mePtr);
            ...
            * Tk_ConfigureWidget. */
{
        ...
        || (mePtr->activeFg != NULL))
    {
        ...
        gcValues.background
        = Tk_3DBorderColor((mePtr->border != NULL) ? mePtr->border
                                                   : menuPtr->border)
          ->pixel;
        ...
        gcValues.background = Tk_3DBorderColor((mePtr->activeBorder != NULL)
                                               ? mePtr->activeBorder
...
static void ComputeMenuGeometry(clientData)
...
static void DisplayMenu(clientData) ClientData clientData; /* Information
                                                              about widget. */
{
    Menu *menuPtr = ( Menu * )clientData;
    MenuEntry *mePtr;
    ...
    for (index = 0; index < menuPtr->numEntries; index++)
    {
        ...
        if (mePtr->type == CASCADE_ENTRY)
        {
            points[0].x = Tk_Width(tkwin) - menuPtr->borderWidth
                          ...
                          - CASCADE_ARROW_WIDTH;
            points[0].y
            = mePtr->y + (mePtr->height - CASCADE_ARROW_HEIGHT) / 2;
        ...
        if ((mePtr->type == RADIO_BUTTON_ENTRY) && mePtr->indicatorOn)
        {
            ...
            points[0].x
            = menuPtr->borderWidth + menuPtr->activeBorderWidth
    ...
    Tk_Draw3DRectangle(menuPtr->tkwin,
                       Tk_WindowId(tkwin),
                       menuPtr->border,
                       0,
                       0,
...
int *indexPtr; /* Where to store converted relief. */
{
    ...
    Tcl_AppendResult(
    interp, "bad menu entry index \"", string, "\"", ( char * )NULL);
    return TCL_ERROR;
}
...
static void MenuEventProc(clientData,
                          eventPtr) ClientData clientData; /* Information
                                                              about window. */
...
static void MenuCmdDeletedProc(clientData)
...
static MenuEntry *
MenuNewEntry(menuPtr, index, type) Menu *menuPtr; /* Menu that will hold the
                                                     new entry. */
...
int type; /* The type of the new entry. */
{
    ...
    = ( MenuEntry * )ckalloc(sizeof(MenuEntry));
    mePtr->type = type;
...
static void EventuallyRedrawMenu(menuPtr,
                                 mePtr) Menu *menuPtr; /* Information about
                                                          menu to redraw. */
...
static int ActivateMenuEntry(menuPtr, index) Menu *menuPtr; /* Menu in which
                                                               to activate. */
