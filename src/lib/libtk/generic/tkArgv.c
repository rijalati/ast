                        ...
                        * such as TK_ARGV_NO_DEFAULTS. */
{
    ...
    gotMatch:
        ...
        case TK_ARGV_OPTION_VALUE:
            ...
            Tk_AddOption(
            tkwin, infoPtr->dst, argv[srcIndex], TK_INTERACTIVE_PRIO);
            srcIndex++;
            argc--;
            break;
        case TK_ARGV_OPTION_NAME_VALUE:
            ...
            Tk_AddOption(
            tkwin, argv[srcIndex], argv[srcIndex + 1], TK_INTERACTIVE_PRIO);
            srcIndex += 2;
            argc -= 2;
            break;
        default:
...
static void PrintUsage(interp,
                       argTable,
                       flags) Tcl_Interp *interp; /* Place information in this
