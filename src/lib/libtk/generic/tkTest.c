...
static void ImageDisplay _ANSI_ARGS_((ClientData clientData,
                                      ...
                                      int drawableX,
                                      int drawableY));
static void ImageFree _ANSI_ARGS_((ClientData clientData, Display *display));
...
extern int SquareCmd _ANSI_ARGS_(
...
#ifdef WIN_TCL
static int TestclipboardCmd
_ANSI_ARGS_((ClientData dummy, Tcl_Interp *interp, int argc, char **argv));
#endif
static int TestdeleteappsCmd
_ANSI_ARGS_((ClientData dummy, Tcl_Interp *interp, int argc, char **argv));
static int TesteventCmd
_ANSI_ARGS_((ClientData dummy, Tcl_Interp *interp, int argc, char **argv));
static int TestmakeexistCmd
_ANSI_ARGS_((ClientData dummy, Tcl_Interp *interp, int argc, char **argv));
static int TestsendCmd
_ANSI_ARGS_((ClientData dummy, Tcl_Interp *interp, int argc, char **argv));
...
int Tktest_Init(interp) Tcl_Interp *interp; /* Interpreter for application. */
{
...
static ClientData
ImageGet(tkwin, clientData) Tk_Window tkwin; /* Token for window in which
                                              * image will be used. */
...
static void ImageDisplay(clientData,
                         display,
                         drawable,
                         imageX,
                         imageY,
                           ...
                           * imageX and imageY. */
{
    ...
    sprintf(buffer,
            "%s display %d %d %d %d %d %d",
            instPtr->masterPtr->imageName,
            imageX,
            imageY,
            width,
            height,
            drawableX,
            drawableY);
    Tcl_SetVar(instPtr->masterPtr->interp,
...
static void ImageDelete(clientData)
