...
= { { TK_CONFIG_BORDER,
    ...
    { TK_CONFIG_PIXELS,
      ...
      "borderWidth",
      "BorderWidth",
      DEF_CANVAS_BORDER_WIDTH,
      Tk_Offset(TkCanvas, borderWidth),
      0 },
    { TK_CONFIG_DOUBLE,
      "-closeenough",
      "closeEnough",
      "CloseEnough",
      DEF_CANVAS_CLOSE_ENOUGH,
      Tk_Offset(TkCanvas, closeEnough),
      0 },
    { TK_CONFIG_BOOLEAN,
      "-confine",
      "confine",
    ...
    { TK_CONFIG_PIXELS,
      ...
      "Height",
      DEF_CANVAS_HEIGHT,
      Tk_Offset(TkCanvas, height),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightbackground",
      "highlightBackground",
      "HighlightBackground",
      DEF_CANVAS_HIGHLIGHT_BG,
      Tk_Offset(TkCanvas, highlightBgColorPtr),
      0 },
    { TK_CONFIG_COLOR,
      "-highlightcolor",
      "highlightColor",
      "HighlightColor",
      DEF_CANVAS_HIGHLIGHT,
    ...
    { TK_CONFIG_PIXELS,
      ...
      "highlightThickness",
      "HighlightThickness",
      DEF_CANVAS_HIGHLIGHT_WIDTH,
      Tk_Offset(TkCanvas, highlightWidth),
      0 },
    { TK_CONFIG_BORDER,
      "-insertbackground",
      "insertBackground",
      "Foreground",
      DEF_CANVAS_INSERT_BG,
      Tk_Offset(TkCanvas, textInfo.insertBorder),
      0 },
    { TK_CONFIG_PIXELS,
      "-insertborderwidth",
      "insertBorderWidth",
      ...
      Tk_Offset(TkCanvas, textInfo.insertBorderWidth),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_PIXELS,
      "-insertborderwidth",
      "insertBorderWidth",
    ...
    { TK_CONFIG_INT,
      ...
      "insertOffTime",
      "OffTime",
      DEF_CANVAS_INSERT_OFF_TIME,
      Tk_Offset(TkCanvas, insertOffTime),
      0 },
    { TK_CONFIG_INT,
      "-insertontime",
      "insertOnTime",
      "OnTime",
      DEF_CANVAS_INSERT_ON_TIME,
      Tk_Offset(TkCanvas, insertOnTime),
      0 },
    { TK_CONFIG_PIXELS,
      "-insertwidth",
      "insertWidth",
      "InsertWidth",
      DEF_CANVAS_INSERT_WIDTH,
      Tk_Offset(TkCanvas, textInfo.insertWidth),
      0 },
    { TK_CONFIG_RELIEF,
      "-relief",
      "relief",
      "Relief",
      DEF_CANVAS_RELIEF,
      Tk_Offset(TkCanvas, relief),
      0 },
    { TK_CONFIG_STRING,
      "-scrollregion",
      "scrollRegion",
      "ScrollRegion",
      DEF_CANVAS_SCROLL_REGION,
      Tk_Offset(TkCanvas, regionString),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_BORDER,
      "-selectbackground",
      "selectBackground",
      "Foreground",
      DEF_CANVAS_SELECT_COLOR,
      Tk_Offset(TkCanvas, textInfo.selBorder),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_BORDER,
      "-selectbackground",
      "selectBackground",
      "Foreground",
      DEF_CANVAS_SELECT_MONO,
      Tk_Offset(TkCanvas, textInfo.selBorder),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_PIXELS,
      "-selectborderwidth",
      ...
      Tk_Offset(TkCanvas, textInfo.selBorderWidth),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_PIXELS,
      "-selectborderwidth",
      "selectBorderWidth",
    ...
    { TK_CONFIG_COLOR,
      ...
      "selectForeground",
      "Background",
      DEF_CANVAS_SELECT_FG_COLOR,
      Tk_Offset(TkCanvas, textInfo.selFgColorPtr),
      TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_COLOR,
      "-selectforeground",
      "selectForeground",
      "Background",
      DEF_CANVAS_SELECT_FG_MONO,
      Tk_Offset(TkCanvas, textInfo.selFgColorPtr),
      TK_CONFIG_MONO_ONLY },
    { TK_CONFIG_STRING,
      "-takefocus",
      "takeFocus",
      "TakeFocus",
      DEF_CANVAS_TAKE_FOCUS,
      Tk_Offset(TkCanvas, takeFocus),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_PIXELS,
      "-width",
      "width",
      "Width",
      DEF_CANVAS_WIDTH,
      Tk_Offset(TkCanvas, width),
      0 },
    { TK_CONFIG_STRING,
      "-xscrollcommand",
      "xScrollCommand",
      "ScrollCommand",
      DEF_CANVAS_X_SCROLL_CMD,
      Tk_Offset(TkCanvas, xScrollCmd),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_PIXELS,
      "-xscrollincrement",
      "xScrollIncrement",
      "ScrollIncrement",
      DEF_CANVAS_X_SCROLL_INCREMENT,
      Tk_Offset(TkCanvas, xScrollIncrement),
      0 },
    { TK_CONFIG_STRING,
      "-yscrollcommand",
      "yScrollCommand",
      "ScrollCommand",
      DEF_CANVAS_Y_SCROLL_CMD,
      Tk_Offset(TkCanvas, yScrollCmd),
      TK_CONFIG_NULL_OK },
    { TK_CONFIG_PIXELS,
      "-yscrollincrement",
      "yScrollIncrement",
...
static void CanvasCmdDeletedProc _ANSI_ARGS_((ClientData clientData));
...
static Tk_Item *CanvasFindClosest _ANSI_ARGS_((TkCanvas * canvasPtr,
                                               double coords[2]));
static void CanvasFocusProc _ANSI_ARGS_((TkCanvas * canvasPtr, int gotFocus));
static void CanvasLostSelection _ANSI_ARGS_((ClientData clientData));
static void CanvasSelectTo _ANSI_ARGS_((TkCanvas * canvasPtr,
                                        Tk_Item *itemPtr,
                                        int index));
static void
CanvasSetOrigin _ANSI_ARGS_((TkCanvas * canvasPtr, int xOrigin, int yOrigin));
static void CanvasUpdateScrollbars _ANSI_ARGS_((TkCanvas * canvasPtr));
static int CanvasWidgetCmd _ANSI_ARGS_(
(ClientData clientData, Tcl_Interp *interp, int argc, char **argv));
static int ConfigureCanvas _ANSI_ARGS_(
(Tcl_Interp * interp, TkCanvas *canvasPtr, int argc, char **argv, int flags));
static void DestroyCanvas _ANSI_ARGS_((char *memPtr));
static void DisplayCanvas _ANSI_ARGS_((ClientData clientData));
static void
DoItem _ANSI_ARGS_((Tcl_Interp * interp, Tk_Item *itemPtr, Tk_Uid tag));
...
static void PickCurrentItem _ANSI_ARGS_((TkCanvas * canvasPtr,
                                         XEvent *eventPtr));
static void PrintScrollFractions _ANSI_ARGS_(
(int screen1, int screen2, int object1, int object2, char *string));
static void
RelinkItems _ANSI_ARGS_((TkCanvas * canvasPtr, char *tag, Tk_Item *prevPtr));
...
char **argv;           /* Argument strings. */
{
    ...
    if ((c == 'a') && (strncmp(argv[1], "addtag", length) == 0)) {
        ...
        if (argc == 5) {
            ...
            if (argv[4][0] == 0) {
                result = Tk_DeleteBinding(
                interp, canvasPtr->bindingTable, object, argv[3]);
                goto done;
            }
            if (argv[4][0] == '+') {
                argv[4]++;
            ...
            mask = Tk_CreateBinding(
            interp, canvasPtr->bindingTable, object, argv[3], argv[4], append);
            if (mask == 0) {
                goto error;
            }
            if (mask
            ...
            command
            = Tk_GetBinding(interp, canvasPtr->bindingTable, object, argv[3]);
            if (command == NULL) {
                goto error;
            }
        ...
        if (argc == 2) {
            ...
            result = ConfigureCanvas(
            interp, canvasPtr, argc - 2, argv + 2, TK_CONFIG_ARGV_ONLY);
        }
        ...
        for (itemPtr = StartTagSearch(canvasPtr, argv[2], &search);
            ...
            for (i = itemPtr->numTags - 1; i >= 0; i--) {
                if (itemPtr->tagPtr[i] == tag) {
                    itemPtr->tagPtr[i]
                    = itemPtr->tagPtr[itemPtr->numTags - 1];
                    itemPtr->numTags--;
                }
            }
        }
        ...
        if ((c == 'a') && (strncmp(argv[2], "adjust", length) == 0)) {
            ...
            if (canvasPtr->textInfo.selItemPtr != NULL) {
                sprintf(
                interp->result, "%d", canvasPtr->textInfo.selItemPtr->id);
            }
...
int flags;           /* Flags to pass to Tk_ConfigureWidget. */
{
    ...
    Tk_GeometryRequest(canvasPtr->tkwin,
                       canvasPtr->width + 2 * canvasPtr->inset,
    ...
    if (canvasPtr->regionString != NULL) {
        ...
        if (Tcl_SplitList(
            canvasPtr->interp, canvasPtr->regionString, &argc2, &argv2)
            != TCL_OK) {
            return TCL_ERROR;
        }
        if (argc2 != 4) {
        ...
        if ((Tk_GetPixels(canvasPtr->interp,
                          canvasPtr->tkwin,
                          argv2[0],
                          &canvasPtr->scrollX1)
             != TCL_OK)
            || (Tk_GetPixels(canvasPtr->interp,
                             canvasPtr->tkwin,
                             argv2[1],
                             &canvasPtr->scrollY1)
                != TCL_OK)
...
ClientData clientData; /* Information about widget. */
{
    ...
    if ((canvasPtr->redrawX1 < canvasPtr->redrawX2)
        ...
        for (itemPtr = canvasPtr->firstItemPtr; itemPtr != NULL;
             itemPtr = itemPtr->nextPtr) {
            if ((itemPtr->x1 >= screenX2) || (itemPtr->y1 >= screenY2)
                || (itemPtr->x2 < screenX1) || (itemPtr->y2 < screenY1)) {
...
borders:
    if (canvasPtr->flags & REDRAW_BORDERS) {
        ...
        if (canvasPtr->highlightWidth != 0) {
            ...
            tkwin, gc, canvasPtr->highlightWidth, Tk_WindowId(tkwin));
        }
    }
...
void Tk_CreateItemType(typePtr)
                       ...
                       * will be initialized here. */
{
    ...
    for (prevPtr = NULL, itemPtr = canvasPtr->firstItemPtr; itemPtr != NULL;
         prevPtr = itemPtr, itemPtr = itemPtr->nextPtr) {
        for (tagPtr = itemPtr->tagPtr, count = itemPtr->numTags; count > 0;
             tagPtr++, count--) {
            if (*tagPtr == uid) {
                searchPtr->prevPtr = prevPtr;
...
static Tk_Item *NextItem(searchPtr) TagSearch *searchPtr; /* Record describing
                                                           * search in
                                                           * progress. */
{
    Tk_Item *itemPtr, *prevPtr;
                      ...
                      * items are OK. */
{
    ...
    for (itemPtr = canvasPtr->firstItemPtr; itemPtr != NULL;
         itemPtr = itemPtr->nextPtr) {
        if ((itemPtr->x1 >= x2) || (itemPtr->x2 <= x1) || (itemPtr->y1 >= y2)
            || (itemPtr->y2 <= y1)) {
            continue;
        }
                   ...
                   * put at beginning of list). */
{
    ...
    for (itemPtr = StartTagSearch(canvasPtr, tag, &search); itemPtr != NULL;
         itemPtr = NextItem(&search)) {
        if (itemPtr == prevPtr) {
            /*
...
static void PickCurrentItem(canvasPtr,
                            eventPtr) TkCanvas *canvasPtr; /* Canvas widget in
                                                            * which to select
                                                            * current item. */
                   ...
                   * MotionNotify. */
{
    ...
    if (eventPtr != &canvasPtr->pickEvent) {
        if ((eventPtr->type == MotionNotify)
            ...
            canvasPtr->pickEvent.xcrossing.display
            = eventPtr->xmotion.display;
...
static Tk_Item *
CanvasFindClosest(canvasPtr,
                  coords) TkCanvas *canvasPtr; /* Canvas widget to search. */
...
static void CanvasDoEvent(canvasPtr,
                          eventPtr) TkCanvas *canvasPtr; /* Canvas widget in
                                                          * which event
                                                          * occurred. */
...
#define NUM_STATIC 3
    ...
    if (canvasPtr->tkwin != NULL) {
        Tk_BindEvent(canvasPtr->bindingTable,
                     eventPtr,
                     canvasPtr->tkwin,
                     numObjects,
                     objectPtr);
...
static void CanvasSelectTo(canvasPtr,
                           itemPtr,
...
static double GridAlign(coord,
                        spacing) double coord; /* Coordinate to grid-align. */
...
static void PrintScrollFractions(
screen1,
screen2,
object1,
object2,
...
canvasPtr) TkCanvas *canvasPtr; /* Information about canvas. */
{
    int result;
    char buffer[200];
    Tcl_Interp *interp;
    int xOrigin, yOrigin, inset, width, height, scrollX1, scrollX2, scrollY1,
    scrollY2;
...
static void CanvasSetOrigin(canvasPtr,
                            xOrigin,
                            yOrigin) TkCanvas *canvasPtr; /* Information about
                                                             canvas. */
              ...
              * window). */
{
    ...
    if (canvasPtr->xScrollIncrement > 0) {
        if (xOrigin >= 0) {
            ...
            xOrigin
            -= (xOrigin + canvasPtr->inset) % canvasPtr->xScrollIncrement;
        } else {
    ...
    if (canvasPtr->yScrollIncrement > 0) {
        if (yOrigin >= 0) {
            ...
            yOrigin
            -= (yOrigin + canvasPtr->inset) % canvasPtr->yScrollIncrement;
        } else {
