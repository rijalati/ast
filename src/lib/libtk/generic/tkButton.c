...
#define ALL_MASK                                                             \
    (LABEL_MASK | BUTTON_MASK | CHECK_BUTTON_MASK | RADIO_BUTTON_MASK)
...
= { { TK_CONFIG_BORDER,
      ...
      "activeBackground",
      "Foreground",
      DEF_BUTTON_ACTIVE_BG_COLOR,
      Tk_Offset(Button, activeBorder),
    ...
    { TK_CONFIG_COLOR,
      ...
      "activeForeground",
      "Background",
      DEF_BUTTON_ACTIVE_FG_COLOR,
      Tk_Offset(Button, activeFg),
      BUTTON_MASK | CHECK_BUTTON_MASK | RADIO_BUTTON_MASK
      | TK_CONFIG_COLOR_ONLY },
    { TK_CONFIG_COLOR,
      "-activeforeground",
    ...
    { TK_CONFIG_BITMAP,
      ...
      "Bitmap",
      DEF_BUTTON_BITMAP,
      Tk_Offset(Button, bitmap),
      ALL_MASK | TK_CONFIG_NULL_OK },
    { TK_CONFIG_PIXELS,
      "-borderwidth",
      "borderWidth",
      "BorderWidth",
      DEF_BUTTON_BORDER_WIDTH,
      Tk_Offset(Button, borderWidth),
      ALL_MASK },
    { TK_CONFIG_STRING,
      "-command",
      "command",
    ...
    { TK_CONFIG_COLOR,
      ...
      Tk_Offset(Button, highlightBgColorPtr),
      ALL_MASK },
    { TK_CONFIG_COLOR,
      "-highlightcolor",
      "highlightColor",
      ...
      Tk_Offset(Button, highlightColorPtr),
      ALL_MASK },
    { TK_CONFIG_PIXELS,
      "-highlightthickness",
      "highlightThickness",
      "HighlightThickness",
      DEF_LABEL_HIGHLIGHT_WIDTH,
      Tk_Offset(Button, highlightWidth),
      LABEL_MASK },
    { TK_CONFIG_PIXELS,
      "-highlightthickness",
      "highlightThickness",
      "HighlightThickness",
      DEF_BUTTON_HIGHLIGHT_WIDTH,
      Tk_Offset(Button, highlightWidth),
      BUTTON_MASK | CHECK_BUTTON_MASK | RADIO_BUTTON_MASK },
    { TK_CONFIG_STRING,
      "-image",
      ...
      "Image",
      DEF_BUTTON_IMAGE,
      Tk_Offset(Button, imageString),
      ALL_MASK | TK_CONFIG_NULL_OK },
    { TK_CONFIG_BOOLEAN,
      "-indicatoron",
      "indicatorOn",
      "IndicatorOn",
      DEF_BUTTON_INDICATOR,
      Tk_Offset(Button, indicatorOn),
    ...
    { TK_CONFIG_JUSTIFY,
      ...
      "Justify",
      DEF_BUTTON_JUSTIFY,
      Tk_Offset(Button, justify),
      ALL_MASK },
    { TK_CONFIG_STRING,
      "-offvalue",
      "offValue",
      "Value",
      DEF_BUTTON_OFF_VALUE,
      Tk_Offset(Button, offValue),
      CHECK_BUTTON_MASK },
    { TK_CONFIG_STRING,
      "-onvalue",
      "onValue",
    ...
    { TK_CONFIG_BORDER,
      ...
      "selectColor",
      "Background",
      DEF_BUTTON_SELECT_COLOR,
      Tk_Offset(Button, selectBorder),
    ...
    { TK_CONFIG_STRING,
      ...
      "selectImage",
      "SelectImage",
      DEF_BUTTON_SELECT_IMAGE,
      Tk_Offset(Button, selectImageString),
    ...
    { TK_CONFIG_UID,
      ...
      "State",
      DEF_BUTTON_STATE,
      Tk_Offset(Button, state),
      BUTTON_MASK | CHECK_BUTTON_MASK | RADIO_BUTTON_MASK },
    { TK_CONFIG_STRING,
      "-takefocus",
      "takeFocus",
      "TakeFocus",
      DEF_LABEL_TAKE_FOCUS,
      Tk_Offset(Button, takeFocus),
      LABEL_MASK | TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      "-takefocus",
      "takeFocus",
      "TakeFocus",
      DEF_BUTTON_TAKE_FOCUS,
      Tk_Offset(Button, takeFocus),
      BUTTON_MASK | CHECK_BUTTON_MASK | RADIO_BUTTON_MASK
      | TK_CONFIG_NULL_OK },
    { TK_CONFIG_STRING,
      ...
      "Text",
      DEF_BUTTON_TEXT,
      Tk_Offset(Button, text),
      ALL_MASK },
    { TK_CONFIG_STRING,
      "-textvariable",
      "textVariable",
      "Variable",
      DEF_BUTTON_TEXT_VARIABLE,
      Tk_Offset(Button, textVarName),
      ALL_MASK | TK_CONFIG_NULL_OK },
    { TK_CONFIG_INT,
      "-underline",
      "underline",
      "Underline",
      DEF_BUTTON_UNDERLINE,
      Tk_Offset(Button, underline),
      ALL_MASK },
    { TK_CONFIG_STRING,
      "-value",
      "value",
    ...
    { TK_CONFIG_STRING,
      ...
      Tk_Offset(Button, selVarName),
      RADIO_BUTTON_MASK },
    { TK_CONFIG_STRING,
      "-variable",
      "variable",
      "Variable",
      DEF_CHECKBUTTON_VARIABLE,
      Tk_Offset(Button, selVarName),
    ...
    { TK_CONFIG_STRING,
      ...
      "Width",
      DEF_BUTTON_WIDTH,
      Tk_Offset(Button, widthString),
      ALL_MASK },
    { TK_CONFIG_PIXELS,
      "-wraplength",
      "wrapLength",
      "WrapLength",
      DEF_BUTTON_WRAP_LENGTH,
...
static int ButtonCreate _ANSI_ARGS_(
(ClientData clientData, Tcl_Interp *interp, int argc, char **argv, int type));
...
static void ButtonImageProc _ANSI_ARGS_((ClientData clientData,
                                         ...
                                         int imgWidth,
                                         int imgHeight));
static void ButtonSelectImageProc _ANSI_ARGS_((ClientData clientData,
                                               int x,
                                               int y,
                                               int width,
                                               int height,
...
static char *ButtonVarProc _ANSI_ARGS_((ClientData clientData,
                                        ...
                                        char *name2,
                                        int flags));
static int ButtonWidgetCmd _ANSI_ARGS_(
(ClientData clientData, Tcl_Interp *interp, int argc, char **argv));
static void ComputeButtonGeometry _ANSI_ARGS_((Button * butPtr));
static int ConfigureButton _ANSI_ARGS_(
(Tcl_Interp * interp, Button *butPtr, int argc, char **argv, int flags));
...
char **argv; /* Argument strings. */
{
             ...
             && (butPtr->type != TYPE_LABEL))
    {
        ...
        if (butPtr->state != tkDisabledUid)
        {
            ...
            {
                butPtr->state
                = (butPtr->state == tkNormalUid) ? tkActiveUid : tkNormalUid;
                 ...
                 * for DisplayButton;  it's no longer needed, and
             ...
             && (length >= 2) && (butPtr->type == TYPE_CHECK_BUTTON))
    {
        ...
        {
            if (Tcl_SetVar(
                interp, butPtr->selVarName, butPtr->offValue, TCL_GLOBAL_ONLY)
                == NULL)
            {
                result = TCL_ERROR;
            }
        ...
        {
            if (Tcl_SetVar(
                interp, butPtr->selVarName, butPtr->onValue, TCL_GLOBAL_ONLY)
                == NULL)
            {
                result = TCL_ERROR;
            }
...
static void DestroyButton(butPtr) Button *butPtr; /* Info about button widget.
                                                   */
{
    /*
...
int flags; /* Flags to pass to Tk_ConfigureWidget. */
{
    ...
    if (butPtr->activeFg != NULL)
    {
        ...
        newGC = Tk_GetGC(
        butPtr->tkwin, GCForeground | GCBackground | GCFont, &gcValues);
        if (butPtr->activeTextGC != None)
        {
            Tk_FreeGC(butPtr->display, butPtr->activeTextGC);
        }
    ...
    if (butPtr->type != TYPE_LABEL)
    {
        ...
        else
        {
            ...
            {
                butPtr->gray
                = Tk_GetBitmap(interp, butPtr->tkwin, Tk_GetUid("gray50"));
                if (butPtr->gray == None)
                {
                    return TCL_ERROR;
                }
    ...
    {
        image = Tk_GetImage(butPtr->interp,
                            butPtr->tkwin,
                            butPtr->imageString,
                            ButtonImageProc,
                            ( ClientData )butPtr);
    ...
    {
        if (Tk_GetPixels(
            interp, butPtr->tkwin, butPtr->widthString, &butPtr->width)
            != TCL_OK)
        {
        widthError:
        ...
        if (Tk_GetPixels(
            interp, butPtr->tkwin, butPtr->heightString, &butPtr->height)
            != TCL_OK)
        {
        heightError:
    ...
    {
        if (Tcl_GetInt(interp, butPtr->widthString, &butPtr->width) != TCL_OK)
        {
            goto widthError;
        }
...
ClientData clientData; /* Information about widget. */
{
    ...
    else if ((butPtr->state == tkActiveUid) && !Tk_StrictMotif(butPtr->tkwin))
    {
    ...
    {
        relief
        = (butPtr->flags & SELECTED) ? TK_RELIEF_SUNKEN : TK_RELIEF_RAISED;
    }
    ...
    pixmap = Tk_GetPixmap(butPtr->display,
                          Tk_WindowId(tkwin),
                          Tk_Width(tkwin),
                          Tk_Height(tkwin),
                          Tk_Depth(tkwin));
    ...
    imageOrBitmap:
        ...
        if (butPtr->image != NULL)
        {
            ...
            {
                Tk_RedrawImage(
                butPtr->selectImage, 0, 0, width, height, pixmap, x, y);
            }
            else
            {
                Tk_RedrawImage(
                butPtr->image, 0, 0, width, height, pixmap, x, y);
            }
        }
        else
        {
    ...
    else
    {
        ...
        case TK_ANCHOR_SW:
            x
            = butPtr->inset + butPtr->padX + butPtr->indicatorSpace + offset;
            break;
        case TK_ANCHOR_N:
        case TK_ANCHOR_CENTER:
        case TK_ANCHOR_S:
    ...
    else if ((butPtr->type == TYPE_RADIO_BUTTON) && butPtr->indicatorOn)
    {
        ...
        if (butPtr->flags & SELECTED)
        {
            ...
            gc = Tk_3DBorderGC(tkwin,
                               ...
                               TK_3D_FLAT_GC);
            XFillPolygon(
            butPtr->display, pixmap, gc, points, 4, Convex, CoordModeOrigin);
        }
        else
        {
...
static void ComputeButtonGeometry(
butPtr) Button *butPtr; /* Button whose geometry may have changed. */
{
    int width, height;
    ...
    else
    {
        ...
        TkComputeTextGeometry(butPtr->fontPtr,
                              butPtr->text,
                              butPtr->numChars,
                              butPtr->wrapLength,
                              &butPtr->textWidth,
        ...
        if ((butPtr->type >= TYPE_CHECK_BUTTON) && butPtr->indicatorOn)
        {
            ...
            butPtr->indicatorSpace
            = butPtr->indicatorDiameter + XTextWidth(butPtr->fontPtr, "0", 1);
        }
    }
...
static int InvokeButton(butPtr) Button *butPtr; /* Information about button.
                                                 */
{
    if (butPtr->type == TYPE_CHECK_BUTTON)
    {
...
int flags; /* Information about what happened. */
{
    ...
    if (flags & TCL_TRACE_UNSETS)
    {
        ...
        {
            Tcl_SetVar(
            interp, butPtr->textVarName, butPtr->text, TCL_GLOBAL_ONLY);
            Tcl_TraceVar(interp,
                         butPtr->textVarName,
                         TCL_GLOBAL_ONLY | TCL_TRACE_WRITES
                         | TCL_TRACE_UNSETS,
