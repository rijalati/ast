...
struct Ardir_s;
typedef struct Ardir_s Ardir_t;
struct Ardirent_s;
typedef struct Ardirent_s Ardirent_t;
struct Ardirmeth_s;
typedef struct Ardirmeth_s Ardirmeth_t;
...
extern Ardirmeth_t *
ardirmeth(const char *);
extern Ardirmeth_t *
ardirlist(Ardirmeth_t *);
extern Ardir_t *
ardiropen(const char *, Ardirmeth_t *, int);
extern Ardirent_t *
ardirnext(Ardir_t *);
extern off_t
ardircopy(Ardir_t *, Ardirent_t *, int);
extern int
ardirchange(Ardir_t *, Ardirent_t *);
extern int
ardirinsert(Ardir_t *, const char *, int);
extern const char *
ardirspecial(Ardir_t *);
extern int
ardirclose(Ardir_t *);
