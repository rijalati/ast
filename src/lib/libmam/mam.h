...
mamfree(struct mam *);
extern int
mamscan(struct mam *, const char *);
extern struct rule *
mamrule(struct proc *, const char *);
extern struct var *
mamvar(struct proc *, const char *, const char *);
extern void
mamprereq(struct proc *, struct rule *, struct rule *, struct list **);
