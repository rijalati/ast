...
typedef int (*Dssread_f)(struct Dssfile_s *,
                         struct Dssrecord_s *,
                         struct Dssdisc_s *);
typedef int (*Dsswrite_f)(struct Dssfile_s *,
                          struct Dssrecord_s *,
                          struct Dssdisc_s *);
...
extern Tags_t *
dss_con_beg(Tag_t *, Tagframe_t *, const char *, Tagdisc_t *);
extern int
dss_con_dat(Tag_t *, Tagframe_t *, const char *, Tagdisc_t *);
extern int
dss_con_end(Tag_t *, Tagframe_t *, Tagdisc_t *);

extern Tags_t *
dss_map_beg(Tag_t *, Tagframe_t *, const char *, Tagdisc_t *);
extern int
dss_map_dat(Tag_t *, Tagframe_t *, const char *, Tagdisc_t *);
extern int
dss_map_end(Tag_t *, Tagframe_t *, Tagdisc_t *);

extern Dssrecord_t *
dss_no_fread(Dssfile_t *, Dssrecord_t *, Dssdisc_t *);
extern int
dss_no_fwrite(Dssfile_t *, Dssrecord_t *, Dssdisc_t *);
extern Sfoff_t
dss_no_fseek(Dssfile_t *, Sfoff_t, Dssdisc_t *);
