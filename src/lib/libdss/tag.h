...
struct Tagframe_s;
typedef struct Tagframe_s Tagframe_t;
struct Tags_s;
typedef struct Tags_s Tags_t;
struct Tagdisc_s;
typedef struct Tagdisc_s Tagdisc_t;
...
typedef int (
*Tagscan_f)(Tag_t *, Tagframe_t *, void *, unsigned int, Tagdisc_t *);
...
extern Tag_t *
tagopen(Sfio_t *, const char *, int, Tags_t *, Tagdisc_t *);
extern Sfio_t *
tagsync(Tag_t *);
extern int
tagclose(Tag_t *);
...
extern char *
tagcontext(Tag_t *, Tagframe_t *);

extern int
tagscan(Tags_t *, Tagscan_f, void *, Tagdisc_t *);

extern int
tagusage(Tags_t *, Sfio_t *, Tagdisc_t *);
