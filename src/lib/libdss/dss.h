...
#        define DSSLIB(m)                                                    \
            ...
            Dsslib_t *dss_lib(const char *name, Dssdisc_t *disc)             \
            {                                                                \
                return &dss_lib_##m;                                         \
            }                                                                \
            unsigned long plugin_version(void)                               \
            {                                                                \
                return DSS_PLUGIN_VERSION;                                   \
            }
#    else
#        define DSSLIB(m)                                                    \
            extern Dsslib_t dss_lib_##m;                                     \
            Dsslib_t *dss_lib(name, disc) const char *name;                  \
            Dssdisc_t *disc;                                                 \
            {                                                                \
                return &dss_lib_##m;                                         \
            }                                                                \
...
struct Dssfile_s;
typedef struct Dssfile_s Dssfile_t;
struct Dssformat_s;
typedef struct Dssformat_s Dssformat_t;
struct Dssoptdisc_s;
typedef struct Dssoptdisc_s Dssoptdisc_t;
struct Dssrecord_s;
typedef struct Dssrecord_s Dssrecord_t;
struct Dssstate_s;
typedef struct Dssstate_s Dssstate_t;
...
dssstate(Dssdisc_t *);
extern Dsslib_t *
dsslib(const char *, Dssflags_t, Dssdisc_t *);
extern Dsslib_t *
dssload(const char *, Dssdisc_t *);
extern int
dssadd(Dsslib_t *, Dssdisc_t *);

extern Dssmeth_t *
dssmeth(const char *, Dssdisc_t *);
extern Dssmeth_t *
dsstags(Sfio_t *, const char *, int, Dssflags_t, Dssdisc_t *, Dssmeth_t *);

extern Sfio_t *
dssfind(const char *, const char *, Dssflags_t, char *, size_t, Dssdisc_t *);

extern int
dssoptinfo(Opt_t *, Sfio_t *, const char *, Optdisc_t *);
extern int
dssoptlib(Sfio_t *, Dsslib_t *, const char *, Dssdisc_t *);

extern Dss_t *
dssopen(Dssflags_t, Dssflags_t, Dssdisc_t *, Dssmeth_t *);
extern int
dssrun(Dss_t *, const char *, const char *, const char *, char **);
extern int
dssclose(Dss_t *);

extern Dssfile_t *
dssfopen(Dss_t *, const char *, Sfio_t *, Dssflags_t, Dssformat_t *);
extern Dssrecord_t *
dssfread(Dssfile_t *);
extern int
dssfwrite(Dssfile_t *, Dssrecord_t *);
extern Sfoff_t
dssftell(Dssfile_t *);
extern int
dssfseek(Dssfile_t *, Sfoff_t);
extern int
dssfclose(Dssfile_t *);
extern Dssexpr_t *
dsscomp(Dss_t *, const char *, Sfio_t *);
extern int
dssbeg(Dss_t *, Dssexpr_t *);
extern int
dsseval(Dss_t *, Dssexpr_t *, Dssrecord_t *);
extern int
dssend(Dss_t *, Dssexpr_t *);
extern int
dsslist(Dss_t *, Dssexpr_t *, Sfio_t *);
extern int
dssfree(Dss_t *, Dssexpr_t *);
extern ssize_t
dssmagic(Dss_t *, Sfio_t *, const char *, const char *, uint32_t, size_t);
extern ssize_t
dssprintf(Dss_t *, Cx_t *, Sfio_t *, const char *, Dssrecord_t *);
...
dssget(Dssrecord_t *,
       ...
       Dssvalue_t *);
extern Dsstype_t *
dsstype(Dss_t *, const char *);
extern Dssvariable_t *
dssvariable(Dss_t *, const char *);
