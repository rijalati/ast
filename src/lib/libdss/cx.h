...
#    define CXDETAILS(d, f, t, v)                                            \
        ((d) ? (d)                                                           \
             : ((d) = (f) && (f)->details                                    \
                      ? (f)->details                                         \
                      : (t)->format.details ? (t)->format.details : (v)))

#    define CX_HEADER_INIT                                                   \
        {                                                                    \
            { 0 }, 0                                                         \
        }
#    define CX_SCHEMA_INIT                                                   \
        {                                                                    \
            { 0 }, CX_SCHEMA                                                 \
        }
...
#    define cxislogical(t)                                                   \
        (cxrepresentation(t) == CX_bool || cxrepresentation(t) == CX_number)
...
#    define cxsize(t, v)                                                     \
        ((cxisstring(t) || cxisbuffer(t)) ? ((v)->buffer.size) : 0)
...
struct Cxarray_s;
typedef struct Cxarray_s Cxarray_t;
struct Cxconstraint_s;
typedef struct Cxconstraint_s Cxconstraint_t;
struct Cxdisc_s;
typedef struct Cxdisc_s Cxdisc_t;
struct Cxedit_s;
typedef struct Cxedit_s Cxedit_t;
struct Cxexpr_s;
typedef struct Cxexpr_s Cxexpr_t;
struct Cxformat_s;
typedef struct Cxformat_s Cxformat_t;
struct Cxinstruction_s;
typedef struct Cxinstruction_s Cxinstruction_t;
struct Cxitem_s;
typedef struct Cxitem_s Cxitem_t;
struct Cxlib_s;
typedef struct Cxlib_s Cxlib_t;
struct Cxmatch_s;
typedef struct Cxmatch_s Cxmatch_t;
struct Cxmap_s;
typedef struct Cxmap_s Cxmap_t;
struct Cxmember_s;
typedef struct Cxmember_s Cxmember_t;
struct Cxop_s;
typedef struct Cxop_s Cxop_t;
struct Cxoperand_s;
typedef struct Cxoperand_s Cxoperand_t;
struct Cxpart_s;
typedef struct Cxpart_s Cxpart_t;
struct Cxquery_s;
typedef struct Cxquery_s Cxquery_t;
struct Cxreference_s;
typedef struct Cxreference_s Cxreference_t;
struct Cxstate_s;
typedef struct Cxstate_s Cxstate_t;
struct Cxstructure_s;
typedef struct Cxstructure_s Cxstructure_t;
struct Cxtype_s;
typedef struct Cxtype_s Cxtype_t;
struct Cxvariable_s;
typedef struct Cxvariable_s Cxvariable_t;
...
typedef ssize_t (*Cxexternal_f)(Cx_t *,
                                Cxtype_t *,
                                const char *,
                                Cxformat_t *,
                                Cxvalue_t *,
...
typedef ssize_t (*Cxinternal_f)(Cx_t *,
                                Cxtype_t *,
                                const char *,
                                Cxformat_t *,
                                Cxoperand_t *,
...
typedef void *(
*Cxmatchcomp_f)(Cx_t *, Cxtype_t *, Cxtype_t *, Cxvalue_t *, Cxdisc_t *);
typedef int (
*Cxmatchexec_f)(Cx_t *, void *, Cxtype_t *, Cxvalue_t *, Cxdisc_t *);
...
typedef int (*Cxrecode_f)(Cx_t *,
                          ...
                          Cxdisc_t *);
typedef int (
*Cxstr2num_f)(Cx_t *, const char *, size_t, Cxunsigned_t *, Cxdisc_t *);
...
struct Cxmeth_s;
typedef struct Cxmeth_s Cxmeth_t;
...
#    define cxinit(d, e)                                                     \
        (memset(d, 0, sizeof(Cxdisc_t)),                                     \
         (d)->version = CX_VERSION,                                          \
         (d)->errorf = (Error_f)(e),                                         \
         cxstate(d))
...
extern Cx_t *
cxopen(Cxflags_t, Cxflags_t, Cxdisc_t *);
extern Cx_t *
cxscope(Cx_t *, Cx_t *, Cxflags_t, Cxflags_t, Cxdisc_t *);
extern int
cxclose(Cx_t *);

extern void *
cxpush(Cx_t *, const char *, Sfio_t *, const char *, ssize_t, Cxflags_t);
extern int
cxpop(Cx_t *, void *);
extern ssize_t
cxtell(Cx_t *);
...
cxcomp(Cx_t *);
extern int
cxbeg(Cx_t *, Cxexpr_t *, const char *);
extern int
cxeval(Cx_t *, Cxexpr_t *, void *, Cxoperand_t *);
extern int
cxend(Cx_t *, Cxexpr_t *);
extern int
cxlist(Cx_t *, Cxexpr_t *, Sfio_t *);
extern int
cxfree(Cx_t *, Cxexpr_t *);
extern int
cxcast(Cx_t *,
       Cxoperand_t *,
       Cxvariable_t *,
       ...
       const char *);
extern size_t
cxsizeof(Cx_t *, Cxvariable_t *, Cxtype_t *, Cxvalue_t *);
extern ssize_t
cxmembers(Cx_t *,
          Cxtype_t *,
          const char *,
...
cxcodename(int);
extern char *
cxopname(int, Cxtype_t *, Cxtype_t *);

extern int
cxaddcallout(Cx_t *, Cxcallout_t *, Cxdisc_t *);
extern int
cxaddconstraint(Cx_t *, Cxconstraint_t *, Cxdisc_t *);
extern int
cxaddedit(Cx_t *, Cxedit_t *, Cxdisc_t *);
extern int
cxaddmap(Cx_t *, Cxmap_t *, Cxdisc_t *);
extern int
cxaddquery(Cx_t *, Cxquery_t *, Cxdisc_t *);
extern int
cxaddrecode(Cx_t *, Cxrecode_t *, Cxdisc_t *);
extern int
cxaddtype(Cx_t *, Cxtype_t *, Cxdisc_t *);
extern int
cxaddvariable(Cx_t *, Cxvariable_t *, Cxdisc_t *);

extern Cxtype_t *
cxattr(Cx_t *, const char *, char **, Cxformat_t *, Cxdisc_t *);
extern Cxcallout_f
cxcallout(Cx_t *, int, Cxtype_t *, Cxtype_t *, Cxdisc_t *);
extern Cxconstraint_t *
cxconstraint(Cx_t *, const char *, Cxdisc_t *);
extern Cxedit_t *
cxedit(Cx_t *, const char *, Cxdisc_t *);
extern Cxvariable_t *
cxfunction(Cx_t *, const char *, Cxdisc_t *);
extern Cxmap_t *
cxmap(Cx_t *, const char *, Cxdisc_t *);
extern Cxquery_t *
cxquery(Cx_t *, const char *, Cxdisc_t *);
extern Cxrecode_f
cxrecode(Cx_t *, int, Cxtype_t *, Cxtype_t *, Cxdisc_t *);
extern Cxtype_t *
cxtype(Cx_t *, const char *, Cxdisc_t *);
extern Cxvariable_t *
cxvariable(Cx_t *, const char *, Cxtype_t *, Cxdisc_t *);

extern int
cxnum2str(Cx_t *, Cxformat_t *, Cxunsigned_t, char **);
extern int
cxstr2num(Cx_t *, Cxformat_t *, const char *, size_t, Cxunsigned_t *);

extern int
cxsub(Cx_t *, Cxedit_t *, Cxoperand_t *);
extern int
cxsuball(Cx_t *, Cxpart_t *, Cxoperand_t *);

extern char *
cxcvt(Cx_t *, const char *, size_t);

extern int
cxatfree(Cx_t *, Cxexpr_t *, Cxdone_f, void *);
