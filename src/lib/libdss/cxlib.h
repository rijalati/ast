...
struct Cxbuf_s;
typedef struct Cxbuf_s Cxbuf_t;
struct Cxcompile_s;
typedef struct Cxcompile_s Cxcompile_t;
struct Cxdone_s;
typedef struct Cxdone_s Cxdone_t;
struct Cxinclude_s;
typedef struct Cxinclude_s Cxinclude_t;
...
#    define _CX_CONSTRAINT_PRIVATE_ regex_t *re;
