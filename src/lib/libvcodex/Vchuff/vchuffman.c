...
#if __STD_C
int
vchcopy(Vcodex_t *vc, ssize_t *freq, ssize_t *size, ssize_t maxs)
#else
...
#if __STD_C
static ssize_t
vchuff(Vcodex_t *vc, const Void_t *data, size_t dtsz, Void_t **out)
#else
static ssize_t vchuff(vc, data, dtsz, out) Vcodex_t *vc;
...
#if __STD_C
static ssize_t
vcunhuff(Vcodex_t *vc, const Void_t *orig, size_t dtsz, Void_t **out)
#else
static ssize_t vcunhuff(vc, orig, dtsz, out) Vcodex_t *vc;
...
#if __STD_C
static int
huffevent(Vcodex_t *vc, int type, Void_t *params)
#else
static int huffevent(vc, type, params) Vcodex_t *vc;
int type;
Void_t *params;
#endif
{
