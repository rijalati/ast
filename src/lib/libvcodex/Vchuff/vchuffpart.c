...
#if __STD_C
static double
entropy(ssize_t *freq, Vcchar_t *data, size_t size)
#else
static double entropy(freq, data, size) ssize_t *freq;
Vcchar_t *data;
size_t size;
#endif
{
...
#if __STD_C
static double
eupdate(double e, ssize_t *freq, ssize_t *fr, int add)
#else
...
/* recursively partition a dataset into parts with different statistical
 * models */
#if __STD_C
static int
part(Part_t *pt, Vcchar_t *data, size_t size, ssize_t *rfreq, double re)
#else
...
#if __STD_C
static ssize_t
pthuff(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
...
#if __STD_C
static ssize_t
ptunhuff(Vcodex_t *vc, const Void_t *orig, size_t size, Void_t **out)
#else
...
#if __STD_C
static int
ptevent(Vcodex_t *vc, int type, Void_t *params)
#else
static int ptevent(vc, type, params) Vcodex_t *vc;
int type;
Void_t *params;
#endif
{
