...
#if __STD_C
static ssize_t
rle0(Rle_t *rle, int encoding)
#else
static ssize_t rle0(rle, encoding) Rle_t *rle;
int encoding;
#endif
{
    ssize_t c, z;
...
#if __STD_C
static ssize_t
rle1(Rle_t *rle, int encoding)
#else
static ssize_t rle1(rle, encoding) Rle_t *rle;
int encoding;
#endif
{
    ssize_t c, rc, rz;
...
#if __STD_C
static ssize_t
rle2(Rle_t *rle, int encoding)
#else
static ssize_t rle2(rle, encoding) Rle_t *rle;
int encoding;
#endif
{
    Vcchar_t *dt, *enddt;
...
#if __STD_C
static ssize_t
rleg(Rle_t *rle, int encoding)
#else
static ssize_t rleg(rle, encoding) Rle_t *rle;
int encoding;
#endif
{
...
#if __STD_C
static ssize_t
vcrle(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t vcrle(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
{
    ...
    if (!(output
          = vcbuffer(vc, output, sz, -1))) /* truncate buffer to size */
        RETURN(-1);
    if (out)
        *out = output;
    return sz;
...
#if __STD_C
static ssize_t
vcunrle(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t vcunrle(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static ssize_t
rleextract(Vcodex_t *vc, Vcchar_t **datap)
#else
static ssize_t rleextract(vc, datap) Vcodex_t *vc;
...
#if __STD_C
static int
rlerestore(Vcmtcode_t *mtcd)
#else
static int rlerestore(mtcd) Vcmtcode_t *mtcd;
#endif
{
    Vcmtarg_t *arg;
    char *ident, buf[1024];
...
#if __STD_C
static int
rleevent(Vcodex_t *vc, int type, Void_t *params)
#else
static int rleevent(vc, type, params) Vcodex_t *vc;
int type;
Void_t *params;
#endif
{
