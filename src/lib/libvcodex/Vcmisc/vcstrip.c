...
#if __STD_C
static ssize_t
strip(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t strip(vc, data, size, out) Vcodex_t *vc;
const Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static ssize_t
unstrip(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t unstrip(vc, data, size, out) Vcodex_t *vc;
const Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static int
stripevent(Vcodex_t *vc, int type, Void_t *params)
#else
static int stripevent(vc, type, params) Vcodex_t *vc;
int type;
Void_t *params;
#endif
{
