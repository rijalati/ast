...
#if __STD_C
static ssize_t
vcbwt(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t vcbwt(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static ssize_t
vcunbwt(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t vcunbwt(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
