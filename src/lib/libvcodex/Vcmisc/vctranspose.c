...
#if __STD_C
static ssize_t
transflip(Vcchar_t *data, ssize_t dtsz, int rsep, Vcchar_t *flip)
#else
static ssize_t transflip(data, dtsz, rsep, flip) Vcchar_t *data;
ssize_t dtsz;
int rsep;
Vcchar_t *flip;
#endif
...
#if __STD_C
static ssize_t
unflip(Vcchar_t *data, ssize_t dtsz, int rsep, Vcchar_t *flip)
#else
static ssize_t unflip(data, dtsz, rsep, flip) Vcchar_t *data;
ssize_t dtsz;
int rsep;
Vcchar_t *flip;
#endif
...
#if __STD_C
static void
transfixed(Vcchar_t *oldtbl, ssize_t nrows, ssize_t ncols, Vcchar_t *newtbl)
#else
static void transfixed(oldtbl,
                       nrows,
                       ncols,
...
#if __STD_C
static ssize_t
transtrain(const Void_t *train, size_t trsz)
#else
static ssize_t transtrain(train, trsz) Void_t *train; /* training data */
size_t trsz;
#endif
{
    ssize_t ncols, sz;
...
#if __STD_C
static ssize_t
transpose(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t transpose(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static ssize_t
untranspose(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t untranspose(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static int
transevent(Vcodex_t *vc, int type, Void_t *params)
#else
static int transevent(vc, type, params) Vcodex_t *vc;
int type;
Void_t *params;
#endif
{
