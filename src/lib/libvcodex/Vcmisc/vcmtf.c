...
#if __STD_C
static ssize_t
mtfp(Vcchar_t *dt, Vcchar_t *enddt, Vcchar_t *output, int encoding)
#else
static ssize_t mtfp(dt, enddt, output, encoding) Vcchar_t *dt; /* data to be
                                                                  un/mtf-ed	*/
Vcchar_t *enddt;
...
#if __STD_C
static ssize_t
mtf0(Vcchar_t *dt, Vcchar_t *enddt, Vcchar_t *output, int encoding)
#else
static ssize_t mtf0(dt, enddt, output, encoding) Vcchar_t *dt; /* data to be
                                                                  un/mtf-ed	*/
Vcchar_t *enddt;
Vcchar_t *output; /* output array		*/
int encoding; /* !=0 if encoding	*/
...
#if __STD_C
static ssize_t
vcmtf(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t vcmtf(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static ssize_t
vcunmtf(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t vcunmtf(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static ssize_t
mtfextract(Vcodex_t *vc, Vcchar_t **datap)
#else
static ssize_t mtfextract(vc, datap) Vcodex_t *vc;
...
#if __STD_C
static int
mtfrestore(Vcmtcode_t *mtcd)
#else
static int mtfrestore(mtcd) Vcmtcode_t *mtcd;
#endif
{
    Vcmtarg_t *arg;
    char *ident, buf[1024];
...
#if __STD_C
static int
mtfevent(Vcodex_t *vc, int type, Void_t *params)
#else
static int mtfevent(vc, type, params) Vcodex_t *vc;
int type;
Void_t *params;
#endif
{
