...
#if __STD_C
Vccontext_t *
vcinitcontext(Vcodex_t *vc, Vccontext_t *ctxt)
#else
Vccontext_t *vcinitcontext(vc, ctxt) Vcodex_t *vc;
...
#if __STD_C
int
vcfreecontext(Vcodex_t *vc, Vccontext_t *ctxt)
#else
int vcfreecontext(vc, ctxt) Vcodex_t *vc;
