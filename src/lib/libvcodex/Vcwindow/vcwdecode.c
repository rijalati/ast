...
#if __STD_C
static Vcwmatch_t *
decode(Vcwindow_t *vcw, Void_t *data, size_t size, Sfoff_t here)
#else
static Vcwmatch_t *
decode(vcw, data, size, here) Vcwindow_t *vcw; /* signature structure		*/
...
static Vcwmethod_t _Vcwdecode = { decode, 0, "decode" };
