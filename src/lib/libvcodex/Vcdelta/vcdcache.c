...
#if __STD_C
void
vcdkaclose(Vcdcache_t *ka)
#else
void vcdkaclose(ka) Vcdcache_t *ka;
#endif
{
    if (ka)
        free(ka);
...
#if __STD_C
Vcdcache_t *
vcdkaopen(ssize_t s_near, ssize_t s_same)
#else
Vcdcache_t *vcdkaopen(s_near, s_same) ssize_t s_near;
ssize_t s_same;
#endif
{
    Vcdcache_t *ka;
...
#if __STD_C
void
vcdkaclear(Vcdcache_t *ka)
#else
void vcdkaclear(ka) Vcdcache_t *ka;
#endif
{
    ssize_t i;
...
#if __STD_C
static void
vcdkaupdate(Vcdcache_t *ka, ssize_t addr)
#else
static void vcdkaupdate(ka, addr) Vcdcache_t *ka;
ssize_t addr;
#endif
{
    if (ka)
...
#if __STD_C
ssize_t
vcdkagetaddr(Vcdcache_t *ka, Vcio_t *addr, ssize_t here, ssize_t mode)
#else
ssize_t vcdkagetaddr(ka, addr, here, mode) Vcdcache_t *ka;
Vcio_t *addr;
ssize_t here;
ssize_t mode;
#endif
