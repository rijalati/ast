...
#if __STD_C
static ssize_t
hamming(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t hamming(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static ssize_t
unhamming(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t unhamming(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
