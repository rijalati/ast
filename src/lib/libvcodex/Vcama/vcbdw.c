...
#if __STD_C
static ssize_t
bdwpart(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t bdwpart(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
...
#if __STD_C
static ssize_t
bdwunpart(Vcodex_t *vc, const Void_t *data, size_t size, Void_t **out)
#else
static ssize_t bdwunpart(vc, data, size, out) Vcodex_t *vc;
Void_t *data;
size_t size;
Void_t **out;
#endif
