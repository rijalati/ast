...
#if __STD_C
ssize_t
_vcioputu(Vcio_t *io, Vcint_t v)
#else
ssize_t _vcioputu(io, v) Vcio_t *io;
Vcint_t v;
#endif
{
    Vcchar_t *ptr, *code;
...
_vciogetu(Vcio_t *io)
#else
Vcint_t _vciogetu(io) Vcio_t *io;
#endif
{
    int n;
    Vcint_t v;
...
#if __STD_C
ssize_t
_vcioputm(Vcio_t *io, Vcint_t v, Vcint_t max)
#else
ssize_t _vcioputm(io, v, max) Vcio_t *io;
Vcint_t v;
Vcint_t max;
#endif
{
...
#if __STD_C
Vcint_t
_vciogetm(Vcio_t *io, Vcint_t max)
#else
Vcint_t _vciogetm(io, max) Vcio_t *io;
Vcint_t max;
#endif
{
    Vcint_t v;
...
#if __STD_C
Vcint_t
_vcioget2(Vcio_t *io, Vcchar_t a, Vcchar_t z)
#else
Vcint_t _vcioget2(io, a, z) Vcio_t *io;
Vcchar_t a; /* 1st coding letter	*/
Vcchar_t z; /* 2nd coding letter	*/
#endif
{
...
#if __STD_C
ssize_t
_vcioputg(Vcio_t *io, Vcint_t v)
#else
ssize_t _vcioputg(io, v) Vcio_t *io;
Vcint_t v;
#endif
{
    ssize_t n;
...
_vciogetg(Vcio_t *io)
#else
Vcint_t _vciogetg(io) Vcio_t *io;
#endif
{
    Vcint_t v;
    int k, b, g, s;
...
#define NBITS(v)                                                             \
    ((v) > 0xffff ? (((v) >>= 16), (NBITS16(v) + 16)) : NBITS16(v))

/* Coding a list of non-negative integers using a variable-length bit coding.
** Each integer is coded by a prefix telling the # of significant bits
*followed
...
#if __STD_C
ssize_t
vcioputlist(Vcio_t *io, Vcint_t *list, ssize_t nlist)
#else
ssize_t vcioputlist(io, list, nlist) Vcio_t *io;
Vcint_t *list;
ssize_t nlist;
#endif
{
...
#if __STD_C
ssize_t
vciogetlist(Vcio_t *io, Vcint_t *list, ssize_t nlist)
#else
ssize_t vciogetlist(io, list, nlist) Vcio_t *io;
Vcint_t *list;
ssize_t nlist;
#endif
{
...
*/
ssize_t
vcpositive(Vcint_t *list, ssize_t nlist, ssize_t *pos, ssize_t *neg, int type)
{
    ssize_t k, p, n, s, g;
    Vcint_t v;
...
#if __STD_C
Vcint_t
vcintcode(Vcint_t v, Vcint_t near, Vcint_t min, Vcint_t max, int type)
#else
...
#if __STD_C
ssize_t
vcitoa(Vcint_t i, char *a, ssize_t z)
#else
ssize_t vcitoa(i, a, z) Vcint_t i;
char *a;
ssize_t z;
#endif
{
...
ssize_t
vchexcode(Vcchar_t *byte, ssize_t bytez, Vcchar_t *hex, ssize_t hexz, int type)
{
    int b, h, l, r;
    Vcchar_t *dig;
