...
= "[-?\n@(#)$Id: uname (AT&T Research) 2007-04-19 $\n]" USAGE_LICENSE
  ...
  "[+?Selected information is printed in the same order as the options "
  "below.]"
  "[a:all?Equivalent to \b-snrvmpio\b.]"
  "[s:system|sysname|kernel-name?The detailed kernel name. This is the "
  "default.]"
...
: hide getdomainname gethostid gethostname sethostname
#else
