...
#    define JCL_LIST                                                         \
        (JCL_LISTAUTOEDITS | JCL_LISTEXEC | JCL_LISTINPUTS | JCL_LISTJOBS    \
         | JCL_LISTOUTPUTS | JCL_LISTPROGRAMS | JCL_LISTSCRIPTS              \
         | JCL_LISTVARIABLES)
...
struct Ie_s;
typedef struct Ie_s Ie_t;
struct Include_s;
typedef struct Include_s Include_t;
struct Redirect_s;
...
extern int
diff(const char *, const char *, Jcldisc_t *);
extern char *
expand(Jcl_t *, const char *, int);
extern char *
lookup(Jcl_t *, const char *, const char *, int, int);
extern char *
mark(const char *, int, size_t, Jcldisc_t *);
extern int
marked(const char *, Jcldd_t *, Jcldisc_t *);
extern char *
matched(int, size_t *, Jcldisc_t *);
extern void
nospace(Jcl_t *, Jcldisc_t *);
extern char *
stash(Jcl_t *, Vmalloc_t *, const char *, int);
extern int
suflen(const char *);
extern void
uniq(const char *, const char *, unsigned long, Jcldisc_t *);
