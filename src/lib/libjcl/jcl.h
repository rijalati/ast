...
struct Jclcat_s;
typedef struct Jclcat_s Jclcat_t;
struct Jclcond_s;
typedef struct Jclcond_s Jclcond_t;
struct Jcldd_s;
typedef struct Jcldd_s Jcldd_t;
struct Jcldir_s;
typedef struct Jcldir_s Jcldir_t;
struct Jcldisc_s;
typedef struct Jcldisc_s Jcldisc_t;
struct Jclout_s;
typedef struct Jclout_s Jclout_t;
struct Jcloutput_s;
typedef struct Jcloutput_s Jcloutput_t;
struct Jclstep_s;
typedef struct Jclstep_s Jclstep_t;
struct Jclsym_s;
typedef struct Jclsym_s Jclsym_t;
struct Jcl_s;
typedef struct Jcl_s Jcl_t;
...
#    define jclinit(d, e)                                                    \
        (memset(d, 0, sizeof(*(d))),                                         \
         (d)->version = JCL_VERSION,                                         \
         (d)->errorf = (Error_f)(e),                                         \
         (d)->date = (d)->odate = (d)->rdate = time(NiL))

extern int
jclmap(Jcl_t *, const char *, Jcldisc_t *);
extern int
jclstats(Sfio_t *, unsigned long, Jcldisc_t *);

extern int
jclclose(Jcl_t *);
extern int
jcleval(Jcl_t *, Jclcond_t *, int);
extern char *
jclfind(Jcl_t *, const char *, unsigned long, int, Sfio_t **);
extern int
jclinclude(Jcl_t *, const char *, unsigned long, Jcldisc_t *);
extern Jcl_t *
jclopen(Jcl_t *, const char *, unsigned long, Jcldisc_t *);
extern char *
jclparm(char **);
extern char *
jclpath(Jcl_t *, const char *);
extern int
jclpop(Jcl_t *);
extern int
jclpush(Jcl_t *, Sfio_t *, const char *, long);
extern int
jclrc(Jcl_t *, Jclstep_t *, int);
extern int
jclrun(Jcl_t *);
extern Jclstep_t *
jclstep(Jcl_t *);
extern Jclsym_t *
jclsym(Jcl_t *, const char *, const char *, int);
